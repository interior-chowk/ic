...
<body>
    ...
    <main id="content" role="main" class="main">
        ...
        <!-- Content -->
        <div class="container py-2 py-sm-7">
            <label class="badge badge-soft-success float-right __inline-2"><?php echo e(\App\CPU\translate('Software version')); ?>

                : <?php echo e(env('SOFTWARE_VERSION')); ?></label>
            <?php ($e_commerce_logo = \App\Model\BusinessSetting::where(['type' => 'company_web_logo'])->first()->value); ?>
            <a class="d-flex justify-content-center mb-1" href="javascript:">
                <img class="z-index-2" height="100" src="<?php echo e(asset('storage/app/public/company/' . $e_commerce_logo)); ?>"
                    alt="Logo" onerror="this.src='<?php echo e(asset('public/assets/back-end/img/400x400/img2.jpg')); ?>'">
            </a>
                    ...
                    <div class="card card">
                        <div class="card-body">
                            ...
                            <form id="form-id" action="<?php echo e(route('admin.auth.login')); ?>" method="post">
                                ...
                                <div class="text-center">
                                    <div class="">
                                        <h4 class="display-4"><?php echo e(\App\CPU\translate('sign_in')); ?></h4>
                                ...
                                <div class="js-form-message form-group">
                                    <label class="input-label"
                                        for="signinSrEmail"><?php echo e(\App\CPU\translate('your_email')); ?></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 input-icons" class="bg-white rounded">
                                            <a onclick="javascript:re_captcha();"
                                                ...
                                                <img src="<?php echo e(URL('/admin/auth/code/captcha/1')); ?>"
                                ...
                                <button type="submit"
                                    class="btn btn-block btn--primary"><?php echo e(\App\CPU\translate('sign_in')); ?></button>
                            </form>
                            <!-- End Form -->
                        </div>
                        <?php if(env('APP_MODE') == 'demo'): ?>
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-10">
                                        <span><?php echo e(\App\CPU\translate('Email')); ?> :
                                            <?php echo e(\App\CPU\translate('admin@admin.com')); ?></span>
                                        <span><?php echo e(\App\CPU\translate('Password')); ?> :
                                            <?php echo e(\App\CPU\translate('12345678')); ?></span>
                                    </div>
                                    <div class="col-2">
    ...
    <?php else: ?>
        <script type="text/javascript">
            function re_captcha() {
                $url = "<?php echo e(URL('/admin/auth/code/captcha')); ?>";
                $url = $url + "/" + Math.random();
...
<?php /**PATH D:\xampp\htdocs\adminic\resources\views/admin-views/auth/login.blade.php ENDPATH**/ ?>