                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-7 col-md-12 seller-register-part-2" data-aos="zoom-in" data-aos-duration="500">
                        ...
                        <div class="c-seller-registraion-step-form">
                            <form class="__shop-apply" action="<?php echo e(route('seller.auth.seller-registeration-2')); ?>"
                                id="form-id" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="seller_id" value="<?php echo e($id); ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input id="gst" type="text" name="gst"
                                                value="<?php echo e($shop?->gst_no ?? old('gst')); ?>" class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input id="shop_name" type="text" name="shop_name"
                                                value="<?php echo e($shop?->name ?? old('shop_name')); ?>" class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input id="shop_address" type="text" name="shop_address"
                                                value="<?php echo e($shop?->address ?? old('shop_address')); ?>" class="form-control"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <select id="bank_select" name="bank_name" class="form-control">
                                                <option value="<?php echo e($shop?->bank_name ?? old('bank_name')); ?>">Select Bank
                                                </option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="acc_no" type="text" class="form-control" name="acc_no"
                                                value="<?php echo e($shop?->acc_no ?? old('acc_no')); ?>" placeholder="Account No."
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="ifsc" type="text" class="form-control" name="ifsc"
                                                value="<?php echo e($shop?->ifsc ?? old('ifsc')); ?>" placeholder="IFSC" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="c-btn-group text-center">
                                            <a href="<?php echo e(route('seller.auth.seller-registeration', ['id' => $id])); ?>"
                ...
                <div class="modal-body">
                    <div class="personal-info">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h6>First Name</h6>
                                <p id="modal_first_name"><?php echo e(optional($data)->f_name ?? ''); ?></p>
                            </div>
                            <div class="col-md-6">
                                <h6>Last Name</h6>
                                <p id="modal_last_name"><?php echo e(optional($data)->l_name ?? ''); ?></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <h6>Email</h6>
                                <p id="modal_email"><?php echo e(optional($data)->email ?? ''); ?></p>
                            </div>
                            <div class="col-md-6">
                                <h6>Phone Number</h6>
                                <p id="modal_phone"><?php echo e(optional($data)->phone ?? ''); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="business-info">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h6>Company Name</h6>
                                <p id="modal_company_name"><?php echo e(optional($shop)->name ?? ''); ?></p>
                            </div>
                            <div class="col-md-6">
                                <h6>Address</h6>
                                <p id="modal_company_address"><?php echo e(optional($shop)->address ?? ''); ?></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <h6>Bank Account Number</h6>
                                <p id="modal_acc_no"><?php echo e(optional($shop)->acc_no ?? ''); ?></p>
                            </div>
                            <div class="col-md-6">
                                <h6>Bank Name</h6>
                                <p id="modal_bank_name"><?php echo e(optional($shop)->bank_name ?? ''); ?></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <h6>IFSC Code</h6>
                                <p id="modal_ifsc"><?php echo e(optional($shop)->ifsc ?? ''); ?></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <h6>GST Number</h6>
                                <p id="modal_gst_filename"><?php echo e(optional($shop)->gst ?? ''); ?></p>
                            </div>
                            <div class="col-md-6">
                                <h6>PAN Number</h6>
                                <p id="modal_pan_filename"><?php echo e(optional($shop)->pan ?? ''); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(function() {
        ...
        const imageBaseUrl = "<?php echo e(url('public/website/assets/images')); ?>/";
        ...
        function verifyGST() {
            ...
            $.ajax({
                url: "<?php echo e(route('seller.shop.verifyGst')); ?>",
                type: 'POST',
                data: {
                    gst: gstVal,
        ...
        function verifyBank() {
            ...
            if (acc_no && ifsc) { // bank_name is optional now
                ...
                $.ajax({
                    url: "<?php echo e(route('seller.verify.bank')); ?>",
                    type: "POST",
                    data: {
                        bank_name: bank_name,
                        acc_no: acc_no,
...
<?php echo $__env->make('layouts.back-end.common_seller_1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\adminic\resources\views/seller-views/auth-seller/seller-registeration-2.blade.php ENDPATH**/ ?>