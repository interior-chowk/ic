...
class ProductDetailsController extends Controller
{
    ...
    public function product($slug)
    {
       ...
       $couponTitles = Coupon::where('status', 1)->pluck('title'); 
        ...
        return view('web.product',compact('product','related_products','rel_service_providers','category','category_values','Product_banner_1','Product_banner_2','category_name_1','category_name_2','category_name_3','couponTitles'));
    }
