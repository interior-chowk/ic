...
class ReportController extends Controller
{
    ...
    public function membership(Request $request)
    {
        ...
        $mem = ServiceProviderPlan::with(['provider','membership'])
        ...
        return view('admin-views.membership.report', compact('mem', 'search'));
    }
    ...
    public function seller_earning_excel_sale_export(Request $request){
     ...
     public function seller_earning_excel_export_old(Request $request){
        $from         = $request['from'];
        $to           = $request['to'];
        $date_type    = $request['date_type'] ?? 'this_year';
