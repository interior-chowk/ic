...
class OrderController extends Controller
{
    ...
    public function details($id, ShiprocketService $shiprocketService)
    {
        ...
        if($order->order_type == 'default_type')
        {
            ...
            return view('admin-views.order.order-details', compact('shipping_address','order', 'linked_orders', 'delivery_men', 'total_delivered', 'company_name', 'company_web_logo', 'physical_product', 'status'));
        }else{
    ...
    public function generate_invoice($id)
    {
       ...
       //dd($sku);
        ...
        $mpdf_view = View::make('admin-views.order.invoice',
            compact('order','sku', 'seller', 'company_phone', 'company_name', 'company_email', 'company_web_logo')
        );
