...
class BusinessSettingsController extends Controller
{
    ...
    public function sp_social_media()
    {
        // $about_us = BusinessSetting::where('type', 'about_us')->first();
        return view('admin-views.business-settings.sp-social-media');
    }
    ...
    public function sp_fetch(Request $request)
    {
        if ($request->ajax()) {
            $data = ServiceProviderSocialMedia::where('status', 1)->orderBy('id', 'desc')->get();
            return response()->json($data);
        }
    }
    ...
    public function social_media_store(Request $request)
    {
        ...
        if ($request->name == 'youtube') {
         ...
         if ($request->name == 'app_store') {
            $icon = 'fab fa-app-store';
        }
         if ($request->name == 'play_store') {
    ...
    public function sp_social_media_store(Request $request)
    {
        $check = ServiceProviderSocialMedia::where('name', $request->name)->first();
        if ($check != null) {
            return response()->json([
                'error' => 1,
            ]);
        ...
        $social_media = new ServiceProviderSocialMedia;
        $social_media->name = $request->name;
        $social_media->link = $request->link;
        $social_media->icon = $icon;
        $social_media->save();
    ...
    public function sp_social_media_edit(Request $request)
    {
        $data = ServiceProviderSocialMedia::where('id', $request->id)->first();
        return response()->json($data);
    }
    ...
    public function social_media_update(Request $request)
    {
     ...
     public function sp_social_media_update(Request $request)
    {
        $social_media = ServiceProviderSocialMedia::find($request->id);
        $social_media->name = $request->name;
        $social_media->link = $request->link;
        $social_media->save();
        return response()->json();
    ...
    public function sp_social_media_delete(Request $request)
    {
        $br = ServiceProviderSocialMedia::find($request->id);
        $br->delete();
        return response()->json();
    }
    ...
    public function sp_social_media_status_update(Request $request)
    {
        ServiceProviderSocialMedia::where(['id' => $request['id']])->update([
            'active_status' => $request['status'],
        ]);
        return response()->json([
            'success' => 1,
    ...
    public function provider_terms_condition()
    {
        $terms_condition = BusinessSetting::where('type', 'provider_terms_condition')->first();
        return view('admin-views.business-settings.provider-terms-condition', compact('terms_condition'));
    }

    public function updateProviderTermsCondition(Request $data)
    {
        $validatedData = $data->validate([
            'value' => 'required',
        ]);
        BusinessSetting::where('type', 'provider_terms_condition')->update(['value' => $data->value]);
        Toastr::success('Terms and Condition Updated successfully!');
        return redirect()->back();
    }
    ...
    public function e_wallet_Policy()
    {
        ...
        return view('admin-views.business-settings.e-wallet-Policy', compact('e_wallet_Policy'));
    }

    public function e_wallet_Policy_update(Request $data)
    {
        $validatedData = $data->validate([
            'value' => 'required',
        ]);
        BusinessSetting::where('type', 'e_wallet_Policy')->update(['value' => $data->value]);
        Toastr::success('E walle policy Updated successfully!');
        return redirect()->back();
    }
    ...
    public function shipping_policy()
    {
        ...
        return view('admin-views.business-settings.shipping-policy', compact('shipping_policy'));
    }
    ...
    public function shipping_policy_update(Request $data)
    {
        ...
        BusinessSetting::where('type', 'shipping_policy')->update(['value' => $data->value]);
    ...
    public function secure_payment_policy()
    {
        ...
        return view('admin-views.business-settings.secure-payment-policy', compact('secure_payment_policy'));
    }

    public function secure_payment_policy_update(Request $data)
    {
        $validatedData = $data->validate([
            'value' => 'required',
        ]);
        BusinessSetting::where('type', 'secure_payment_policy')->update(['value' => $data->value]);
        Toastr::success('Secure payment policy Updated successfully!');
        return redirect()->back();
    }
    ...
    public function instant_delivery_policy()
    {
        ...
        return view('admin-views.business-settings.instant-delivery-policy', compact('instant_delivery_policy'));
    }

    public function instant_delivery_policy_update(Request $data)
    {
        $validatedData = $data->validate([
            'value' => 'required',
        ]);
        BusinessSetting::where('type', 'instant_delivery_policy')->update(['value' => $data->value]);
        Toastr::success('Instant delivery policy Updated successfully!');
        return redirect()->back();
    }
    
     public function shiprocket_token(Request $request){
        $shiprocket_token= BusinessSetting::where('type', 'shiprocket_token')->first();

        return view('admin-views.business-settings.shiprocket-token', compact('shiprocket_token'));
    }
    
    
     public function shiprocket_token_update(Request $data)
    {
        $validatedData = $data->validate([
            'token' => 'required',
        ]);
        BusinessSetting::where('type', 'shiprocket_token')->update(['value' => $data->token]);
        Toastr::success('Token Updated successfully!');
        return redirect()->back();
    }
    
    
    public function seller_terms_condition()
    {
        $seller_terms_condition = BusinessSetting::where('type', 'seller_terms_condition')->first();
        return view('admin-views.business-settings.seller-terms-condition', compact('seller_terms_condition'));
    }

    public function seller_terms_condition_update(Request $data)
    {
        $validatedData = $data->validate([
            'value' => 'required',
        ]);
        BusinessSetting::where('type', 'seller_terms_condition')->update(['value' => $data->value]);
        Toastr::success('seller Terms & Condition Updated successfully!');
        return redirect()->back();
    }
    ...
    public function companyInfo()
    {
        ...
        $company_whatapp_number = BusinessSetting::where('type', 'company_whatapp_number')->first();
        return view('admin-views.business-settings.website-info', [
            'company_name' => $company_name,
            'company_email' => $company_email,
            'company_whatapp_number' => $company_whatapp_number,
        ]);
    }
    ...
    public function updateInfo(Request $request)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['type' => 'company_phone'], [
         ...
         // company Whatapp Phone
        DB::table('business_settings')->updateOrInsert(['type' => 'company_whatapp_number'], [
            'value' => $request['company_whatapp_number']
        ]);
