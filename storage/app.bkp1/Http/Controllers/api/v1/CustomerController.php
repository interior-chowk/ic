...
class CustomerController extends Controller
{
    ...
    public function get_invoice(Request $request)
    {
        ...
        //$download_url = url('/') . '/seller/order-invoice-gst/' . $request->order_id . '/' . $request->gst_number . '/' . "{$company_name}";
    ...
    public function wallet_apply(Request $request)
    {
        ...
        if ($user->wallet_balance) {
            ...
            //$amount =  $request->product_amount*0.1;
    ...
    {
        // Wishlist products fetch karein
    ...
    public function get_order_details(Request $request)
    {
        ...
        //if($diffInDays > $return_day->Return_days )
        ...
        /* $details->map(function ($query,$reviewable) {*/
