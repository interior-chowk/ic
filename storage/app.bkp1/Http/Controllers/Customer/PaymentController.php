...
class PaymentController extends Controller
{
    public function payment(Request $request)
    {
        ...
        session()->put('instant_delivery', $request['instant_delivery']);
        session()->put('gstNumber', $request['gstNumber']);
        session()->put('gstCompanyName', $request['gstCompanyName']);
        session()->put('isWalletUsed', $request['isWalletUsed']);
        session()->put('wallet_deduct_amount', $request['wallet_deduct_amount']);
        session()->put('iteam_amounts', $request['iteam_amounts']);
        ...
        if (isset($customer)) {
            ...
            return view('payment.mobile_app_payment_view', compact('payment_method'));
        }
