...
class Category extends Model
{
    ...
    public function childes_s()
    {
       
        return $this->hasMany(Category::class, 'parent_id')->where('position', 1)->orderBy('priority', 'asc');
    }

    public function subChildes()
    {
      
        return $this->hasMany(Category::class, 'sub_parent_id')->where('position', 2)->orderBy('priority', 'asc');
    }
