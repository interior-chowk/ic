...
<div class="checkout_details container pb-5 mb-2 mb-md-4">
    <div class="row mt-5">
        ...
        @php($wallet_deduct_amount = session()->has('wallet_deduct_amount') ? session('wallet_deduct_amount') : 0)
        @php($amount = \App\CPU\CartManager::cart_grand_total() - $coupon_discount - $wallet_deduct_amount)
