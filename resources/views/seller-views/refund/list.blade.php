            ...
            <div class="flex-between justify-content-between align-items-center flex-grow-1">
                ...
                <div class="col-12 col-md-4">
                    <select name="filter" class="form-control" onchange="handleSelectChange(this)">
                        ...
                        <option value="{{route('seller.refund.list',['pending'])}}" {{ request()->is('seller/refund/list/pending') ? 'selected' : '' }}>{{\App\CPU\translate('pending')}}</option>
                        <option value="{{route('seller.refund.list',['approved'])}}" {{ request()->is('seller/refund/list/approved') ? 'selected' : '' }}>{{\App\CPU\translate('approved')}}</option>
                        <option value="{{route('seller.refund.list',['refunded'])}}" {{ request()->is('seller/refund/list/refunded') ? 'selected' : '' }}>{{\App\CPU\translate('refunded')}}</option>
                        <option value="{{route('seller.refund.list',['rejected'])}}" {{ request()->is('seller/refund/list/rejected') ? 'selected' : '' }}>{{\App\CPU\translate('rejected')}}</option>
                    </select>
                </div>
