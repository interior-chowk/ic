                                ...
                                @foreach($order->details as $key=>$detail)
                                    @if($detail->product)
                                        <tr>
                                            ...
                                            <td>{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($detail['tax']))}} [{{ isset($detail->product_all_status->tax)? $detail->product_all_status->tax : ''}}{{ isset($detail->product_all_status->tax_type)? '%' : ''}}]</td>
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-9">
                                <dl class="row gy-1 text-sm-right">
                                    ...
                                    <dt class="col-sm-6 font-weight-normal">{{\App\CPU\translate('Shipping')}} + {{\App\CPU\translate('instant_delivery_charge')}}</dt>
                                     @else
                                    <dt class="col-sm-6 font-weight-normal">{{\App\CPU\translate('Shipping_charge')}}</dt>
                                    @endif
                                    ...
                                    <?php 
                                             /* if($shipping <= 150){
                                                ...
                                                $toatal_ship_inst_charge = $toatal_ship_inst - $shipping;*/
                                   ...
                                   @endif
                                    ...
                                    <dd class="col-sm-6 font-weight-normal title-color">
                                     ...
                                     <dt class="col-sm-6 font-weight-normal">{{\App\CPU\translate('wallet_deduction')}}</dt>
                                    <dd class="col-sm-6 font-weight-normal title-color">
                                        - {{$wallet_deduction}}
                                    </dd>
                                    ...
                                    <dd class="col-sm-6 title-color">
                                        <strong>{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($total+$toatal_ship_inst-$coupon_discount-$wallet_deduction))}}</strong>
                                    </dd>
                                </dl>
                                <!-- End Row -->
                            </div>
