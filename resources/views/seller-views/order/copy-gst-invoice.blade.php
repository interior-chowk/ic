                            ...
                            <td>
                                @if ($order->shippingAddress)
                                    ...
                                    <div class="h4 montserrat-normal-600">
                                        <p style=" margin-top: 6px; margin-bottom:0px;" ><b>Company Name </b> : {{ $order->company_name }}</p> 
                                        <p style=" margin-top: 6px; margin-bottom:0px;" ><b>GST No.</b> : {{ $order->gst_number }}</p> 
               ...
               @php $subtotal=(($details['price'])*$details->qty)+$details['tax'] @endphp
                <tr>
                    ...
                    <td>
                        ...
                        @endif
                         <br>
                       {{\App\CPU\translate('HSN_code')}} : {{$details['product']->HSN_code?$details['product']->HSN_code:''}}
                    </td>
                    <td>{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($details['price']))}}</td>
                     <td>{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($details['tax']))}} [{{ isset($details->product_all_status->tax)? $details->product_all_status->tax : ''}}{{ isset($details->product_all_status->tax_type)? '%' : ''}}]</td>
                    <td>{{$details->qty}}</td>
                    ...
                    <tbody>
                        ...
                        ?>
                          ...
                          <tr>
                            ...
                            <tr>
                                <td class="p-1 text-left">{{\App\CPU\translate('instant_delivery_amount')}}</td>
                                <td class="p-1">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($instant_delivery_amount))}}</td>
                            </tr>
