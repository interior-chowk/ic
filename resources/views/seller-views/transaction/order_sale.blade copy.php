                ...
                <table id="datatable" style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};"
                    ...
                    <thead class="thead-light thead-50 text-capitalize">
                        <tr>
                            ...
                            <th class="toggle earning-column d-none">
                                {{ \App\CPU\translate('Plateform fee') }}<br><small>(In ₹)</small></th>
                            ...
                            @foreach ($orderDetails->details as $key => $details)
                                ...
                                <tr>
                                    ...
                                    <td id="services">
                                        @if ($order->statement == '2')
                                            <a class="btn btn-outline-success square-btn btn-sm mr-1" target="_blank"
                                                title="Invoice"
                                                href="{{ route('admin.orders.service-generate-invoice', $order->id) }}">
                                                <i class="tio-file"></i>
                                            </a>
                                        @endif
                                    </td>
                                    ...
                                    @else
                                        <td class="toggle earning-column d-none">
                                            ...
                                            @if ($order->statement != 2)
                                                ...
                                                @if (!$returnValid)
                                                    <button class="btn btn-xs btn-primary"> {{-- initial status: eligible --}}
                                                        <span class="text">
                                                            {{ 'Not Eligible now' }}
                                                        </span>
                                                    </button>
                                                @else
                                                    <button class="btn btn-xs btn-primary toggle-status-btn"
                                                        ...
                                                        <span class="text">
                                                            @if ($order->statement == 1 && $returnValids)
                                                                {{ 'Eligible' }}
                                                            @elseif($order->statement == 0 && $returnValids)
                                                                {{ 'Claimed/Unpaid' }}
                                                            @endif
                                                        </span>
                                                    </button>
                                    ...
                                    @else
                                        <td>-</td>
                                    @endif
                                    <td class="toggle earning-column d-none">{{ $order->invoice_no }}
                                    <td>
