                ...
                <table id="datatable" style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};"
                    ...
                    <thead class="thead-light thead-50 text-capitalize">
                        <tr>
                            ...
                            <th>{{ \App\CPU\translate('CGST') }}@9 %<br><small>(In
                                    ₹)</small></th>
                            <th>{{ \App\CPU\translate('SGST') }}@9 %<br><small>(In
                                    ₹)</small></th>
                            <th>{{ \App\CPU\translate('IGST') }}@18 %<br><small>(In
                                    ₹)</small></th>
                            <th>{{ \App\CPU\translate('Fee & Commission') }}
                                <br><small>(Incl.Tax)</small>
                            </th>
                            <th>{{ \App\CPU\translate('Net Payble to Seller') }}</th>
                            <th> {{ \App\CPU\translate('Earning Status') }}
                                <span class="ml-2" data-toggle="tooltip" data-placement="top"
                            ...
                            <th>{{ \App\CPU\translate('Payment Reference no') }}
                            </th>
