            ...
            <div class="row align-items-center" >
                <div class="col-lg-5 col-md-12"  data-aos="zoom-in" data-aos-duration="500">
                    <div class="c-seller-login-left">
                        <img src="{{ asset('asset/img/seller-login-left.png') }}" alt="">
                        <div class="text-center">
                          <h3>If you don’t  have seller account </h3>
                          <a href="{{ route('seller.auth.seller-registeration') }}" class="c-btn-2">Create  Seller account</a>
                        </div>
                    </div>
                </div>
                      ...
                      <div class="c-seller-login-right">
                          ...
                          @csrf
                              <div class="c-form-group">
                                  ...
                                  <input type="text" name="email" placeholder="Registred E-mail ID" class="c-form-control" id="signinSrEmail">
                              </div>
                              <div class="c-form-group">
                                  <i class="fa fa-lock" aria-hidden="true"></i>
                                  <input type="password" name="password" placeholder="Password" class="c-form-control js-toggle-password" id="pass_log_id">
                                  <div class="c-password-show">
                                      <i class="fa fa-eye-slash" aria-hidden="true"></i>
                                  </div>
                              </div>
                              <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="" name="remember" id="termsCheckbox">
                            ...
                            @else
                                <div class="row">
                                    <div class="col-6 pr-0">
                                        <input type="text" class="form-control border-0" name="default_recaptcha_id_seller_login" value=""
