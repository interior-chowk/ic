        ...
        <div class="c-seller-login-in">
            <div class="container">
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-4 col-md-12 me-auto reset-password" data-aos="zoom-in" data-aos-duration="500"
                        data-aos-delay="500">
                        ...
                        <div class="c-password-right">
                            ...
                            <div class="c-password-right-in">
                                <div class="c-password-right-img">
                                    <img src="{{ asset('public/asset/img/lock.png') }}" alt="">
                                </div>
                                ...
                                <form method="POST" action="{{ route('seller.auth.reset-passwords-update') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="password" placeholder="Enter new password"
                                            id="exampleInputPassword" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Repeat new password</label>
                                        <input type="text" name="confirm_password" placeholder="Enter new password"
                                            id="exampleRepeatPassword" class="form-control">
                    ...
                    <div class="col-lg-5 col-md-12" data-aos="zoom-in" data-aos-duration="500">
                        <div class="c-seller-login-left c-password-left c-reste-password">
                            ...
                            <img src="{{ asset('public/asset/img/reset-password.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
