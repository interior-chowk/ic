        ...
        <form class="__shop-apply" action="{{ route('shop.apply') }}" id="form-id" method="post"
            ...
            <div class="card __card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-4 ">
                            <!--<small class="text-danger">( * {{ \App\CPU\translate('country_code_is_must') }} {{ \App\CPU\translate('Like for +91') }} )</small>-->
                            ...
                            <small class="text-danger" id="show_phone_error" style="display:none">(
                                {{ \App\CPU\translate('please_fill_phone_number') }})</small>
                            <small class="text-danger" id="show_phone_error_verified" style="display:none">(
                                {{ \App\CPU\translate('please_verified_phone_number') }})</small>
                        </div>
                        <div class="col-sm-2 ">
                            <button type="button"
                                class="btn btn--primary btn-user btn-block get_otp">{{ \App\CPU\translate('Get OTP') }}</button>
                        </div>
                        <div class="col-sm-6" id="otp_input_type" style="display:none">
                            <input id="partitioned" class="form-control" name="otp"
                                placeholder="{{ \App\CPU\translate('Enter_OTP') }}" type="text" maxlength="4" />
                        ...
                        <div class="col-sm-6 " id="otp_verify_button" style="display:none">
                            ...
                            <button type="button"
                                class="btn btn--primary btn-user btn-block Verify_otp">{{ \App\CPU\translate('OTP_Verify') }}</button>
                        ...
                        <div class="col-sm-6 login-form">
                            <div class="input-group input-group-merge">
                                ...
                                <span class="input-group-text p-viewer m-0"
                                    onclick="togglePassword('exampleInputPassword', 'eyeIcon1')">
                        ...
                        <div class="col-sm-6 login-form">
                            <div class="input-group input-group-merge">
                                <input type="password" class="form-control form-control-user" minlength="6"
                                    ...
                                    required>
                                <span class="input-group-text p-viewer m-0"
                                    onclick="togglePassword('exampleRepeatPassword', 'eyeIcon2')">
            ...
            <div class="card __card">
                ...
                <div class="card-body">
                    <div class="row g-3 mb-3">
                        <div class="col-sm-6">
                            <input type="text" class="form-control form-control-user" id="shop_name" name="shop_name"
                                placeholder="{{ \App\CPU\translate('shop_name') }}" value="{{ old('shop_name') }}"
                                required>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-sm-3">
                            <select class="form-control form-control-user js-example-basic-multiple" id="shop_country"
                                name="country" disabled required>
                        ...
                        <div class="col-sm-3">
                            <select class="form-control form-control-user js-example-basic-multiple" id="shop_state"
                                name="state" required>
                        ...
                        <div class="col-sm-3">
                            <select class="form-control form-control-user js-example-basic-multiple" id="shop_city"
                                name="city" required>
                        ...
                        <div class="col-sm-3">
                            <select class="form-control form-control-user js-example-basic-multiple" id="shop_pin"
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group mb-5">
                                <div class="custom-file">
                                    <input type="file" name="reg_cert_image" id="LogoUpload"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label" for="LogoUpload">{{ \App\CPU\translate('Upload') }}
                                        {{ \App\CPU\translate('Company Registration Certificate') }}</label>
                                    <small
                                        class="text-info">{{ \App\CPU\translate('Company Registration Certificate') }}</small>
                                    <input type="text" class="form-control form-control-user" id="shop_compno"
                                        name="reg_cert"
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" name="gst_cert_image" id="BannerUpload"
                                        class="custom-file-input overflow-hidden __p-2p"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                        for="BannerUpload">{{ \App\CPU\translate('Upload') }}
                                        {{ \App\CPU\translate('GST No.') }}</label>
                                    <small class="text-info">{{ \App\CPU\translate('GST No') }}</small>
                                    <input type="text" class="form-control form-control-user" id="shop_gst"
                                        name="gst_no" placeholder="{{ \App\CPU\translate('GST No.') }}"
                                        value="{{ old('Pincode') }}" minlength="15" maxlength="15" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row g-3 mb-3">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" name="pan_image" id="BannerUpload"
                                        class="custom-file-input overflow-hidden __p-2p"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                        for="BannerUpload">{{ \App\CPU\translate('Upload') }}
                                        {{ \App\CPU\translate('PAN No.') }}</label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-5">
                                <div class="custom-file">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="shop_pan"
                                        name="pan" placeholder="{{ \App\CPU\translate('PAN No.') }}"
                                        value="{{ old('Pincode') }}" minlength="10" maxlength="10" length="10"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <select id="company_type" name="company_type" class="form-control" required>
                                        ...
                                        <option value="Limited Liability Partnership (LLP)">Limited Liability Partnership
                                            (LLP)</option>
            ...
            <div class="card __card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-sm-3">
                            <input type="text" class="form-control form-control-user" id="shop_bank" name="bank_name"
                                placeholder="{{ \App\CPU\translate('Bank Name') }}" value="{{ old('bank_name') }}"
                                required>
                        </div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control form-control-user" id="shop_branch"
                                name="bank_branch" placeholder="{{ \App\CPU\translate('Branch Name') }}"
                                value="{{ old('bank_branch') }}" required>
                        </div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control form-control-user" id="shop_account"
                                name="acc_no" placeholder="{{ \App\CPU\translate('Account No.') }}"
                                value="{{ old('acc_no') }}" required>
                        </div>
                        <div class="col-sm-3">
                            <input type="text" class="form-control form-control-user" id="shop_ifsc" name="ifsc"
                                placeholder="{{ \App\CPU\translate('IFSC') }}" value="{{ old('ifsc') }}" required>
                        </div>

                        <div class="col-sm-6">
                            <div class="form-group mt-5">
                                <div class="custom-file">
                                    <input type="file" name="cheque" id="ChequeUpload"
                                        class="custom-file-input overflow-hidden __p-2p"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" required>
                                    <label class="custom-file-label"
                                        for="ChequeUpload">{{ \App\CPU\translate('Upload') }}
                                        {{ \App\CPU\translate('Blank Cheque') }}</label>
