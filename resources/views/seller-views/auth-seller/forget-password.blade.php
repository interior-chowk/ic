                ...
                <div class="row align-items-end">
                    <div class="col-lg-5 col-md-12" data-aos="zoom-in" data-aos-duration="500">
                        <div class="c-seller-login-left c-password-left">
                            ...
                            <img src="{{ asset('public/asset/img/password-left.png') }}" alt="">

                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 ms-auto forget-password" data-aos="zoom-in" data-aos-duration="500"
                        data-aos-delay="500">

                        <div class="c-password-right">
                            <img src="{{ asset('public/asset/img/password-top.png') }}" alt="">
                            <div class="c-password-right-in">
                                <div class="c-password-right-img">
                                    <img src="{{ asset('public/asset/img/user-img.png') }}" alt="">
                                </div>
                                <p> Enter your E-mail ID and we’ll send you a link to reset your password.</p>
                                <form class="card-body needs-validation"
                                    action="{{ route('seller.auth.forget-password-request') }}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <input type="text" name="identity" placeholder="Enter your registered E-mail ID"
                                            class="form-control">
                                    </div>
