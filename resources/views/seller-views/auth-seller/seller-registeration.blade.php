                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group input-with-icon">
                                        <input type="text" name="f_name" class="form-control" value="{{old('f_name')}}" placeholder="First Name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group input-with-icon">
                                        <input type="text" name="l_name" class="form-control" value="{{old('l_name')}}" placeholder="Last Name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group input-with-icon">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group input-with-icon">
                                        <input type="text" name="phone" class="form-control" id="exampleInputPhone" placeholder="Mobile number">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group input-with-icon">
                                        ...
                                        <input type="password" name="password" class="form-control pass_log_id_new" placeholder="Create Password" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group input-with-icon">
                                        ...
                                        <input type="password" name="password_confirm" class="form-control pass_log_id_new-2" placeholder="Repeat password" required>
...
<script>
var imageBaseUrl = "{{ asset('asset/img') }}/";

// Helper to set input icon & error text
...
$(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response == 1) {
                        ...
                        setInputStatus($("#exampleInputPhone"), 'error', 'Number already exists!');
                        $('#otp_input_type').hide();
                        $('.reg-form').attr('disabled', true);
                    }
                },
                error: function() {
                    setInputStatus($("#exampleInputPhone"), 'error', 'Something went wrong!');
                    $('#otp_input_type').hide();
                    $('.reg-form').attr('disabled', true);
                }
            });
    ...
    $("#partitioned").on('input', function() {
        ...
        if(otp.length === 4) {
            setInputStatus($(this), 'loading');
            $.ajax({
                url: "{{route('shop.Verify_otp')}}",
                type: 'POST',
                data: { number: otp, phone: $("#phone_input").val(), _token: '{!! csrf_token() !!}' },
                success: function(response) {
                    if(response == 1) {
                        ...
                        setInputStatus($("#partitioned"), 'error', 'OTP is not matched!');
                        $('.reg-form').attr('disabled', true);
                    }
                },
                error: function() {
                    ...
                    <div class="c-seller-registraion-step-form">
                        <form class="__shop-apply" action="{{route('seller.auth.seller-registeration-store')}}" id="form-id" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group input-with-icon">
                                        <input type="text" name="phone_display" class="form-control" id="exampleInputPhone" placeholder="Mobile number">
                                        <span class="icon-status" id="phone-icon"></span>
                                        <small class="text-danger" id="phone-error" style="display:none"></small>
                                    </div>
                                </div>
...
<script>
var imageBaseUrl = "{{ url('public/website/assets/images') }}/";
