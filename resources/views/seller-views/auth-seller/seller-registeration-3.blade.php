            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-5 col-md-12 " data-aos="zoom-in" data-aos-duration="500">
                    <div class="c-seller-login-left c-password-left c-seller-registraion-heading">
                        ...
                        <img src="{{ asset('asset/img/seller-register.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-7 col-md-12 seller-register-part-3" data-aos="zoom-in" data-aos-duration="500">
                    <div class="c-seller-registraion-step">
                        <ul>
                            <li class="done-form">
                                <button type="button">
                                    <img src="{{ asset('asset/img/step-1.png') }}">
                                    <h3>Personal info.</h3>
                                </button>
                            </li>
                            <li class="done-form">
                                <button type="button">
                                    <img src="{{ asset('asset/img/step-2.png') }}">
                                    <h3>Business info</h3>
                                </button>
                            </li>
                            <li class="active">
                                <button type="button">
                                    <img src="{{ asset('asset/img/step-3.png') }}">
                                    <h3>Upload docs</h3>
                                </button>
                            </li>
                        </ul>
                    ...
                    <div class="c-seller-registraion-step-form">
                        <form class="__shop-apply" action="{{route('seller.auth.seller-registeration-3')}}" id="form-id" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group c-file-upload-control">
                                        <div class="row align-items-center">
                                            <div class="col-lg-5 col-md-12">
                                                <label class="form-label c-bulet-label" for="GSTIN">GSTIN Certificate</label>
                                            </div>
                                            <div class="col-lg-7 col-md-12">
                                                <div class="information-tag">
                                                   <span class="ml-2" data-toggle="tooltip" data-placement="top" title="{{\App\CPU\translate('The Maximum file size for uploads is 5 MB. Do not upload files that exceed this size.')}}">
                                                <img style="height: 16px; width: fit-content;" class="info-img" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="img">
                                            </span>
                                                </div>
                                                <input type="file"  class="form-control" name="gst_cert_image" id="gst_img" required>
                                    ...
                                    <div class="form-group c-file-upload-control">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-7 col-md-12">
                                                ...
                                                <input type="file"  class="form-control" name="pan_image" id="PAN_file" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group c-file-upload-control">
                                        <div class="row align-items-center">
                                            <div class="col-lg-5 col-md-12">
                                                <label class="form-label c-bulet-label" for="Cheque">Copy of Cheque </label>
                                            </div>
                                            <div class="col-lg-7 col-md-12">
                                                 <div class="information-tag">
                                                   <span class="ml-2" data-toggle="tooltip" data-placement="top" title="{{\App\CPU\translate('The Maximum file size for uploads is 5 MB. Do not upload files that exceed this size.')}}">
                                                ...
                                                <input type="file" class="form-control" name="cheque" id="Cheque_file" required>
                                 ...
                                 <style>
                                    .error  {
                                        border: 1px solid red; /* Apply red border when checkbox is not checked */
                                    }
                                </style>
                                <div class="col-md-12">
                                    <div class="form-check">
                                        <input class="form-check-input error" type="checkbox" value="" name="remember" id="inputCheckd">
                                        <label class="form-check-label" for="inputCheckd">
                                             <?php 
                                               ...
                                               @if($Business_setting->type == 'seller_terms_condition')
                                                <a href="{{ route('policy',['type' => $Business_setting->type]) }}" target="_blank">
                                ...
                                <div class="col-md-12">
                                    <div class="c-btn-group text-center">
                                        <a href="{{ route('seller.auth.seller-registeration-2',['id'=>$id]) }}" class="c-btn-2 ">Back</a>
                                        <a class="c-btn-2 c-btn-border cursor-pointer" style="cursor:pointer" onclick="preview_data()">Preview</a>
                                        <button type="submit" class="c-btn-2 c-orange-btn" id="apply" disabled >Submit</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <div class="modal-dialog modal-lg" role="document"> <!-- Added 'modal-lg' class for wider modal -->
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" onclick="close_preview()" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <p class="mt-1"><img src="#" id="gstin_certificate_id" style="height: 100px; width: 100px;">
                                 <br>
            ...
            <div class="modal-footer bg-whitesmoke br">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="close_preview()">Close</button>
...
<script>
    ...
    document.getElementById('modal_cheque_filename').textContent = document.getElementById('cheque_filename').textContent;
