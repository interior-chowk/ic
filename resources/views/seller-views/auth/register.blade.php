...
<div class="container py-5 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
    ...
    <h3 class="mb-3 text-center"> {{translate('Vendor')}} {{translate('Application')}}</h3>
        ...
        <div class="card __card mb-3">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-sm-4 "><!--<small class="text-danger">( * {{\App\CPU\translate('country_code_is_must')}} {{\App\CPU\translate('Like for +91')}} )</small>-->
                    <input type="hidden" name ="phone" id="phone_input">
                        ...
                        <small class="text-danger" id="show_phone_error" style="display:none">( {{\App\CPU\translate('please_fill_phone_number')}})</small>
                         <small class="text-danger" id="show_phone_error_verified" style="display:none">( {{\App\CPU\translate('please_verified_phone_number')}})</small>
                    </div>
                     <div class="col-sm-2 ">
                     <button type="button" class="btn btn--primary btn-user btn-block get_otp">{{\App\CPU\translate('Get OTP')}}</button>
                     </div>
                 
                       <div class="col-sm-6" id="otp_input_type" style="display:none">
                           <input id="partitioned" class="form-control" name="otp" placeholder="{{\App\CPU\translate('Enter_OTP')}}" type="text" maxlength="4" />
                            <small class="text-danger" id="show_otp_error" style="display:none">( {{\App\CPU\translate('otp is not matched !')}})</small>
                           </div>
                       <div class="col-sm-6 " id="otp_verify_button" style="display:none">
                            
                             <button type="button" class="btn btn--primary btn-user btn-block Verify_otp">{{\App\CPU\translate('OTP_Verify')}}</button>
                    ...
                    <!--<div class="col-sm-6 login-form">
                        ...
                        >
                        <span for='exampleInputPassword' class="p-viewer">
    ...
    <div class="input-group input-group-merge">
        <input type="password" class="form-control form-control-user" minlength="6" id="exampleInputPassword" name="password" placeholder="{{\App\CPU\translate('password')}}" required>
        <span class="input-group-text p-viewer m-0" onclick="togglePassword('exampleInputPassword', 'eyeIcon1')">
            <i id="eyeIcon1" class="fa fa-eye" aria-hidden="true"></i>
        </span>
    </div>
</div>
...
<div class="col-sm-6 login-form">
    <div class="input-group input-group-merge">
        ...
        <span class="input-group-text p-viewer m-0" onclick="togglePassword('exampleRepeatPassword', 'eyeIcon2')">
            <i id="eyeIcon2" class="fa fa-eye" aria-hidden="true"></i>
        </span>
    </div>
    ...
    function togglePassword(inputId, eyeIconId) {
        ...
        if (passwordInput.type === "password") {
            ...
            eyeIcon.classList.add("fa-eye");
                    ...
                    <!--<div class="col-sm-6 login-form">
                        <input type="password" class="form-control form-control-user" minlength="6" id="exampleRepeatPassword" placeholder="{{\App\CPU\translate('repeat_password')}}" required>
                        <span for='exampleRepeatPassword' class="p-viewer">
                          <i class="fa fa-eye" aria-hidden="true"></i>
                        </span>
                        <div class="pass invalid-feedback">{{\App\CPU\translate('Repeat')}}  {{\App\CPU\translate('password')}} {{\App\CPU\translate('not match')}} .</div>
                    </div>-->
        ...
        <div class="card __card">
            <div class="card-header">
                <h5 class="card-title m-0">
                    ...
                    {{\App\CPU\translate('Company')}} {{\App\CPU\translate('Info')}}
                </h5>
            </div>
            <style>
                select {
            ...
            <div class="card-body">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-sm-3">
                       <!-- <input type="text" class="form-control form-control-user" id="shop_country" name="country" placeholder="{{\App\CPU\translate('Country')}}" value="{{old('Country')}}" required>-->
                        <select  class="form-control form-control-user js-example-basic-multiple" id="shop_country" name="country" disabled required>
                    ...
                    <div class="col-sm-3">
                      <!--  <input type="text" class="form-control form-control-user" id="shop_state" name="state" placeholder="{{\App\CPU\translate('State')}}" value="{{old('State')}}" required>-->
                        <select  class="form-control form-control-user js-example-basic-multiple" id="shop_state" name="state"  required>
                    ...
                    <div class="col-sm-3">
                        <!--<input type="text" class="form-control form-control-user" id="shop_city" name="city" placeholder="{{\App\CPU\translate('City')}}" value="{{old('City')}}" required>-->
                        
                         <select  class="form-control form-control-user js-example-basic-multiple" id="shop_city" name="city"  required>
                    ...
                    <div class="col-sm-3">
                       <!-- <input type="text" class="form-control form-control-user" id="shop_pin" name="pincode" placeholder="{{\App\CPU\translate('Pincode')}}" value="{{old('Pincode')}}" minlength="6" maxlength="6" required>-->
                          <select  class="form-control form-control-user js-example-basic-multiple" id="shop_pin" name="pincode"  required>
                               <option> Select Pincode </option>
                            @foreach($data['pincodes'] as $pincodes )
                           
                            <option value="{{ $pincodes->id }}">{{ $pincodes->code }}</option>
                            @endforeach
                          </select>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <div class="custom-file">
                                <input type="file" name="reg_cert_image" id="LogoUpload" class="custom-file-input"
                                    accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label" for="LogoUpload">{{\App\CPU\translate('Upload')}} {{\App\CPU\translate('Company Registration Certificate')}}</label>
                                <small class="text-info">{{\App\CPU\translate('Company Registration Certificate')}}</small>
                                <input type="text" class="form-control form-control-user" id="shop_compno" name="reg_cert" placeholder="{{\App\CPU\translate('Company Registration Certificate No.')}}" value="{{old('Pincode')}}" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="custom-file">
                                <input type="file" name="gst_cert_image" id="BannerUpload" class="custom-file-input overflow-hidden __p-2p" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label" for="BannerUpload">{{\App\CPU\translate('Upload')}} {{\App\CPU\translate('GST No.')}}</label>
                                <small class="text-info">{{\App\CPU\translate('GST No')}}</small>
                                <input type="text" class="form-control form-control-user" id="shop_gst" name="gst_no" placeholder="{{\App\CPU\translate('GST No.')}}" value="{{old('Pincode')}}" minlength="15" maxlength="15" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <div class="custom-file">
                                <input type="file" name="pan_image" id="BannerUpload" class="custom-file-input overflow-hidden __p-2p" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label" for="BannerUpload">{{\App\CPU\translate('Upload')}} {{\App\CPU\translate('PAN No.')}}</label>
                              <small class="text-info">Your pan card</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        ...
                        <div class="form-group mb-0">
                            <div class="custom-file">
                                ...
                                <small class="text-info">Your company logo</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <div class="custom-file">
                                ...
                                <small class="text-info">You company banner</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <div class="custom-file">
                                 ...
                                 <small class="text-info">{{\App\CPU\translate('PAN No.')}}</small>
                                <input type="text" class="form-control form-control-user" id="shop_pan" name="pan" placeholder="{{\App\CPU\translate('PAN No.')}}" value="{{old('Pincode')}}" minlength="10" maxlength="10" length="10" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="custom-file">
                                ...
                                <small class="text-info">{{\App\CPU\translate('company_type')}}</small>
        ...
        <div class="card __card">
            <div class="card-header">
                <h5 class="card-title m-0">
                    <svg width="22" height="22" x="0" y="0" viewBox="0 0 128 128" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g
.579 6.35-2.579zm3.628 5.498c-.935-.907-2.21-1.474-3.628-1.474-1.389 0-2.636.539-3.571 1.417-.028.028-.057.057-.085.085-.937.936-1.504 2.211-1.504 3.628 0 1.389.539 2.636 1.419 3.572.028.028.057.057.085.085.936.907 2.211 1.502 3.656 1.502 1.418 0 2.693-.595 3.628-1.502.936-.936 1.502-2.211 1.502-3.657 0-1.417-.566-2.692-1.502-3.628z" fill="#000000" data-original="#000000" class=""></path></g></g></svg>
                    {{\App\CPU\translate('Bank')}} {{\App\CPU\translate('Info')}}
                </h5>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-sm-3">
                        <input type="text" class="form-control form-control-user" id="shop_bank" name="bank_name" placeholder="{{\App\CPU\translate('Bank Name')}}" value="{{old('bank_name')}}" required>
                    </div>
                    <div class="col-sm-3">
                        <input type="text" class="form-control form-control-user" id="shop_branch" name="bank_branch" placeholder="{{\App\CPU\translate('Branch Name')}}" value="{{old('bank_branch')}}" required>
                    </div>
                    <div class="col-sm-3">
                        <input type="text" class="form-control form-control-user" id="shop_account" name="acc_no" placeholder="{{\App\CPU\translate('Account No.')}}" value="{{old('acc_no')}}" required>
                    </div>
                    <div class="col-sm-3">
                        <input type="text" class="form-control form-control-user" id="shop_ifsc" name="ifsc" placeholder="{{\App\CPU\translate('IFSC')}}" value="{{old('ifsc')}}" required>
                    </div>
                    
                            <div class="col-sm-6">
                        <div class="form-group mt-5">
                            <div class="custom-file">
                                <input type="file" name="cheque" id="ChequeUpload" class="custom-file-input overflow-hidden __p-2p" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" required>
                                <label class="custom-file-label" for="ChequeUpload">{{\App\CPU\translate('Upload')}} {{\App\CPU\translate('Blank Cheque')}}</label>
                    ...
                    <div class="col-sm-6">
                        <div class="pb-3">
                            <center>
                                <img class="__img-125px object-cover" id="viewerCheque"
                                        src="{{asset('public\assets\back-end\img\400x400\img2.jpg')}}" alt="blank cheque"/>
                            </center>
                        </div>
                        </div>
                    ...
                    @if(isset($recaptcha) && $recaptcha['status'] == 1)
                        <div id="recaptcha_element" class="w-100 text-center"  data-type="image"></div>
                        <br/>
                    @else
                    <div class="col-12">
                        <div class="row py-2">
                    ...
                    <div class="col-sm-12">
                        ...
                        <button type="submit" class="btn btn--primary btn-user btn-block" id="apply" disabled>{{\App\CPU\translate('Submit')}}</button>
    ...
    $('#inputCheckd').change(function () {
            ...
            if ($(this).is(':checked')) {
                ...
                $('#apply').removeAttr('disabled');
                    ...
                    $("#show_phone_error_verified").show();
    ...
    $("#BannerUpload").change(function () {
     ...
     function readBannerURL(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                $('#viewerCheque').attr('src', e.target.result);
            }
...
<script>
        ...
        $.ajax({
            url: "{{route('shop.country')}}", // Replace with your PHP script URL{{route('shop.apply')}}
...
<script>
        ...
        $.ajax({
            url: "{{route('shop.state')}}", // Replace with your PHP script URL{{route('shop.apply')}}
            type: 'POST', // or 'GET' depending on your PHP script
            data: data,
            success: function(response) {
...
<script>
        ...
        $.ajax({
            url: "{{route('shop.city')}}", // Replace with your PHP script URL{{route('shop.apply')}}
            type: 'POST', // or 'GET' depending on your PHP script
            data: data,
            success: function(response) {
