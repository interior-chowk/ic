...
@section('content')
        ...
        <div class="row">
                        ...
                        <div class="card mt-2 rest-part">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        @if ($brand_setting)
                                            <div class="col-md-4 mb-3">
                                                <label for="name" class="title-color">{{ \App\CPU\translate('Brand') }}
                                                </label>
                                                <select
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="number" min="0" step="0.01"
                                                ...
                                                value="{{ old('Return_days') }}" name="Return_days" id="Return_days"
                                                class="form-control">
                                        </div>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="number" min="0" step="0.01"
                                                ...
                                                value="{{ old('Return_days') }}" name="Replacement_days"
                                                id="Replacement_days" class="form-control">
                                        </div>
                                        <script>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="warehouse-select" class="title-color">Warehouse / Pickup
                                                Address<span class="ml-2" data-toggle="tooltip" data-placement="top"
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="number" min="0" step="0.01"
                                                placeholder="{{ \App\CPU\translate('Hsn_code') }}" value=""
                                                name="HSN_code" class="form-control">
                                        </div>

                                        <div class="col-md-4 physical_product_show" id="shipping_cost_multy1"
                                            style="margin-top: 30px;">
                                            <div class="rounded py-2 min-h-40 d-flex justify-content-between gap-3">
                                                <label class="title-color mb-0">
                                                    {{ 'Free Delivery ' . strtolower('by') . ' Seller' }}
                                                ...
                                                <label class="switcher">
                                                    <input class="switcher_input form-control" type="checkbox"
                                                        name="free_delivery">
                                ...
                                <div class="row align-items-center mb-3 physical_product_show" id="shipping_cost_multy2">
                                    <div class="col-md-4">
                                        <div class="border rounded px-3 py-2 d-flex align-items-center justify-content-between"
                                            height="400px">
                                            <label class="switcher mr-5">
                                                <input class="switcher_input" type="checkbox"
                                                    name="available_instant_delivery" id="instant_switcher">
                                                <span class="switcher_control"></span>
                                            </label>
                                            <label class="title-color mb-0" style="text-transform: none;">
                                                <span>If this product is heavy, flammable, fragile etc. So Please enable it.
                                                    After activating it, you will get orders for this product from your city
                                                    itself and you will have to deliver this product yourself.</span>
                                            </label>
                                        </div>
                                    </div>
            ...
            `;
                ...
                `;
                                            ...
                                            const selectedCities = Array.from(selectedCitiesTags.children).map(tag => tag.textContent.trim().slice(0, -
                                                1)); // Remove cut symbol
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            $('#instant_switcher').change(function() {
                                                if ($(this).is(':checked')) {
                                                    $('.nested-select-container, .selected-container, .state-block, .selected-cities').css(
                                                        'visibility', 'visible');
                                                } else {
                                                    $('.nested-select-container, .selected-container, .state-block, .selected-cities').css(
                                                        'visibility', 'hidden');
    ...
    @endif -->
                                                            ...
                                                            <tr>
                                                                <td style="width: 20%;">
                                                                    <input type="text" name="features[]"
                                                                        ...
                                                                        readonly
                                                                        style="background-color: #F9F9FA; margin: 10; text-align: center;" />
                                                                </td>
                                                                <td style="width: 40%;">
                                                                    <input type="text"
                    ...
                    <div class="card mt-2 mb-2 rest-part">
                                ...
                                <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" {{ $lang == $default_lang ? 'required' : '' }}
                                            ...
                                            placeholder="{{ \App\CPU\translate('product_title') }}">
                                    </div>
                        ...
                        <div class="card-body pb-0">
                            <div class="row g-2">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="title-color">{{ \App\CPU\translate('search_tags') }} <span
                                                class="ml-2" data-toggle="tooltip" data-placement="top"
                                                title="{{ \App\CPU\translate('Create product tags and keywords for customers so that when they search for relevant products, your product will appear on app .') }}">
                                                <img class="info-img"
                                                    src="{{ asset('/public/assets/back-end/img/info-circle.svg') }}"
                                                    alt="img">
                                            </span></label>
                    ...
                    <div class="card mt-2 rest-part physical_product_show">
                        <div class="card-header">
                            <h5 class="mb-0">{{ \App\CPU\translate('Variations') }} <span class="ml-2"
                                    data-toggle="tooltip" data-placement="top"
                                    title="{{ \App\CPU\translate('Create product variations like colours, types, sizes etc.') }}">
                                    <img class="info-img"
                                        ...
                                        <div class="d-flex gap-2 mb-1">
                                            ...
                                            <label class="switcher">
                                                <input type="checkbox" class="switcher_input" id="color_switcher"
                                                    value="{{ old('colors_active') }}" name="colors_active" required>
                                                <span class="switcher_control"></span>
                                            </label>
                                        </div>
                                        <select
                            ...
                            <div class="form-group">
                                <div class="row align-items-end">
                                    <div class="col-md-4 mb-3" id="c1">
                                        ...
                                        <input type="number" min="0" step="0.01" placeholder="MRP"
                                            name="unit_price" id="unit_price_" value="{{ old('unit_price') }}"
                                            class="form-control">
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3 physical_product_show" id="c5">
                                        <strong>Selling / Listed price after discount ₹<span
                                                id="selling_price_">0.00</strong></h1>
        ...
        function add_more_customer_choice_option(i, name, existingValue = '') {
            ...
            $('#customer_choice_options').append(
                ...
                '[]" placeholder="{{ trans('Enter choice values') }}" data-role="tagsinput" value="' + (
                    existingValue || '') + '" onchange="update_sku()" required></div></div>'
            );
