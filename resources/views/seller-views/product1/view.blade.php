                                    ...
                                    <li class="d-flex align-items-center font-size-sm">
                                        ...
                                        <div class="progress flex-grow-1">
                                            <div class="progress-bar" role="progressbar"
                                                ...
                                                aria-valuenow="{{ $total == 0 ? 0 : ($count / $total) * 100 }}" aria-valuemin="0"
                                        ...
                                        @foreach (json_decode($product->images) as $key => $photo)
                                            <div class="col-md-3">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <img class="w-100"
                                                            onerror="this.src='{{asset('storage/app/public/images/' . $photo) }}'"
                                                            src="{{ asset('storage/app/public/images/' . $photo) }}" alt="Product image">
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
