...
@section('content')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 form-group">
                                        ...
                                        <input type="number" min="0" step="0.01" placeholder="{{ \App\CPU\translate('Replacement day') }}"
                                            value="{{ $product->replacement_days }}" name="Replacement_days" class="form-control">
                                    </div>
                                    <input type="hidden"  name="ids" class="form-control" id="ids" value="{{$product->id}}">
                                      <div class="col-md-4 form-group">
                                            <label class="title-color">{{ \App\CPU\translate('HSN_code') }}</label>
                                            <input type="text"
                                                   placeholder="{{ \App\CPU\translate('HSN Code') }}"
                                                   value="{{ $product->HSN_code }}" name="HSN_code"
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="number" min="0" step="0.01"
                                                   ...
                                                   value="{{ $product->Return_days }}" name="Return_days"
                                                   class="form-control" required>
                                        </div>
    ...
    <select class="form-control" id="warehouse-select" name="warehouse">
        ...
        @foreach ($warehouse as $b)
            <option value="{{ $b->id }}" {{ $b->id==$product->add_warehouse ? 'selected' : ''}}>{{ $b->title }}</option>
        @endforeach
    </select>
</div>
        ...
        <tbody>
            @foreach($specificationArray as $index => $spec)
                <tr>
                    ...
                    <td style="width: 40%;">
                        <input type="text" name="specification_values[{{ $index }}]" 
                               value="{{ $y[$index] ?? '' }}" 
                               class="form-control" 
                               style="margin: 10px;" />
                    </td>
        ...
        <tbody>
            @foreach($key_featureArray as $index => $feature)
                <tr>
                    ...
                    <td style="width: 40%;">
                        <input type="text" name="features_values[{{ $index }}]" 
                               value="{{ $z[$index] ?? '' }}" 
                               class="form-control" 
                               style="margin: 10px;"/>
                    </td>
