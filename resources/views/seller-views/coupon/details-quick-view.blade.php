...
<div class="coupon__details">
    <div class="coupon__details-left">
        <div class="text-center">
            ...
            <h6 class="subtitle">{{ \App\CPU\translate('code') }} : <span id="coupon_code">{{ $coupon->code }}</span>
            </h6>
        ...
        <div class="coupon-info">
            ...
            <div class="coupon-info-item">
                ...
                <span
                    id="expire_date">{{ \App\CPU\translate($coupon->coupon_bearer == 'inhouse' ? 'admin' : $coupon->coupon_bearer) }}</span>
            </div>
        </div>
    </div>
    <div class="coupon__details-right">
        <div class="coupon">
            @if ($coupon->coupon_type == 'free_delivery')
                <img src="{{ asset('public/assets/back-end/img/free-delivery.png') }}" alt="Free delivery"
                    width="100">
            @else
                <div class="d-flex">
                    <h4 id="discount">
