...
.popup-content .form-group {
    width: calc(100% / 4 - 15px); /* 4 fields per row on the first two rows */
    margin-bottom: 15px;
}

/* Adjust for the 3rd row with 3 fields per row */
.popup-content .form-row:nth-child(3) .form-group {
    width: calc(100% / 3 - 15px); /* 3 fields per row for the 3rd row */
}
                    ...
                    <div class="px-3 py-4">
                                ...
                                <form action="" method="GET">
                                    ...
                                    <div class="input-group input-group-merge input-group-custom">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                            placeholder="{{\App\CPU\translate('Search by Product Name or SKU or HSN')}}" aria-label="Search orders" value="" required>
                        ...
                        <button class="btn  btn-primary"
                            ...
                            <div class="col-lg-6 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                                ...
                                <button type="button" onclick="openPopup()" class="btn btn--primary"><i class="tio-add-circle"></i>{{\App\CPU\translate('Add warehouse')}}</button>
                            </div>
                        </div>
                    </div>
</div>
...
<td>{{$house->address}}</td>
<td>{{$house->pincode}}</td>
<td><button type="button" class="delete-btn" data-id="{{$house->id}}" ><i class="tio-delete"></i></button></td></tr>
    ...
    <div class="popup-content">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input type="" name="" id="city" disabled>
            </div>
            <div class="form-group">
                <label for="select4">State</label>
                <input type="" name="" id="state" disabled>
            </div>
            <div class="form-group">
                <label for="select5">Country</label>
                <input type="" name="" id="country" disabled>
            </div>
        </div>
