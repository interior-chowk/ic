                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="bank_name" value="{{$data->shop->bank_name}}"
                                               class="form-control" id="name"
                                               required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="name" class="title-color">{{\App\CPU\translate('Branch Name')}} <span class="text-danger">*</span></label>
                                        <input type="text" name="branch" value="{{$data->shop->bank_branch}}" class="form-control"
                                               id="name"
                                               required>
                                    </div>
                                   
                                    <div class="col-md-6 mb-3">
                                        <label for="ifsc" class="title-color">{{\App\CPU\translate('IFSC')}} <span class="text-danger">*</span></label>
                                        <input type="text" name="ifsc" value="{{$data->shop->ifsc}}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="account_no" value="{{$data->shop->acc_no}}"
                                               class="form-control" id="account_no"
                                               required>
                                    </div>
                                    
                                    <div class="col-md-12 mb-3">
                                        <label for="Cheque_id" class="title-color">{{\App\CPU\translate('Cheque')}} </label>
                                        <input type="file" name="cheque" value=""
                                               class="form-control" id="Cheque_file"
                                               >
                                    </div>
