                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 mb-3">
                                    ...
                                    <input type="number" class="js-masked-input form-control" name="phone" id="phoneLabel"
                                         ...
                                         {{ ($data->profile_edit_status == 0) ? 'readonly' : '' }}
                                         >
                                </div>
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-9" id="select-img">
                                     <div class="text-info mb-2">( * {{\App\CPU\translate('Documents should be in commonly accepted formats such as JPEG, PNG, or gif. ')}})</div>
