                                    ...
                                    <div class="card-body position-relative">
                                        ...
                                        <ul class="list-unstyled d-flex flex-column gap-4">
                                            ...
                                            <li>
                                                ...
                                                <div>{{$data->shop->ifsc ?? 'No Data found'}}</div>
                                            </li>
                                            <li>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 mb-3 text-center">
                                        <?php 
                                        $chequeImagePath = 'storage/app/public/shop/' .$data->shop->cheque_image;
                                        $chequeImageExtension = pathinfo($chequeImagePath, PATHINFO_EXTENSION);
                                        
                                        ?>
                                         @if ($chequeImageExtension != 'pdf')
                                     <img src="{{asset('storage/app/public/shop/'.$data->shop->cheque_image)}}"
                                         onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                         height="200"  alt="">
                                         @else
                                         <iframe src="{{asset('storage/app/public/shop/'.$data->shop->cheque_image)}}" style="width:600px; height:500px;" frameborder="0"></iframe>
                                         @endif
                                    </div>
