            ...
            <tr style="width: 100%;">
                <td style="width:50%;vertical-align: top; margin-top:5px;">
                    ...
                    <div style="text-align:left;margin-top:10px;">
                      <span style="color: #130505 !important;text-transform: capitalize;font-weight: bold;">{{\App\CPU\translate('customer_details')}}  </span><br>
                      ...
                      @if ($order->seller_is == 'seller')
                       ...
                       <div style="display:flex; align-items:center;margin-top:10px;">
                            ...
                            <span style="padding-left: 5px;">{{$customer->f_name . ' ' . $customer->l_name}}</span><br>
                    ...
                    {{-- <div style="margin-top:100px;"> --}}
                        ...
                        <?php $subtotal=(($details['price'])*$details->qty)+$details['tax']; ?>
                            <tr style="text-align: center;">
                                ...
                                <td style="padding:5px;"> {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($details['tax']))}}  [{{ isset($details->product_all_status->tax)? $details->product_all_status->tax : ''}}{{ isset($details->product_all_status->tax_type)? '%' : ''}}]</td>
                        ...
                        justify-content: flex-start;">
                          @foreach ($social_media as $item)
                            ...
                            <div class="" >
                              ...
                              <img src="{{asset('assets/back-end/img/'.$item->name.'.png')}}" alt="" style="height: 25px; width:25px; margin:10px;">
                              </a>
                            </div>
