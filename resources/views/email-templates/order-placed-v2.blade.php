...
<body style="background-color: #ececec;margin:0;padding:0">
    ...
    <div
                    ...
                    <td>
                        <div style="text-align: right; margin-right:15px;">
                            ...
                            <img style="max-width:250px;border:0;"
                                src="{{ asset('/storage/app/public/company/' . $logo) }}" title=""
                                class="sitelogo" width="40%" alt="" />
                        </div>
                    </td>
                </tr>
            </tbody>
                ...
                <tr style="width: 100%;">
                    <td style="width:50%;vertical-align: top; margin-top:5px;">
                        ...
                        <div style="text-align:left;margin-top:10px;">
                            <span
                                style="color: #130505 !important;text-transform: capitalize;font-weight: bold;">{{ \App\CPU\translate('customer_details') }}
                            </span><br>
                            ...
                            @if ($order->seller_is == 'seller')
                                <div style="display:flex; align-items:center;margin-top:10px;">
                                    ...
                                    <span
                                        style="padding-left: 5px;">{{ $customer->f_name . ' ' . $customer->l_name }}</span><br>
                                    <span style="padding-left: 5px;">{{ $customer->email }}</span><br>
                                    <span style="padding-left: 5px;">{{ $customer->phone }}</span>
                                </div>
                            @else
                                <div style="display:flex; align-items:center;margin-top:10px;">
                                    <span>
                ...
                <table style="width: 100%; ">
                    <tbody style="">
                        ...
                        <tr style="border-bottom: 1px ridge;text-transform: capitalize;">
                            ...
                            <th style="padding-bottom: 8px;width:15%">{{ \App\CPU\translate('Tax') }}</th>
                        ...
                        @foreach ($order->details as $key => $details)
                            <?php $subtotal = $details['price'] * $details->qty + $details['tax']; ?>
                            <tr style="text-align: center;">
                                ...
                                <td style="padding:5px;">
                                    {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($details['tax'])) }}
                ...
                <td style="text-align: right">
                    <table style="width: 46%;margin-left:41%; display: inline;text-transform: capitalize; ">
                        <tbody>
                            ...
                            <tr>
                                <td>{{ \App\CPU\translate('wallet_deduction') }} : </td>
                                <td>
                                    -
        ...
        <table style="background-color: rgb(255, 255, 255);width: 90%;margin:auto;margin-top:30px;display:none;">
            <tbody style="">
                                ...
                                @foreach ($social_media as $item)
                                    <div class="">
                                        <a href="{{ $item->link }}" target=”_blank”>
                                            <img src="{{ asset('public/assets/back-end/img/' . $item->name . '.png') }}"
                                                alt="" style="height: 25px; width:25px; margin:10px;">
                                        </a>
                                    </div>
                                @endforeach
                            </div>
