                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailContainer"
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" colspan="2"
                            ...
                            <img alt="" border="0" src="{{ url('/') . '/storage/app/public/company/' . $logo }}"
                                title="" class="sitelogo" width="60%" style="max-width:250px;" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" colspan="2"
                            ...
                            <span
                                style="font-size: 18px; font-weight: normal;">{{ \App\CPU\translate('Notification mail for new order received') }}</span>
                        </td>
