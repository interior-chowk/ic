                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="media align-items-center gap-10">
                                                        <img src="{{ \App\CPU\ProductManager::product_image_path('thumbnail') }}/{{ $detail->product_all_status['thumbnail'] }}"
                                                        ...
                                                        <div>
                                                            <a href="#" class="title-color hover-c1">
                                                                <h6>{{ substr($detail->product_all_status['name'], 0, 30) }}{{ strlen($detail->product_all_status['name']) > 10 ? '...' : '' }}
                                                                </h6>
                                                            </a>
                                                            ...
                                                            <div class="modal-content">
                                                                <form
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        @elseif(
                                                                            $detail->product_all_status->digital_product_type == 'ready_product' &&
