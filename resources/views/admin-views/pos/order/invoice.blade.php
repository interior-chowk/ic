...
<div style="width:363px">
    ...
    <div class="row mt-3">
        ...
        @if ($order->customer)
            <div class="col-12">
                <h5>{{ \App\CPU\translate('Customer Name') }} :
                ...
                @if ($detail->product)
                    <tr>
                        ...
                        <td class="text-left">
                            ...
                            {{ \App\CPU\Helpers::currency_converter(round($detail['discount'], 2)) }}
                        </td>
    ...
    <table style="color: black!important; width: 100%!important">
        ...
        <tr>
            ...
            <td class="text-right" style="font-size: 20px">
                {{ \App\CPU\Helpers::currency_converter(round($order->order_amount, 2)) }}</td>
        </tr>
    </table>
