        ...
        <div class="row pb-4 d--none" id="main-banner"
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.provider-banner.store') }}" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-responsive form-control w-100" name="banner_type" required
                                            ...
                                            @if (theme_root_path() == 'theme_aster')
                                                ...
                                                <option value="Top Side Banner">{{ \App\CPU\translate('Top Side Banner') }}
                                                </option>
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <select class="js-example-responsive form-control w-100" name="category_id"
                                            ...
                                            @foreach (\App\CPU\CategoryManager::parents() as $category)
                                                <option value="{{ $category['id'] }}"
                                                    onchange="sub_category({{ $category['id'] }})">{{ $category['name'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        <td>
                                            <div class="d-flex gap-10 justify-content-center">
                                                <a class="btn btn-outline--primary btn-sm cursor-pointer edit"
                                                    ...
                                                    href="{{ route('admin.provider-banner.edit', [$banner['id']]) }}">
                                                    <i class="tio-edit"></i>
                                                </a>
...
@push('script')
    ...
    <script>
        ...
        $('.cancel').on('click', function() {
            $('.banner_form').attr('action', "{{ route('admin.provider-banner.store') }}");
            $('#main-banner').hide();
        });
        ...
        $(document).on('change', '.status', function() {
            ...
            $.ajax({
                url: "{{ route('admin.provider-banner.status') }}",
                method: 'POST',
                data: {
                    id: id,
                    status: status
        ...
        $(document).on('click', '.delete', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.provider-banner.delete') }}",
                        method: 'POST',
                        data: {
                            id: id
                        },
