                ...
                <div class="card">
                    <div class="px-3 py-4">
                        <div class="row justify-content-between align-items-center">
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group input-group-merge input-group-custom">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                            placeholder="{{\App\CPU\translate('Search by Company Name or Name or Phone or Email or status')}}" aria-label="Search orders" value="{{ $search }}">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-6 mb-2 mb-sm-0">
                            ...
                            <div style="display:block;">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a class="dropdown-item" href="{{route('admin.sellers.export-excel')}}">{{\App\CPU\translate('Excel')}}</a></li>
                    ...
                    <div class="table-responsive">
                        <table
                            ...
                            @foreach($sellers as $key=>$seller)
                                <tr>
                                   <!-- <td>VN{{$sellers->firstItem()+$key}}</td>-->
                                   <td>VN{{$seller->id}}</td>
                                    <td>
