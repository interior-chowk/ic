                    ...
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-2 mb-md-0">
                                ...
                                <div class="flex-start flex-wrap">
                                    <div><h5>{{\App\CPU\translate('return_days')}} : </h5></div>
                    ...
                    <div class="card h-100">
                        <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="flex-start">
                                    <div><h6>{{\App\CPU\translate('bank_name')}} : </h6></div>
                                    <div class="mx-1"><h6>{{$withdraw_request->seller->shop->bank_name ? $withdraw_request->seller->shop->bank_name : 'No Data found'}}</h6></div>
                                </div>
                                <div class="flex-start">
                                    <div><h6>{{\App\CPU\translate('Branch')}} : </h6></div>
                                    <div class="mx-1"><h6>{{$withdraw_request->seller->shop->branch ? $withdraw_request->seller->shop->branch : 'No Data found'}}</h6></div>
                                </div>
                                
                                <div class="flex-start">
                                    <div><h6>{{\App\CPU\translate('account_no')}} : </h6></div>
                                    <div class="mx-1"><h6>{{$withdraw_request->seller->shop->account_no ? $withdraw_request->seller->shop->account_no : 'No Data found'}}</h6></div>
                                </div>
                                <div class="flex-start">
                                    <div><h6>{{\App\CPU\translate('IFSC')}} : </h6></div>
                                    <div class="mx-1"><h6>{{$withdraw_request->seller->shop->ifsc ? $withdraw_request->seller->shop->ifsc : 'No Data found'}}</h6></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card h-100">
                        <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                            ...
                            <div class="flex-start" >
                                <div class="mx-1" style="display: contents;"><h5>{{\App\CPU\translate('address')}} :
                                {{$withdraw_request->seller->shop->address}}</h5></div>
                            </div>
