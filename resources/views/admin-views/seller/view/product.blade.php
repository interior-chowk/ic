                        ...
                        <div class="card h-100">
                            <div class="px-3 py-4">
                                <h5 class="mb-0 d-flex align-items-center gap-2">
                                    ...
                                    <span class="badge badge-soft-dark radius-50 fz-12">{{$products->total()}}</span>
                                           ...
                                           <div class="col-lg-10 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                            ...
                            <div style="display:block;">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a class="dropdown-item" href="{{route('admin.product.seller-export-excel',[$seller->id, ''])}}">{{\App\CPU\translate('Excel')}}</a></li>
                                    <div class="dropdown-divider"></div>
                                </ul>
                            </div>
                            <a href="{{route('admin.product.stock-limit-list',['in_house'])}}" class="btn btn-info" style="display:none;">
