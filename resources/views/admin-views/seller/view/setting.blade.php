                ...
                @if ($seller->status == 'pending')
                    <div class="mt-4 pr-2">
                        <div class="flex-start">
                            ...
                            <div>
                                <h4>{{ \App\CPU\translate('Seller request for open a shop') }}.</h4>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-6 mt-3">
                <form action="{{ url()->current() }}"
                    style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};" method="GET">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0"> {{ \App\CPU\translate('Sales Commission') }} : </h5>
                            <label class="switcher">
                                <input type="checkbox" name="commission_status" class="switcher_input" value="1"
                ...
                <form action="{{ url()->current() }}"
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <label class="switcher">
                                <input type="checkbox" name="gst_status" class="switcher_input" value="1"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url()->current() }}" method="GET">
                            @csrf
                            <label
                                class="title-color d-flex">{{ \App\CPU\translate('Seller POS permission on/off') }}</label>
                            <div class="d-flex align-items-center gap-2 mb-1">
                                <input class="" name="seller_pos" type="radio" value="1" id="seller_pos1"
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <input class="" name="seller_pos" type="radio" value="0" id="seller_pos2"
                                    {{ $seller['pos_status'] == 0 ? 'checked' : '' }}>
