...
@section('content')
                ...
                @if ($seller->status=="pending")
                    <div class="mt-4 pr-2 float-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}">
                        ...
                        <div class="text-center">
                            <form class="d-inline-block" action="{{route('admin.sellers.updateStatus')}}" method="POST" enctype="multipart/form-data">
                                @csrf
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header text-capitalize">
                        <h5 class="mb-0">{{\App\CPU\translate('Seller')}} {{\App\CPU\translate('Account')}}</h5>
                         ...
                         @if($seller->profile_edit_status== 1)
                            <form class="d-inline-block" action="{{route('admin.sellers.updateProfileStatus')}}" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{$seller->id}}">
                    ...
                    <div class="card-body"
                        ...
                        <div class="flex-start">
                            <div><h6>{{\App\CPU\translate('profile_Status')}} : </h6></div>
                            <div class="mx-1">
                                <h6>{!! $seller->profile_edit_status== 1?'<label class="badge badge-success">Approved</label>':'<label class="badge badge-danger">Not-Approved</label>' !!}</h6>
                            </div>
                        </div>
                        <div class="flex-start">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body"
                            ...
                            <div class="flex-start" >
                                ...
                                {{$seller->shop->address}}. 
                                {{$seller->shop->city}}, {{$seller->shop->state}}, {{$seller->shop->pincode}}
                            </h5></div>
                            </div>
                            <div class="flex-start">
                               
                                <div class="mx-1" style="display: contents;">
                                   <h5>{{\App\CPU\translate('billing_address')}} : {{$seller->shop->billing_address}}. 
                                {{$seller->shop->city}}, {{$seller->shop->state}}, {{$seller->shop->pincode}}
                            </h5></div>
                            </div>
                    ...
                    <div class="card-body"
                        ...
                        <div class="mt-2">
                            <div class="flex-start">
                                ...
                                <div class="mx-1">
                                    <h6>{{$seller->shop->name ? $seller->shop->bank_name : \App\CPU\translate('No Data found')}}</h6>
                                </div>
                            </div>
                            <div class="flex-start">
                            ...
                            <div class="flex-start">
                                ...
                                <div class="mx-1">
                                    <h6>{{$seller->shop->acc_no ? $seller->shop->acc_no : \App\CPU\translate('No Data found')}}</h6>
                                </div>
                            </div>
                             <div class="flex-start">
                                <div><h6>{{\App\CPU\translate('IFSC')}} : </h6></div>
                                <div class="mx-1">
                                    <h6>{{$seller->shop->ifsc ? $seller->shop->ifsc : \App\CPU\translate('No Data found')}}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body"
                        ...
                        <div class="mt-2">
                            <div class="flex-start" style="display:none;">
                                <div><h6>Reg. Certificate : </h6></div>
                                <div class="mx-1">
                                    <h6>
                                        
                                        <a href="{{asset('storage/shop')}}/{{$seller->shop->reg_cert_image}}" target="_blank">
                            ...
                            <div class="flex-start">
                                <div><h6>GST Certificate : </h6></div>
                                <div class="mx-1">
                                    <h6>
                                        
                                        <a href="{{asset('storage/shop')}}/{{$seller->shop->gst_cert_image}}" target="_blank">
                            ...
                            <div class="flex-start">
                                ...
                                <div class="mx-1">
                                    <h6>
                                        <a href="{{asset('storage/shop')}}/{{$seller->shop->pan_image}}" target="_blank">
                            ...
                            <div class="flex-start">
                                <div><h6>Cheque : </h6></div>
                                <div class="mx-1">
                                    <h6>
                                        <a href="{{asset('storage/shop')}}/{{$seller->shop->cheque_image}}" target="_blank">
                ...
                <div class="card">
                    ...
                    <div class="card-body"
                        ...
                        <div class="mt-2">
                                   ...
                                   <div class="text-center">
                                       <?php
                                         $gstCertImagePath = 'storage/shop/' . $seller->shop->gst_cert_image;
                                        ...
                                        src="{{asset('storage/shop/'.$seller->shop->gst_cert_image)}}" alt="Product thumbnail"/>
                                        @else
                                         <a href="{{ asset('storage/shop/' . $seller->shop->gst_cert_image) }}" class="btn btn-primary" target="_blank">Click
                ...
                <div class="card">
                    ...
                    <div class="card-body"
                        ...
                        <div class="mt-2">
                                   ...
                                   <div class="text-center">
                                       <?php
                                        $panImagePath = 'storage/shop/' . $seller->shop->pan_image;
                                         $panImageExtension = pathinfo($panImagePath, PATHINFO_EXTENSION);
                                        ?>
                                        @if ($panImageExtension != 'pdf')
                                        <img class="upload-img-view" id="gstviewer"
                                        onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                        src="{{asset('storage/shop/'.$seller->shop->pan_image)}}" alt="Product thumbnail"/>
                                         @else
                                         <a href="{{ asset('storage/shop/' . $seller->shop->pan_image) }}" class="btn btn-primary" target="_blank">Click
                ...
                <div class="card">
                    ...
                    <div class="card-body"
                        ...
                        <div class="mt-2">
                                   ...
                                   <div class="text-center">
                                        <?php 
                                        $chequeImagePath = 'storage/shop/' .$seller->shop->cheque_image;
                                        ...
                                        <img class="upload-img-view" id="gstviewer"
                                        onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                        src="{{asset('storage/shop/'.$seller->shop->cheque_image)}}" alt="Product thumbnail"/>
                                         @else
                                         <a href="{{ asset('storage/shop/' . $seller->shop->cheque_image) }}" class="btn btn-primary" target="_blank">Click
                    ...
                    <div class="card-body"
                        ...
                        <div class="mt-2">
                                   ...
                                   <div class="text-center">
                                        <img class="upload-img-view" id="gstviewer"
                                        onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                        src="{{asset('storage/seller/'.$seller->signature)}}" alt="Product thumbnail"/>
                                    </div>
    ...
    <input type="file" id="file" placeholder="{{ \App\CPU\translate('file') }}"
    value="" name="" class="form-control" style="display: none">
