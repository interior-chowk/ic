                        ...
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                    ...
                                    placeholder="{{ \App\CPU\translate('Ex') }}: Jhone" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control form-control-user" id="exampleInputPhone"
                                    ...
                                    placeholder="{{ \App\CPU\translate('Ex') }}: +09587498" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="bottom_banner" id="BottomBannerUpload"
                                            ...
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label"
                                            for="BottomBannerUpload">{{ translate('Upload') }} {{ translate('Bottom') }}
