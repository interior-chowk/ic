                ...
                <form action="{{ route('admin.sellers.withdraw-method.update') }}" method="POST">
                    ...
                    <div class=" p-30">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="reset"
                                class="btn btn--secondary mx-2">{{ \App\CPU\translate('Reset') }}</button>
                            <button type="submit"
                                class="btn btn--primary demo_check">{{ \App\CPU\translate('Submit') }}</button>
                        </div>
                    </div>
                </form>
            </div>
