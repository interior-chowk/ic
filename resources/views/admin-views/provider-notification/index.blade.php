    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.provider-notification.store') }}" method="post"
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                <a class="btn btn-outline--primary btn-sm edit square-btn"
                                                    ...
                                                    href="{{ route('admin.provider-notification.edit', [$notification['id']]) }}">
                                                    <i class="tio-edit"></i>
                                                </a>
...
@push('script_2')
    <script>
        ...
        $(document).on('change', '.status', function() {
            ...
            $.ajax({
                url: "{{ route('admin.provider-notification.status') }}",
                method: 'POST',
                data: {
                    id: id,
                    status: status
        ...
        $(document).on('click', '.delete', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.provider-notification.delete') }}",
                        method: 'POST',
                        data: {
                            id: id
                        },
    ...
    <script>
        ...
        function resendNotification(t) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: '{{ route('admin.provider-notification.resend-notification') }}',
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            id: id
