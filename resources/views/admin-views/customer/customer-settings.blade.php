                        ...
                        <div class="card-body">
                            <div class="loyalty-point-section" id="customer_loyalty_point_section">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="Signup_refer_point_sender" min="0"
                                            value="{{$data['Signup_refer_point_sender']??'0'}}">
                                </div>
                                
                                <div class="form-group">
                                    <label class="title-color d-flex"
                                           for="intem_purchase_point">{{\App\CPU\translate('Signup_refer_point_(receiver)')}}</label>
                                    <input type="number" class="form-control" name="Signup_refer_point_receiver" min="0"
                                            value="{{$data['Signup_refer_point_receiver']??'0'}}">
                                </div>
                            </div>
