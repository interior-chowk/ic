...
<main id="content" role="main" class="main">
    ...
    <div class="container py-2 py-sm-7">
        ...
        <a class="d-flex justify-content-center mb-1" href="javascript:">
            <img class="z-index-2" height="100" src="{{asset("storage/company/".$e_commerce_logo)}}" alt="Logo"
                ...
                <div class="card card">
                    <div class="card-body">
                        ...
                        <form id="form-id" action="{{route('admin.auth.login')}}" method="post">
                            ...
                            <div class="text-center">
                                <div class="">
                                    <h4 class="display-4">{{\App\CPU\translate('sign_in')}}</h4>
                            ...
                            @else
                                <div class="row">
                                    <div class="col-6 pr-0">
                                        <input type="text" class="form-control border-0" name="default_captcha_value" value=""
                            ...
                            <button type="submit" class="btn btn-block btn--primary">{{\App\CPU\translate('sign_in')}}</button>
                        </form>
                        <!-- End Form -->
                    </div>
                    @if(env('APP_MODE')=='demo')
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-10">
                                    <span>{{\App\CPU\translate('Email')}} : {{\App\CPU\translate('admin@admin.com')}}</span>
