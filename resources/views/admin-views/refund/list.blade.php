                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-12 col-md-4">
                        <select name="filter" class="form-control" onchange="handleSelectChange(this)">
                            ...
                            <option value="{{ route('admin.refund-section.refund.list', ['pending']) }}"
                                {{ request()->is('admin/refund-section/refund/list/pending') ? 'selected' : '' }}>
                                {{ \App\CPU\translate('pending') }}</option>
                            <option value="{{ route('admin.refund-section.refund.list', ['approved']) }}"
                                {{ request()->is('admin/refund-section/refund/list/approved') ? 'selected' : '' }}>
                                {{ \App\CPU\translate('approved') }}</option>
                            <option value="{{ route('admin.refund-section.refund.list', ['refunded']) }}"
                                {{ request()->is('admin/refund-section/refund/list/refunded') ? 'selected' : '' }}>
                                {{ \App\CPU\translate('refunded') }}</option>
                            <option value="{{ route('admin.refund-section.refund.list', ['rejected']) }}"
                                {{ request()->is('admin/refund-section/refund/list/rejected') ? 'selected' : '' }}>
