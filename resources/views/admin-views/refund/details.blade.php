    ...
    <div class="content container-fluid">
        ...
        <div class="row gy-2">
                        ...
                        <form action="{{ route('admin.refund-section.refund.order.update-id', $order->id) }}"
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div><span class="text-dark">#@if($order->order_return_id == null){{$order->id}}@else{{$order->order_return_id}}@endif</span></div>
                                </div>
                                <div class="col-md-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">{{ \App\CPU\translate('refund_remarks') }}</h4>
                    </div>
                    <div class="card-body">
                        <div class="col-12">
                            <p>
