<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li style="display:none;" class="{{ Request::is('admin/stock/product-in-wishlist') ?'active':'' }}"><a href="{{route('admin.stock.product-in-wishlist')}}">{{\App\CPU\translate('Wish_Listed_Products')}}</a></li>
    </ul>
</div>
