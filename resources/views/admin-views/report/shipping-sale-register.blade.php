...
@section('title', \App\CPU\translate('Shipping Register Report'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{ \App\CPU\translate('Shipping_Register_Report') }}
            </h2>
        </div>
        <!-- End Page Title -->
                ...
                <table id="datatable" style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};"
                    ...
                    <thead class="thead-light thead-50 text-capitalize">
                        <tr>
                            ...
                            <th>{{ \App\CPU\translate('Invoice Amount') }}<small>(Incl. GST)</small></th>
                            ...
                            <th>{{ \App\CPU\translate('Delivery_type') }}</th>
                            <th>{{ \App\CPU\translate('Total') }}<small>(Incl. GST)</small></th>
                        </tr>
                    </thead>
                    @php
                        $countRow = 1;
...
@else
    ...
    @endif
                                ...
                                @if ($customer_state == $seller_state)
                                    <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($shipping_gst / 2)) }}
                                    </td>
                                    <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($shipping_gst / 2)) }}
                                    </td>
                                    <td>-</td>
                                ...
                                <td>
                                    {{ $order->instant_delivery_type == 0 ? 'Standard' : 'Instant' }}
                                </td>
