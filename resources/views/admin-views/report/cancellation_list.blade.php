                ...
                <table id="datatable"
                    ...
                    @foreach($orders as $key=>$order)
                        <tr>
                            ...
                            <td>
                                <a class="title-color" href="{{route('admin.orders.details',['id'=>$order->id])}}" target="_blank">{{$order->id}}</a>
                            </td>
                            ...
                            <td>{{str_replace('_',' ',$order['transaction_ref'])}} {{ $order->payment_method == 'offline_payment' ? '('.$order->payment_by.')':'' }}</td>
