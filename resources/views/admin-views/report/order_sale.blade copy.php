                        ...
                        @foreach ($orders as $key => $order)
                            ...
                            @foreach ($orderDetails->details as $key => $details)
                                ...
                                <tr>
                                    ...
                                    <td class="toggle billing-column d-none">
                                        {{ $sku_product->listed_price + $order->shipping_cost + $order->discount_amount - $order->wallet_deduction }}
                                    </td>
                                    <td class="toggle billing-column d-none">
                                    ...
                                    <td class="toggle earning-column d-none">
                                        {{ ($sku_product->commission_fee * $sku_product->listed_percent) / 100 }}</td>
                                    <td class="toggle earning-column d-none">{{ '5' }}</td>
                                    <td class="toggle earning-column d-none">
                                        {{ number_format((($sku_product->listed_price + $order->shipping_cost + $order->discount_amount) * 5) / 100, 2) }}
                                    </td>
                                    <td class="toggle earning-column d-none">
                                        {{ number_format((($sku_product->listed_price + $order->shipping_cost + $order->discount_amount) * 5) / 100 + ($sku_product->commission_fee * $sku_product->listed_percent) / 100, 2) }}
                                    </td>
                                    @if ($customer_state == $state_name)
                                        <td class="toggle earning-column d-none">
                                    ...
                                    <td class="toggle earning-column d-none">
                                        ...
                                        @endif --}}
                                        @php
                                            // Calculate earning for this order
                                            if ($order->shipping_cost != 0) {
                                                $earning =
                                                    $sku_product->listed_price +
                                                    $order->shipping_cost_amt +
