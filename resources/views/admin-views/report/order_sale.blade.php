  ...
  <span>Earning Details</span>
    ...
    ->value('states.name');
                           ...
                           ?>
                             ...
                             <!-- <td>{{ number_format($order->order_amount + $order->discount_amount - $order->shipping_cost, 2) }}</td> -->
                              ...
                              <td class="toggle billing-column d-none">@if($order->coupon_discount_bearer == 'inhouse'){{ $order->discount_amount }}@endif</td>
                               ...
                               <!-- <td>{{ $sku_product->listed_price }}</td> -->
                                <td class="toggle billing-column d-none">{{ $sku_product->listed_price + $order->shipping_cost + $order->discount_amount }}</td>
                                 <td class="toggle billing-column d-none">-</td>
                                  <td class="toggle billing-column d-none">{{ $sku_product->listed_price + $order->shipping_cost + $order->discount_amount  }}</td>
                                   <td class="toggle billing-column d-none">{{str_replace('_',' ',$order['razorpay_payment_id'])}} {{ $order->payment_method == 'offline_payment' ? '('.$order->payment_by.')':'' }}</td>
                                    ...
                                    <td class="toggle earning-column d-none">{{ number_format((($sku_product->listed_price + $order->shipping_cost + $order->discount_amount) * 5) / 100, 2) }}</td>
                                    <td class="toggle earning-column d-none">{{ number_format(((($sku_product->listed_price + $order->shipping_cost + $order->discount_amount)*5)/100) + (($sku_product->commission_fee*$sku_product->listed_percent)/100),2)}}</td>
                                    
                                     
                                    @if($customer_state == $seller_state)
                            <td class="toggle earning-column d-none">{{ number_format((((($sku_product->listed_price + $order->shipping_cost + $order->discount_amount)*5)/100) + (($sku_product->commission_fee*$sku_product->listed_percent)/100))*0.09, 2) }}
</td>
                            <td class="toggle earning-column d-none">{{ number_format((((($sku_product->listed_price + $order->shipping_cost + $order->discount_amount)*5)/100) + (($sku_product->commission_fee * $sku_product->listed_percent)/100)) * 0.09, 2) }}
</td>
                            ...
                            <td class="toggle earning-column d-none">-</td>
                            <td class="toggle earning-column d-none">-</td>
                            <td class="toggle earning-column d-none">{{ number_format((((($sku_product->listed_price + $order->shipping_cost + $order->discount_amount) * 5) / 100) + (($sku_product->commission_fee * $sku_product->listed_percent) / 100)) * 0.18, 2) }}
</td>
                            
                            @endif
                            <td class="toggle earning-column d-none">{{ number_format((((((($sku_product->listed_price + $order->shipping_cost + $order->discount_amount) * 5) / 100) + (($sku_product->commission_fee * $sku_product->listed_percent) / 100)) * 0.18) + ((($sku_product->listed_price + $order->shipping_cost + $order->discount_amount) * 5) / 100) + (($sku_product->commission_fee * $sku_product->listed_percent) / 100)), 2) }}
</td>
                                    <td class="toggle earning-column d-none">{{   number_format(( $sku_product->listed_price + $order->shipping_cost + $order->discount_amount) - ($order->shipping_cost)- (((((($sku_product->listed_price + $order->shipping_cost + $order->discount_amount)*5)/100) + (($sku_product->commission_fee*$sku_product->listed_percent)/100))*0.18)  + ((($sku_product->listed_price + $order->shipping_cost + $order->discount_amount)*5)/100) + (($sku_product->commission_fee*$sku_product->listed_percent)/100)) -($order->discount_amount),2) }}</td> 
                                    @php
