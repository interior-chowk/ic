                        ...
                        @foreach ($orders as $key => $order)
                            ...
                            @foreach ($orderDetails->details as $key => $details)
                                ...
                                <tr>
                                    ...
                                    <!-- <td>{{ date('d-m-Y', strtotime($order['created_at'])) }}</td> -->
                                    <td>{{ $order->billingAddress ? $order->billingAddress['contact_person_name'] : '' }}
                                    </td>
                                    ...
                                    <td>{{ $details->qty }}</td>
                                    <td>No.</td>
                                    <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($price_product)) }}
                                    </td>
                                    <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($price_product - $discountPrice)) }}
                                    </td>
                                    <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($discountPrice)) }}
                                    </td>
                                    <td>
                                        {{ isset($details->product_all_status->tax) ? $details->product_all_status->tax : '' }}
                                    </td>
