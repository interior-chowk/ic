            ...
            <form method="POST" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="category" class="form-control" placeholder="e.g. Technology" required>
                    </div>
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea name="description" id="description-editor" class="form-control" rows="6" placeholder="Write full blog description here..." required></textarea>
                    </div>
                </div>
