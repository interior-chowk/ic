                        ...
                        <form action="{{route('admin.coupon.store-coupon')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4 form-group coupon_type first_order">
                                    ...
                                    <select class="js-example-basic-multiple js-states js-example-responsive form-control" id="customer_id_1" name="customer_id" >
                                ...
                                <div class="col-md-6 col-lg-12 form-group">
                                    <label for="name" class="title-color font-weight-medium d-flex">{{\App\CPU\translate('Description')}}</label>
                                    <textarea id="description" type="date" name="description" value="{{ old('description') }}" class="form-control"
                                        placeholder="{{\App\CPU\translate('enter_description')}}" required></textarea>
                                </div>
                            </div>
...
<script>
    $('#discount_type').on('change', function (){
       ...
       $("#customer_id_").change(function(){
                 var customer_id =  $("#customer_id_").val();
                 alert(customer_id);
             var data = {
        ...
        $.ajax({
            url: "{{route('admin.coupon.customer_phone')}}", // Replace with your PHP script URL{{route('shop.apply')}}
