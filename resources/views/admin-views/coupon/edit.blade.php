                            ...
                            <div class="col-md-6 col-lg-4 form-group coupon_type first_order">
                                ...
                                <select class="js-example-basic-multiple js-states js-example-responsive form-control" name="customer_id" >
                                    ...
                                    @foreach($customers as $customer)
                                        <option value="{{ $customer->id }}" {{$c['customer_id']==$customer->id ? 'selected':''}}>{{ $customer->f_name. ' '. $customer->l_name . ' ' .'[ '. $customer->phone .' ]' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 col-lg-4 form-group first_order">
                            ...
                            <div class="col-md-6 col-lg-4 form-group">
                             ...
                             <div class="col-md-6 col-lg-12 form-group">
                                    ...
                                    <textarea id="description" type="date" name="description" value="{{ old('description') }}" class="form-control"
                                        placeholder="{{\App\CPU\translate('enter_description')}}" required>{{ $c['description'] }}</textarea>
                            </div>
                        </div>
