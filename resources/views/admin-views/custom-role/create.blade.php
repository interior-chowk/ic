                            ...
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2">
                                    <input type="checkbox" class="module-checkbox parent" name="modules[]" value="dashboard"
                                        id="dashboard">
                                    <label for="dashboard"
                                        class="title-color mb-0">{{ \App\CPU\translate('Dashboard') }}</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2">
                                    <input type="checkbox" class="module-checkbox parent" name="modules[]" value="orders"
                                        id="orders">
                                    <label for="orders"
                                        class="title-color mb-0">{{ \App\CPU\translate('Orders') }}</label>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2">
                                    <input type="checkbox" class="module-checkbox parent" name="modules[]" value="approval"
                                        id="approval">
                                    <label for="approval"
                                        class="title-color mb-0">{{ \App\CPU\translate('Approval') }}</label>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2">
                                    <input type="checkbox" class="module-checkbox parent" name="modules[]" value="create"
                                        id="create">
                                    <label for="create"
                                        class="title-color mb-0">{{ \App\CPU\translate('Create') }}</label>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2">
                                    <input type="checkbox" class="module-checkbox parent" name="modules[]"
                                        value="list" id="list">
                                    <label for="list"
                                        class="title-color mb-0">{{ \App\CPU\translate('List') }}</label>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <label for="offers_deals"
                                        class="title-color mb-0">{{ \App\CPU\translate('Offers & Deals') }}</label>
                                </div>
                        ...
                        <div class="col-sm-12 col-lg-6 mb-3">
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <label for="reviews"
                                        class="title-color mb-0">{{ \App\CPU\translate('Reviews') }}</label>
                                </div>
                        ...
                        <div class="col-sm-12 col-lg-6 mb-3">
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <label for="reports"
                                        class="title-color mb-0">{{ \App\CPU\translate('Reports') }}</label>
                                </div>
                        ...
                        <div class="col-sm-12 col-lg-6 mb-3">
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <label for="employees"
                                        class="title-color mb-0">{{ \App\CPU\translate('Employees') }}</label>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <label for="system_settings"
                                        class="title-color mb-0">{{ \App\CPU\translate('System settings') }}</label>
                                </div>
