                                ...
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <div class="form-group " id="{{ $lang }}-form">
                                            <label for="exampleFormControlInput1">Commission Fee<span
                                        ...
                                        <div class="form-group " id="{{ $lang }}-form">
                                            <label>Service Tag<span class="text-danger">*</span>
                                            </label>
                                            <select name="service_tag" class="form-control" required>
                                                <option value="">Select Service Tag</option>

                                                @foreach (App\Model\ServiceCategory::where('parent_id', '!=', 0)->get() as $serCat)
<option value="{{ $serCat->id }}">{{ $serCat->name }}</option>
@endforeach
                                            </select>
                ...
                <div class="card">
                    <div class="px-3 py-4">
                        <div class="row align-items-center">
                            <div class="col-sm-8 col-md-4 col-lg-4 mb-2 mb-sm-0">
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group input-group-custom input-group-merge">
                                        <select name="filter" class="form-control">
                                            <option value="" selected disabled>
                                                {{ \App\CPU\translate('filter_category') }}</option>
                                            @foreach (\App\Model\Category::where(['position' => 0])->get() as $category)
                        ...
                        <table style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th class="text-center">{{ \App\CPU\translate('main') }}
                                        {{ \App\CPU\translate('category') }}</th>
                                    <th class="text-center">{{ \App\CPU\translate('sub_category') }}
                            ...
                            <tbody>
                                @foreach ($categories as $key => $category)
                                    <tr>
                                        ...
                                        @if ($parent_category)
                                            <td class="text-center">{{ $parent_category['name'] }}</td>
                                        @else
                                            <td> </td>
                                        @endif
