                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input name="position" value="1" class="d-none">
                                     ...
                                     <div class="form-group "
                                             id="{{$lang}}-form">
                                            <label
                                                   for="exampleFormControlInput1">Commission Fee<span class="text-danger">*</span>
                                                </label>
                                            <input type="number" name="commission" class="form-control"
                                                   placeholder="commission fee" {{$lang == $default_lang? 'required':''}}>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="title-color"
                             ...
                             <form  action="{{ url()->current() }}" method="GET">
                               <div class="input-group input-group-custom input-group-merge">
                                    <select name="filter" class="form-control">
                                         <option value="" selected disabled>{{\App\CPU\translate('filter_category')}}</option>
                                           @foreach(\App\Model\Category::where(['position'=>0])->get() as $category)
                        ...
                        <table style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th class="text-center">{{ \App\CPU\translate('main')}} {{ \App\CPU\translate('category')}}</th>
