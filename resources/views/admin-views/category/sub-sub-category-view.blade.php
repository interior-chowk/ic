...
@section('content')
                                        ...
                                        <div class="form-group">
                                            <label class="title-color text-capitalize"
                                             ...
                                             <select name="sub_parent_id" id="parent_id" class="form-control">
                                                  <option value="" disabled selected>{{\App\CPU\translate('Select_sub_category')}}</option>
  ...
  <div class="col-12">
    ...
    <div class="input-box" id="inputBox1">
      <input type="text" name="specification" placeholder="Enter text for specification key" class="form-control">
    </div>
  </div>
<br><br>
  <div class="col-12">
    ...
    <div class="input-box" id="inputBox2">
      <input type="text" name="key_features" placeholder="Enter text for key features" name="" class="form-control">
    </div>
  </div>
  <br><br>
  <div class="col-12">
    ...
    <div class="input-box" id="inputBox3">
      <input type="text" name="technical_specification" placeholder="Enter text for specification key" class="form-control">
    </div>
  </div>
<br><br>
  <div class="col-12">
    ...
    <div class="input-box" id="inputBox4">
      <input type="text" name="other_details" placeholder="Enter text for key features" name="" class="form-control">
    </div>
  </div>
                            ...
                            <div class="col-lg-6 from_part_2">
                                        ...
                                        <div class="custom-file text-left">
                                            <input type="text" name="meta_title" id=""
                                                class="form-control" value="" placeholder="meta title">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 form-group pt-4">
                                        <label class=""
                                            for="">{{ \App\CPU\translate('meta description') }}
                                            ({{ strtoupper($lang) }})</label>
                        ...
                        <div class="row align-items-center">
                             ...
                             <form  action="{{ url()->current() }}" method="GET">
                               <div class="input-group input-group-custom input-group-merge">
                                    <select name="filter" class="form-control">
                                         <option value="" selected disabled>{{\App\CPU\translate('filter_sub_category')}}</option>
                                           @foreach(\App\Model\Category::where(['position'=>1])->orderBy('name')->get() as $sub_category)
                                                <option value="{{$sub_category['id']}}" {{ ($filter == $sub_category['id']) ? 'selected' : '' }}>{{$sub_category['name']}}</option>
                                            @endforeach
                            ...
                            <div class="col-sm-7 col-md-2 col-lg-2">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.sub-sub-category.all-category-excel') }}">
