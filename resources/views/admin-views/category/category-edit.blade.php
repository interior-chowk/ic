...
<style>
    .input-box {
      display: none; /* By default input box hidden hoga */
      margin-top: 10px;
    }
  </style>
@section('content')
                                    ...
                                    @if($category['position'] == 1)
                                     ...
                                     <div class="form-group "
                                            ...
                                            <label class="title-color"
                                                   for="exampleFormControlInput1">{{\App\CPU\translate('commission')}} <span class="text-danger">*</span>
                                                </label>
                                            <input required type="number" name="commission" class="form-control"
                                                   placeholder="{{\App\CPU\translate('commission')}}" value="{{$category['commission']}}" {{$lang == $default_lang? 'required':''}}>
                                        </div>
                                    @endif
    ...
    <div class="input-box" id="inputBox1">
      <input type="text" name="specification" required placeholder="Enter text for specification key" class="form-control" value="{{$category->specification}}">
    </div>
  </div>
<br>
  <div class="col-12">
    ...
    <div class="input-box" id="inputBox2">
      <input type="text" required name="key_features" placeholder="Enter text for key features" name="" class="form-control" value="{{$category->key_features}}">
    </div>
  </div>
  <br>
  <div class="col-12">
    <button type="button" class="btn btn--primary" id="btn3">Technical Specificatons</button>
    <div class="input-box" id="inputBox3">
      <input type="text" required name="technical_specification" placeholder="Enter text for specification key" class="form-control" value="{{$category->technical_specification}}">
    </div>
  </div>
<br>
  <div class="col-12">
    ...
    <div class="input-box" id="inputBox4">
      <input type="text" required name="other_details" placeholder="Enter text for key features" name="" class="form-control" value="{{$category->other_details}}">
    </div>
  </div>
  <br>
...
<label class="title-color">{{\App\CPU\translate('Meta_Title')}}</label>
    <span class="text-info"><span class="text-danger">*</span></span>
        <div class="custom-file text-left">
        <input type="text" required name="meta_title" id="" class="form-control" placeholder="meta title" value="{{$category->meta_title}}">
                                        </div>
                                    </div>
    ...
    <label class="switcher mx-auto">
        <input type="checkbox" class="status switcher_input"
               id="{{$category->id}}" {{$category->status == 1 ? 'checked' : ''}}>
