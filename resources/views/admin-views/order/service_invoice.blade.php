                ...
                <tbody>
                    @foreach ($order->details as $key => $details)
                        ...
                        <tr class="no-top-border">
                            ...
                            <td class="text-right">
                                ₹{{ ($details->qty * $sku->listed_percent * $sku->commission_fee) / 100 }}</td>

                            @if ($customer_state == $seller_state)
                                <td class="text-right">
                                    {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency((($details->qty * $sku->listed_percent * $sku->commission_fee) / 100) * 0.09)) }}
                                </td>
                                <td class="text-right">
                                    {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency((($details->qty * $sku->listed_percent * $sku->commission_fee) / 100) * 0.09)) }}
                                </td>
                            ...
                            @else
                                ...
                                <td>-</td>
                                <td class="text-right">
                                    {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency((($details->qty * $sku->listed_percent * $sku->commission_fee) / 100) * 0.18)) }}
                                </td>
                            @endif
                            <td class="text-right">
