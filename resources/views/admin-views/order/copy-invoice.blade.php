            ...
            <table class="customers bs-0">
                ...
                <tbody>
                    @foreach ($order->details as $key => $details)
                        @php $subtotal=(($details['price'])*$details->qty)+$details['tax'] @endphp
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>
                                ...
                                @endif
                                <br>
                                {{ \App\CPU\translate('HSN_code') }} :
                                {{ $details['product']->HSN_code ? $details['product']->HSN_code : '' }}

                            </td>

                            <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($details['price'])) }}
                            </td>
                            <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($details['tax'])) }}
        ...
        <table class="fz-12">
            <tr>
                ...
                <p class="fz-12 font-normal">
                    ...
                    <h4 class="fz-12 mb-1">{{ \App\CPU\translate('Payment') }} {{ \App\CPU\translate('Method') }}</h4>
                    <p class="fz-12 font-normal">
                        {{ \App\CPU\translate($order['payment_method']) }}
                    </p>
                    ...
                    @if ($order->delivery_type != null)
                        ...
                        @if ($order->delivery_type == 'self_delivery')
                            <p class="fz-12 font-normal">
                                ...
                                <br>
                                <span>
                                    {{ \App\CPU\translate('delivery_man_phone') }} :
                        ...
                        <tbody>
                            ...
                            @if ($order->order_type == 'default_type')
                                @if ($order->instant_delivery_type == 1)
                                    ...
                                    <tr>
                                        <td class="p-1 text-left">{{ \App\CPU\translate('instant_delivery_amount') }}
                                        </td>
                                        <td class="p-1">
                                            {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($instant_delivery_amount)) }}
                                        </td>
                                    </tr>
                                @else
                                    <tr>
                            ...
                            <tr>
                                <td class="p-1 text-left">{{ \App\CPU\translate('wallet_deduction') }}</td>
                                <td class="p-1">
                                    - {{ $order->wallet_deduction }} </td>
                            </tr>
                            ...
                            <tr>
                                <td class="border-dashed-top font-weight-bold text-left">
                                    <b>{{ \App\CPU\translate('total') }}</b></td>
                                <td class="border-dashed-top font-weight-bold">
                                    {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($order->order_amount - $order->wallet_deduction)) }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
