            ...
            <table class="customers bs-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($plan['price'])) }}
                        </td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="border: none;">
                            {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($plan['price'])) }}
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="border-right: none; border-left: none;">
                            {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency(($plan['price'] * 18) / 100)) }}
                        </td>
