    ...
    <div class="content-position-y">
        <table class="customers bs-0">
            ...
            <tbody>
                ...
                @php $subtotal=($plan['price']+(($plan['price']*18)/100)) @endphp
                <tr>
                    ...
                    <td>
                       ...
                       <br>
                       {{\App\CPU\translate('Description')}} : {{$plan['plan_description']}}
                        
                    </td>
                     
                    <td>{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($plan['price']))}}</td>
                    <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency(18)) }}%</td>
        ...
        <table class="customers bs-0">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td style="border: none;">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($plan['price']))}}</td>  
                   
                  <td  style="border: none;">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency(18))}}%</td>  
                  <td  style="border: none;">{{(($plan['price']*18)/100)}}</td> 
                ...
                <tr >
                 ...
                 <tr >
                  ...
                  <td  style="border-right: none; border-left: none;">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency((($plan['price']*18)/100)))}}</td>    
