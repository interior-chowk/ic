                    ...
                    <table>
                        <tr>
                            <td>
                                    ...
                                    <span class="h2" style="margin: 0px;">{{\App\CPU\translate('company_address')}} </span>
                                    <div class="h4 montserrat-normal-600">
                                       <p style=" margin-top: 6px; margin-bottom:0px;">{{$company_name ? $company_name : ""}}</p>
                                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$company_phone ? $company_phone : ""}}</p>
                                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$company_email? $company_email : ""}}</p>
                ...
                <td>
                    <table>
                        <tr>
                            <td class="text-right">
                                @if ($plan->provider)
                                    <span class="h2" >{{\App\CPU\translate('service_provider_address')}} </span>
                                    <div class="h4 montserrat-normal-600">
                                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$plan->provider ? $plan->provider['name'] : ""}}</p>
                                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$plan->provider ? $plan->provider['phone'] : ""}}</p>
                                        <span style="display:ruby-text">
                                        <span class="h3" style="margin: 0px;">{{\App\CPU\translate('permanent_address')}} : </span>
                                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$plan->provider ? $plan->provider['permanent_address'] : ""}}</p>
                                        </span>
                                        <span style="display:ruby-text">
                                        <span class="h3" style="margin: 0px;">{{\App\CPU\translate('current_address')}} : </span>
                                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$plan->provider ? $plan->provider['current_address'] : ""}}</p>
                                       </span>
                                    </div>
                                @endif
                            </td>
        ...
        <table class="customers bs-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($plan->membership->price - $subtotalwithoutax))}}</td>
        ...
        <table class="customers bs-0">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td style="border: none;">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($plan->membership->price))}}</td>  
                   
                  <td  style="border: none;">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency(18))}}%</td>  
                ...
                <tr >
                 ...
                 <tr >
                  ...
                  <td  style="border-right: none; border-left: none;">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency((($plan->membership->price*18)/100)))}}</td>    
                ...
                <tr >
                  <td style="border-right: none;" colspan="4">
                      ...
                      If you require any assistance or have feedback or suggestions about our app, You can connect us at <a href="mail::to({{ $company_email }})">{{ $company_email }}</a> or 0120-6027176
                  </td>  
