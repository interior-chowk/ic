                        ...
                        <form action="{{route('admin.Membership_plan.add-data')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="text" name="plan_name" class="form-control" value="{{ old('plan_name') }}" id="plan_name"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="text" name="plan_description" class="form-control" value="{{ old('plan_description') }}" id="plan_description"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="number" min="0" step="0.01" name="price" class="form-control" value="{{ old('price') }}" id="price"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="number" min="0" name="free_2d_design" class="form-control" value="{{ old('free_2d_design') }}" id="free_2d_design"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="number" min="0" name="free_3d_design" class="form-control" value="{{ old('free_3d_design') }}" id="free_3d_design"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="number" min="0" step="0.01" name="reward_value" class="form-control" value="{{ old('reward_value') }}" id="reward_value"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <select class="form-control" id="listing_view" name="listing_view" required>
                                        <option value="Posting Date Wise">{{\App\CPU\translate('Posting Date Wise')}}</option>
                                        <option value="Rotation Wise & Business Wise">{{\App\CPU\translate('Rotation Wise & Business Wise')}}</option>
                                    </select>
                                </div>
                                <div class="col-md-6 col-lg-4 form-group">
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="number" min="0" step="0.01" name="discount_on_delivery" class="form-control" value="{{ old('discount_on_delivery') }}" id="discount_on_delivery"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="number" min="0" step="0.01" name="discount_on_yearly_plan" class="form-control" value="{{ old('discount_on_yearly_plan') }}" id="discount_on_yearly_plan"
                        ...
                        <table id="datatable"
                            ...
                            @foreach($mem as $k=>$m)
                                <tr>
                                    ...
                                    <td>
                                       <strong> <div>{{substr($m['plan_name'],0,20)}}</div></strong>
