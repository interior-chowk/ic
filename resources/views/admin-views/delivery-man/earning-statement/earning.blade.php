                ...
                <div class="row g-2">
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="business-analytics">
                            ...
                            <h2 class="business-analytics__title">
                                {{ $total_earn ? \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($total_earn)) : \App\CPU\BackEndHelper::set_symbol(0) }}
                            </h2>
                            <img src="{{ asset('public/assets/back-end/img/aw.png') }}" width="40"
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="business-analytics">
                            ...
                            <h2 class="business-analytics__title">
                                {{ $withdrawable_balance <= 0 ? \App\CPU\BackEndHelper::set_symbol(0) : \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($withdrawable_balance)) }}
                            </h2>
                            <img src="{{ asset('public/assets/back-end/img/pw.png') }}" width="40"
                                class="business-analytics__img" alt="">
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="business-analytics">
                            ...
                            <img src="{{ asset('public/assets/back-end/img/withdraw.png') }}" width="40"
                                class="business-analytics__img" alt="">
                        </div>
                                ...
                                <form action="" method="GET">
                                    <div class="input-group input-group-merge input-group-custom">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                            placeholder="{{ \App\CPU\translate('Search_by_order_no') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="media align-items-center gap-10 flex-wrap">
                                                        <a class="title-color"
                                                            title="{{ \App\CPU\translate('order_details') }}"
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <div class="text-center p-4">
                                                        ...
                                                        <p class="mb-0">
                                                            {{ \App\CPU\translate('no_earning_history_found') }}</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
