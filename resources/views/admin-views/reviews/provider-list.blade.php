                        ...
                        <div>
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a class="dropdown-item"
                                        href="{{ route('admin.reviews.export', ['provider_id' => $provider_id, 'customer_id' => $customer_id, 'status' => $status, 'from' => $from, 'to' => $to]) }}">{{ \App\CPU\translate('Excel') }}</a>
                                </li>
                        ...
                        @foreach ($reviews as $key => $review)
                            ...
                            @if ($review->provider)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.provider.view', [$review['provider_id']]) }}"
