                            ...
                            <div class="row g-3 align-items-end">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-responsive form-control w-100" name="banner_type" required
                                            ...
                                            <option value="Instant Delivery Banner">
                                                {{ \App\CPU\translate('Instant Delivery Banner') }}</option>
                                            <option value="Main Banner 2">{{ \App\CPU\translate('Main Banner 2') }}</option>
                                            <option value="Service Provider Banner 1">
                                                {{ \App\CPU\translate('Service Provider Banner 1') }}</option>
                                            <option value="Service Provider Banner 2">
                                                {{ \App\CPU\translate('Service Provider Banner 2') }}</option>
                                            <option value="Service Provider Banner 3">
                                                {{ \App\CPU\translate('Service Provider Banner 3') }}</option>
                                            <option value="Banner 2">{{ \App\CPU\translate('Banner 2') }}</option>
                                            {{-- <option value="Banner 3">{{ \App\CPU\translate('Banner 3') }}</option> --}}
                                            <option value="Mobile:1">{{ \App\CPU\translate('Mobile:1') }}</option>
                                            <option value="Mobile:2">{{ \App\CPU\translate('Mobile:2') }}</option>
                                            <option value="Mobile:3">{{ \App\CPU\translate('Mobile:3') }}</option>
                                            <option value="Mobile:4">{{ \App\CPU\translate('Mobile:4') }}</option>
                                            <option value="Mobile:5">{{ \App\CPU\translate('Mobile:5') }}</option>
                                            <option value="Mobile:6">{{ \App\CPU\translate('Mobile:6') }}</option>
                                            <option value="Mobile:7">{{ \App\CPU\translate('Mobile:7') }}</option>
                                            <option value="Desktop:1">{{ \App\CPU\translate('Desktop:1') }}</option>
                                            <option value="Desktop:2">{{ \App\CPU\translate('Desktop:2') }}</option>
                                            <option value="Desktop:3">{{ \App\CPU\translate('Desktop:3') }}</option>
                                            <option value="Desktop:4">{{ \App\CPU\translate('Desktop:4') }}</option>
                                            <option value="Desktop:5">{{ \App\CPU\translate('Desktop:5') }}</option>
                                            <option value="Desktop:6">{{ \App\CPU\translate('Desktop:6') }}</option>
                                            <option value="Desktop:7">{{ \App\CPU\translate('Desktop:7') }}</option>
                                            ...
                                            <option value="Discount 1">{{ \App\CPU\translate('Discount Banner 1') }}
                                            </option>
                                            <option value="Discount 2">{{ \App\CPU\translate('Discount Banner 2') }}
                                            </option>
                                            <option value="Discount 3">{{ \App\CPU\translate('Discount Banner 3') }}
                                            </option>
                                            <option value="Discount 4">{{ \App\CPU\translate('Discount Banner 4') }}
                                            </option>
                                            <option value="Discount 5">{{ \App\CPU\translate('Discount Banner 5') }}
                                            </option>
                                            ...
                                            <option value="Product page banner 1">
                                                {{ \App\CPU\translate('Product page banner 1') }}</option>
                                            <option value="Product page banner 2">
                                                {{ \App\CPU\translate('Product page banner 2') }}</option>
                                            <option value="Seasonal Banner">{{ \App\CPU\translate('Seasonal Banner') }}
                                            </option>
                                            <!--web-->
                                            <option value="Seasonal Banner web">
                                                {{ \App\CPU\translate('Seasonal Banner Web') }}</option>
                                            <option value="Main Banner web">{{ \App\CPU\translate('Main Banner web') }}
                                            </option>
                                            <option value="Instant Delivery Banner web">
                                                {{ \App\CPU\translate('Instant Delivery Banner web') }}</option>
                                            <option value="Main Banner 2 web">{{ \App\CPU\translate('Main Banner 2 web') }}
                                            </option>
                                            <option value="Service Provider Banner 1 web">
                                                {{ \App\CPU\translate('Service Provider Banner 1 web') }}</option>
                                            <option value="Service Provider Banner 2 web">
                                                {{ \App\CPU\translate('Service Provider Banner 2 web') }}</option>
                                            <option value="Service Provider Banner 3 web">
                                                {{ \App\CPU\translate('Service Provider Banner 3 web') }}</option>
                                            ...
                                            <option value="Banner 10 web">{{ \App\CPU\translate('Banner 10 web') }}
                                            </option>
                                            <option value="Discount 1 web">
                                                {{ \App\CPU\translate('Discount Banner 1 web') }}</option>
                                            <option value="Discount 2 web">
                                                {{ \App\CPU\translate('Discount Banner 2 web') }}</option>
                                            <option value="Discount 3 web">
                                                {{ \App\CPU\translate('Discount Banner 3 web') }}</option>
                                            <option value="Discount 4 web">
                                                {{ \App\CPU\translate('Discount Banner 4 web') }}</option>
                                            <option value="Discount 5 web">
                                                {{ \App\CPU\translate('Discount Banner 5 web') }}</option>
                                            <option value="Choice 1 web">{{ \App\CPU\translate('Creators Choice 1 web') }}
                                            </option>
                                            <option value="Choice 2 web">{{ \App\CPU\translate('Creators Choice 2 web') }}
                                            </option>
                                            <option value="Choice 3 web">{{ \App\CPU\translate('Creators Choice 3 web') }}
                                            </option>
                                            <option value="Choice 4 web">{{ \App\CPU\translate('Creators Choice 4 web') }}
                                            </option>
                                            <option value="Choice 5 web">{{ \App\CPU\translate('Creators Choice 5 web') }}
                                            </option>
                                            ...
                                            <option value="Luxury BG web">{{ \App\CPU\translate('Luxury BG web') }}
                                            </option>
                                            <option value="Day BG web">{{ \App\CPU\translate('Deal of the day BG web') }}
                                            </option>
                                            <option value="Discount BG web">{{ \App\CPU\translate('Discount BG web') }}
                                            </option>
                                            <option value="Product page banner 1 web">
                                                {{ \App\CPU\translate('Product page banner 1 web') }}</option>
                                            <option value="Product page banner 2 web">
                                                {{ \App\CPU\translate('Product page banner 2 web') }}</option>
                                            ...
                                            @if (theme_root_path() == 'theme_aster')
                                                <option value="Header Banner">{{ \App\CPU\translate('Header Banner') }}
                                                </option>
                                                <option value="Sidebar Banner">{{ \App\CPU\translate('Sidebar Banner') }}
                                                </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select onchange="display_data(this.value)"
                                            class="js-example-responsive form-control w-100" name="resource_type"
                                            required>
                                    ...
                                    <div class="form-group d--none" id="resource-shop">
                                        <label for="shop_id"
                                            class="title-color">{{ \App\CPU\translate('shop') }}</label>
                                    ...
                                    <div class="form-group mt-4 mb-0">
                                        ...
                                        <input type="text" name="discount" class="form-control" id="url"
                                ...
                                <div class="col-md-6 d-flex flex-column justify-content-end">
                                    <div>
                                        ...
                                        <span class="text-info" id="theme_ratio">( {{ \App\CPU\translate('ratio') }} 4:1
                                            )</span>
                                        <div class="custom-file text-left">
