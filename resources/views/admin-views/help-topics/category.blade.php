...
<a href="{{route('admin.helpTopic.subcategory')}}" class="btn btn--primary btn-icon-split for-addFaq">
    <i class="tio-add"></i>
    <span class="text">{{\App\CPU\translate('Add')}} {{\App\CPU\translate('faq')}} {{\App\CPU\translate('Subategory')}} </span>
</a>
<div class="row">
    <div class="col-md-12">
        <!-- Add Category -->
            ...
            <div class="card-body text-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }}">
                <form action="{{ route('admin.helpTopic.category.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="{{ \App\CPU\translate('Category Name') }}" required>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr id="data-{{ $category->id }}">
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-danger delete-category" data-id="{{ $category->id }}" data-toggle="tooltip" data-placement="top" title="{{ \App\CPU\translate('Delete') }}">
