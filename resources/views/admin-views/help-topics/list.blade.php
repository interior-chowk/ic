            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.helpTopic.category') }}"
                            class="btn btn--primary btn-icon-split for-addFaq">
                            <i class="tio-add"></i>
                            <span class="text">{{ \App\CPU\translate('Add') }} {{ \App\CPU\translate('faq') }}
                                {{ \App\CPU\translate('Category') }} </span>
                        </a>
                            ...
                            <table
                                ...
                                <tbody>
                                    @foreach ($helps as $k => $help)
                                        @php
                                            $category = App\Model\HelpTopicCategory::where(
                                                'id',
                                                $help->category_id,
                                            )->first();
                                            $subcategory = App\Model\HelpTopicSubCategory::where(
                                                'id',
                                                $help->sub_cat_id,
                                            )->first();
                                        @endphp
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                $('#subcategory').append('<option name="' + value
                                    .sub_cat_name + '" value="' + value.id + '">' +
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.category_id) {
                        $.ajax({
                            url: "{{ url('admin/helpTopic/get-subcategories') }}/" + data
                                .category_id,
                            type: 'GET',
                            dataType: 'json',
                            success: function(subcats) {
                                $('#e_subcategory').empty().append(
                                    '<option value="">-- Select Subcategory --</option>'
                                    );
                                $.each(subcats, function(key, value) {
                                    $('#e_subcategory').append('<option value="' +
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('#e_subcategory').empty().append(
                            '<option value="">-- Select Subcategory --</option>');
                        $.each(data, function(key, value) {
                            $('#e_subcategory').append('<option value="' + value.id + '">' +
                                value.sub_cat_name + '</option>');
                        });
                    }
                });
