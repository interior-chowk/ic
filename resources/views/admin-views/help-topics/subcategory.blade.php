            ...
            <div class="card-body text-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }}">
                ...
                <form action="{{ route('admin.helpTopic.subcategory.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sub_cat_name" class="form-control" placeholder="{{ \App\CPU\translate('Subcategory Name') }}" required>
                    </div>
                    <div class="form-group">
                        <label>{{ \App\CPU\translate('Link') }}</label>
                        <input type="text" name="link" class="form-control" placeholder="{{ \App\CPU\translate('Link') }}">
                    </div>
                    <div class="form-group">
                        <label>{{ \App\CPU\translate('Link Name') }}</label>
                        <input type="text" name="link_name" class="form-control" placeholder="{{ \App\CPU\translate('Link Name') }}">
                    </div>
                    <div class="form-group">
                        <label>{{ \App\CPU\translate('Link Short Description') }}</label>
                        <input type="text" name="link_short_description" class="form-control" placeholder="{{ \App\CPU\translate('Link Short Description') }}">
                    </div>
                        ...
                        <form method="POST" id="editForm">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label>{{ \App\CPU\translate('Subcategory Name') }}</label>
                                        <input type="text" name="sub_cat_name" id="edit_category_name" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                    <label>{{\App\CPU\translate('Link')}}</label>
                                    <input type="text" class="form-control" name="link"
                                        placeholder="{{\App\CPU\translate('Type Link')}}"
                                        id="e_link">
                                </div>
                                <div class="form-group">
                                    <label>{{\App\CPU\translate('Link Name')}}</label>
                                    <input type="text" class="form-control" name="link_name"
                                        placeholder="{{\App\CPU\translate('Type Link Name')}}"
                                        id="e_link_name">
                                </div>
                                <div class="form-group">
                                    <label>{{\App\CPU\translate('Link Short Description')}}</label>
            ...
            Swal.fire({
                ...
                if (result) {
                    $.post("{{ route('admin.helpTopic.subcategory.delete') }}", {
                        ...
                        toastr.success('{{ \App\CPU\translate("Deleted successfully") }}');
                        $('#data-' + id).fadeOut();
                    });
                }
            });
