                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="text" name="scheme_name" class="form-control"
                                        value="{{ $sm->scheme_name }}" id="scheme_name"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <select class="form-control" id="scheme_type_id" name="scheme_type" required>
                                        ...
                                        <option value="1" {{ 1 == $sm->scheme_type ? 'selected' : '' }}>
                                            {{ \App\CPU\translate('brand') }}</option>
                                        <option value="2" {{ 2 == $sm->scheme_type ? 'selected' : '' }}>
                                            {{ \App\CPU\translate('seller_/_store') }}</option>
                                        <option value="3" {{ 3 == $sm->scheme_type ? 'selected' : '' }}>
                                            {{ \App\CPU\translate('Products') }}</option>
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <select class="form-control" id="plan_id" name="plan_id" required>
                                        ...
                                        @foreach ($plans as $id => $plan_name)
                                            <option value="{{ $id }}"
                                                {{ $id == $sm->plan_id ? 'selected' : '' }}>{{ $plan_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="number" min="0" step="0.01" name="puchase_target_amount"
                                        class="form-control" value="{{ $sm->puchase_target_amount }}"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="text" name="rewards" class="form-control" value="{{ $sm->rewards }}"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <select class="form-control" id="isActive" name="isActive" required>
                                        <option value="1" {{ 1 == $sm->isActive ? 'selected' : '' }}>
                                            {{ \App\CPU\translate('Yes') }}</option>
                                        <option value="0" {{ 0 == $sm->isActive ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6 col-lg-12 form-group scheme-section" id="brand_section">
                                        ...
                                        <select class="form-control" id="brand_id" name="brand_ids[]" multiple="multiple">
                                            @foreach ($brands as $id => $name)
                                                <option value="{{ $id }}"
                                                    {{ in_array($id, json_decode($sm->brand_ids, true)) ? 'selected' : '' }}>
                                                    {{ $name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-12 form-group scheme-section" id="seller_section">
                                        ...
                                        <select class="form-control" id="seller_id" name="seller_ids[]" multiple="multiple">
                                            @foreach ($sellers as $id => $f_name)
                                                <option value="{{ $id }}"
                                                    {{ in_array($id, json_decode($sm->seller_ids, true)) ? 'selected' : '' }}>
                                                    {{ $f_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-12 form-group scheme-section" id="product_section">
                                        ...
                                        <select class="form-control" id="products_id" name="products_id[]"
                                            ...
                                            @foreach ($products as $id => $name)
                                                <option value="{{ $id }}"
                                                    {{ in_array($id, json_decode($sm->products_id, true)) ? 'selected' : '' }}>
                                                    {{ $name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 col-lg-12 form-group">
                                    ...
                                    <textarea name="Description" class="form-control" id="Description"
                                        placeholder="{{ \App\CPU\translate('Description') }}" required>{{ $sm->Description }}</textarea>
                                </div>
