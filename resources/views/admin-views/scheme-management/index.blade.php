                        ...
                        <form action="{{route('admin.Scheme_management.add-data')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="text" name="scheme_name" class="form-control" value="{{ old('scheme_name') }}" id="scheme_name"
                                ...
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="number" min="0" step="0.01" name="puchase_target_amount" class="form-control" value="{{ old('puchase_target_amount') }}" id="puchase_target_amount"
                                 ...
                                 <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="number" min="0" step="0.01" name="duration" class="form-control" value="{{ old('duration') }}" id="duration"
                                 ...
                                 <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <input type="text"  name="rewards" class="form-control" value="{{ old('rewards') }}" id="rewards"
                               ...
                               <div class="col-md-6 col-lg-12 form-group">
                                    ...
                                    <textarea name="Description" class="form-control" id="Description" placeholder="{{ \App\CPU\translate('Description') }}" required>{{ old('Description') }}</textarea>
                                </div>
                        ...
                        <table id="datatable"
                            ...
                            @foreach($scheme as $k=>$m)
                                <tr>
                                    ...
                                    <td>
                                       <strong> <div>{{substr($m['scheme_name'],0,20)}}</div></strong>
