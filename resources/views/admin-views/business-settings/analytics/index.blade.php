                            ...
                            <div class="col-12 mb-3">
                                <form
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="title-color d-flex">{{ \App\CPU\translate('pixel_analytics_your_pixel_id') }}</label>
                                        <textarea type="text" placeholder="{{ \App\CPU\translate('pixel_analytics_your_pixel_id_from_facebook') }}"
                                            class="form-control" name="pixel_analytics">{{ env('APP_MODE') != 'demo' ? $pixel_analytics ?? '' : '' }}</textarea>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <form
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="title-color d-flex">{{ \App\CPU\translate('google_tag_manager_id') }}</label>
                                        <textarea type="text" placeholder="{{ \App\CPU\translate('google_tag_manager_script_id_from_google') }}"
                                            class="form-control" name="google_tag_manager_id">{{ env('APP_MODE') != 'demo' ? $google_tag_manager_id ?? '' : '' }}</textarea>
                                    </div>
                                    <div class="d-flex justify-content-end">
                                        <button type="{{ env('APP_MODE') != 'demo' ? 'submit' : 'button' }}"
                                            onclick="{{ env('APP_MODE') != 'demo' ? '' : 'call_demo()' }}"
