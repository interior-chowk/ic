<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li style="display:none;" class="{{ Request::is('admin/social-login/view') ?'active':'' }}"><a href="{{route('admin.social-login.view')}}">{{\App\CPU\translate('Social_Media_Login')}}</a></li>
        <li style="display:none;" class="{{ Request::is('admin/social-media-chat/view') ?'active':'' }}"><a href="{{route('admin.social-media-chat.view')}}">{{\App\CPU\translate('Social_Media_Chat')}}</a></li>
    </ul>
</div>
