    ...
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p>*{{ \App\CPU\translate('By_turning_on_maintaince_mode,_all_your_app_and_customer_side_website_will_be_off._Only_admin_panel_and_seller_panel_will_be_functional') }}
                </p>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex">{{ \App\CPU\translate('company') }}
                                    {{ \App\CPU\translate('name') }}</label>
                                <input class="form-control" type="text" name="company_name"
                                    value="{{ $companyName->value ? $companyName->value : ' ' }}" placeholder="New Business">
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            @php($company_whatapp_number = \App\Model\BusinessSetting::where('type', 'company_whatapp_number')->first())
                            <div class="form-group">
                                <label class="title-color d-flex">{{ \App\CPU\translate('whatapp_number') }}</label>
                                <input class="form-control" type="text" name="company_whatapp_number"
                                    value="{{ $company_whatapp_number->value ? $company_whatapp_number->value : '' }}"
                                    placeholder="New Business">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ isset($shop_address) != null ? $shop_address : '' }}"
                                    ...
                                    placeholder="{{ \App\CPU\translate('Your_shop_address') }}" required>
                            </div>
                        </div>
                        @php($default_location = \App\CPU\Helpers::get_business_settings('default_location'))
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="title-color d-flex">{{ \App\CPU\translate('latitude') }}</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="title-color d-flex">{{ \App\CPU\translate('longitude') }}</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="title-color d-flex">{{ \App\CPU\translate('time') }}
                                    {{ \App\CPU\translate('zone') }}</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id="country" name="country" class="form-control  js-select2-custom">
                                    ...
                                    <option value="AG" {{ $cc ? ($cc == 'AG' ? 'selected' : '') : '' }}>Antigua and Barbuda
                                    </option>
                                    ...
                                    <option value="BO" {{ $cc ? ($cc == 'BO' ? 'selected' : '') : '' }}>Bolivia, Plurinational
                                        State
                                        of
                                    </option>
                                    <option value="BQ" {{ $cc ? ($cc == 'BQ' ? 'selected' : '') : '' }}>Bonaire, Sint Eustatius
                                        and
                                        Saba
                                    </option>
                                    ...
                                    <option value="BN" {{ $cc ? ($cc == 'BN' ? 'selected' : '') : '' }}>Brunei Darussalam
                                    </option>
                                    ...
                                    <option value="CF" {{ $cc ? ($cc == 'CF' ? 'selected' : '') : '' }}>Central African
                                        Republic
                                    </option>
                                    ...
                                    <option value="CX" {{ $cc ? ($cc == 'CX' ? 'selected' : '') : '' }}>Christmas Island
                                    </option>
                                    ...
                                    <option value="DO" {{ $cc ? ($cc == 'DO' ? 'selected' : '') : '' }}>Dominican Republic
                                    </option>
                                    ...
                                    <option value="GQ" {{ $cc ? ($cc == 'GQ' ? 'selected' : '') : '' }}>Equatorial Guinea
                                    </option>
                                    ...
                                    <option value="FK" {{ $cc ? ($cc == 'FK' ? 'selected' : '') : '' }}>Falkland Islands
                                        (Malvinas)
                                    </option>
                                    ...
                                    <option value="PF" {{ $cc ? ($cc == 'PF' ? 'selected' : '') : '' }}>French Polynesia
                                    </option>
                                    <option value="TF" {{ $cc ? ($cc == 'TF' ? 'selected' : '') : '' }}>French Southern
                                        Territories
                                    </option>
                                    ...
                                    <option value="HM" {{ $cc ? ($cc == 'HM' ? 'selected' : '') : '' }}>Heard Island and
                                        McDonald
                                        Islands
                                    </option>
                                    ...
                                    <option value="IR" {{ $cc ? ($cc == 'IR' ? 'selected' : '') : '' }}>Iran, Islamic Republic
                                        of
                                    </option>
                                    ...
                                    <option value="KP" {{ $cc ? ($cc == 'KP' ? 'selected' : '') : '' }}>Korea, Democratic
                                        People's
                                        Republic of
                                    </option>
                                    <option value="KR" {{ $cc ? ($cc == 'KR' ? 'selected' : '') : '' }}>Korea, Republic of
                                    </option>
                                    ...
                                    <option value="MH" {{ $cc ? ($cc == 'MH' ? 'selected' : '') : '' }}>Marshall Islands
                                    </option>
                                    ...
                                    <option value="FM" {{ $cc ? ($cc == 'FM' ? 'selected' : '') : '' }}>Micronesia, Federated
                                        States
                                        of
                                    </option>
                                    <option value="MD" {{ $cc ? ($cc == 'MD' ? 'selected' : '') : '' }}>Moldova, Republic of
                                    </option>
                                    ...
                                    <option value="MP" {{ $cc ? ($cc == 'MP' ? 'selected' : '') : '' }}>Northern Mariana
                                        Islands
                                    </option>
                                    ...
                                    <option value="PG" {{ $cc ? ($cc == 'PG' ? 'selected' : '') : '' }}>Papua New Guinea
                                    </option>
                                    ...
                                    <option value="RU" {{ $cc ? ($cc == 'RU' ? 'selected' : '') : '' }}>Russian Federation
                                    </option>
                                    <option value="RW" {{ $cc ? ($cc == 'RW' ? 'selected' : '') : '' }}>Rwanda</option>
                                    <option value="BL" {{ $cc ? ($cc == 'BL' ? 'selected' : '') : '' }}>Saint Barthélemy
                                    </option>
                                    <option value="SH" {{ $cc ? ($cc == 'SH' ? 'selected' : '') : '' }}>Saint Helena, Ascension
                                        and
                                        Tristan da Cunha
                                    </option>
                                    ...
                                    <option value="MF" {{ $cc ? ($cc == 'MF' ? 'selected' : '') : '' }}>Saint Martin (French
                                        part)
                                    </option>
                                    <option value="PM" {{ $cc ? ($cc == 'PM' ? 'selected' : '') : '' }}>Saint Pierre and
                                        Miquelon
                                    </option>
                                    ...
                                    <option value="SY" {{ $cc ? ($cc == 'SY' ? 'selected' : '') : '' }}>Syrian Arab Republic
                                    </option>
                                    <option value="TW" {{ $cc ? ($cc == 'TW' ? 'selected' : '') : '' }}>Taiwan, Province of
                                        China
                                    </option>
                                    <option value="TJ" {{ $cc ? ($cc == 'TJ' ? 'selected' : '') : '' }}>Tajikistan</option>
                                    <option value="TZ" {{ $cc ? ($cc == 'TZ' ? 'selected' : '') : '' }}>Tanzania, United
                                        Republic of
                                    </option>
                                    ...
                                    <option value="TT" {{ $cc ? ($cc == 'TT' ? 'selected' : '') : '' }}>Trinidad and Tobago
                                    </option>
                                    ...
                                    <option value="TC" {{ $cc ? ($cc == 'TC' ? 'selected' : '') : '' }}>Turks and Caicos
                                        Islands
                                    </option>
                                    ...
                                    <option value="VI" {{ $cc ? ($cc == 'VI' ? 'selected' : '') : '' }}>Virgin Islands, U.S.
                                    </option>
                                    <option value="WF" {{ $cc ? ($cc == 'WF' ? 'selected' : '') : '' }}>Wallis and Futuna
                                    </option>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <label class="title-color d-flex">{{ \App\CPU\translate('Currency') }}
                                {{ \App\CPU\translate('Position') }}</label>
                            <div class="form-row">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio custom-radio-reverse"
                                            ...
                                            <label class="custom-control-label media align-items-center"
                                                ...
                                                <span class="media-body">{{ \App\CPU\translate('Right') }}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{ \App\CPU\translate('forgot_password_verification_by') }}
                                </label>
                                <select name="forgot_password_verification" class="form-control  js-select2-custom">
                                    <option value="email" {{ isset($fpv) ? ($fpv == 'email' ? 'selected' : '') : '' }}>Email
                                    </option>
                                    <option value="phone" {{ isset($fpv) ? ($fpv == 'phone' ? 'selected' : '') : '' }}>Phone
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex gap-1">{{ \App\CPU\translate('OTP_verification') }}<span
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex gap-1">{{ \App\CPU\translate('email') }}
                                    {{ \App\CPU\translate('verification') }}<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="title-color d-flex gap-1">{{ \App\CPU\translate('order_verification') }}<span
                                        class="text-danger">*</span></label>
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="order_verification" id="order_verification1"
                                                {{ $order_verification == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="order_verification" id="order_verification2"
                                                {{ $order_verification == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{ \App\CPU\translate('Company_Copyright_Text') }}</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex">{{ \App\CPU\translate('pagination') }}
                                    {{ \App\CPU\translate('settings') }}</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ $decimal_point->value }}" name="decimal_point_settings"
                                    class="form-control" min="0" placeholder="{{ \App\CPU\translate('4') }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            'secondary' => null,
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    ...
                                    <label
                                        class="title-color text-capitalize">{{ \App\CPU\translate('Primary_Color') }}</label>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            @if (theme_root_path() == 'theme_aster')
                                <div class="form-group">
                                    <input type="color" name="primary_light"
                                        value="{{ isset($data->primary_light) ? $data->primary_light : '#CFDFFB' }}"
                                        class="form-control form-control_color">
                                    <div class="text-center">
                                        <div class="title-color mb-4 mt-3">#CFDFFB</div>
                                        <label
                                            class="title-color text-capitalize">{{ \App\CPU\translate('Primary_Light_Color') }}</label>
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            ...
                            <div class="mt-4 position-relative">
                                ...
                                <label class="custom-file-label"
                                    for="customFileUploadWL">{{ \App\CPU\translate('choose') }}
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            ...
                            <div class="position-relative mt-4">
                                <input type="file" name="company_footer_logo" id="customFileUploadWFL"
                                    class="custom-file-input" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                    for="customFileUploadWFL">{{ \App\CPU\translate('choose') }}
                                    {{ \App\CPU\translate('file') }}</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            ...
                            <div class="position-relative mt-4">
                                <input type="file" name="company_fav_icon" id="customFileUploadFI"
                                    class="custom-file-input" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                    for="customFileUploadFI">{{ \App\CPU\translate('choose') }}
                                    {{ \App\CPU\translate('file') }}</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            ...
                            <div class="position-relative mt-4">
                                <input type="file" name="loader_gif" id="customFileUploadLoader"
                                    class="custom-file-input" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                    for="customFileUploadLoader">{{ \App\CPU\translate('choose') }}
                                    {{ \App\CPU\translate('file') }}</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            ...
                            <div class="mt-4 position-relative">
                                <input type="file" name="company_mobile_logo" id="customFileUploadML"
                                    class="custom-file-input" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                    for="customFileUploadML">{{ \App\CPU\translate('choose') }}
                                    {{ \App\CPU\translate('file') }}</label>
                            </div>
                        </div>
                    </div>
            ...
            $("#phone_verification_on").click(function() {
                @if (env('APP_MODE') != 'demo')
                    if ($('#email_verification_on').prop("checked") == true) {
                        ...
                        const message =
                            "{{ \App\CPU\translate('Both Phone & Email verification can not be active at a time') }}";
                        toastr.info(message);
                    }
                @else
                    call_demo();
