        ...
        <div class="row gx-2 gx-lg-3 mt-2">
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-body">
                        <form
                            action="{{ env('APP_MODE') != 'demo' ? route('admin.business-settings.map-api-update') : 'javascript:' }}"
                            method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="title-color d-flex">{{ \App\CPU\translate('map_api_key') }}
                                            ({{ \App\CPU\translate('client') }})</label>
                                        <input type="text"
                                            placeholder="{{ \App\CPU\translate('map_api_key') }} ({{ \App\CPU\translate('client') }})"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="title-color d-flex">{{ \App\CPU\translate('map_api_key') }}
                                            ({{ \App\CPU\translate('server') }})</label>
                                        <input type="text"
                                            placeholder="{{ \App\CPU\translate('map_api_key') }} ({{ \App\CPU\translate('server') }})"
