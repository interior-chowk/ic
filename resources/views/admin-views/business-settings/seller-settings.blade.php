...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row gy-3">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.business-settings.seller-settings.update-seller-settings') }}"
                            method="post">
                            @csrf
                            <label class="title-color d-flex">{{ \App\CPU\translate('Default Sales Commission') }} ( %
                                )</label>
                            <input type="number" class="form-control" name="commission"
                                value="{{ isset($commission) ? $commission->value : 0 }}" min="0" max="100"
                                step="0.01">
            ...
            <div class="col-md-6 mt-md-0" style="display:none;">
                <div class="card h-100">
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.business-settings.seller-settings.update-seller-registration') }}"
                            ...
                            @csrf
                            <label
                                class="title-color d-flex mb-3">{{ \App\CPU\translate('Seller Registration on/off') }}</label>
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    <input name="seller_registration" type="radio" value="0" id="defaultCheck2"
                                        {{ $seller_registration == 0 ? 'checked' : '' }}>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.business-settings.seller-settings.seller-pos-settings') }}"
                            ...
                            @csrf
                            <label
                                class="title-color d-flex mb-3">{{ \App\CPU\translate('Seller POS permission on/off') }}</label>
                            <div class="d-flex flex-column">
                                <div class="d-flex gap-2 align-items-center mb-2">
                                    <input name="seller_pos" type="radio" value="1" id="seller_pos1"
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    <input name="seller_pos" type="radio" value="0" id="seller_pos2"
                                        {{ $seller_pos == 0 ? 'checked' : '' }}>
                                ...
                                <div class="form-control">
                                    <div class="custom-control custom-radio custom-radio-reverse"
                                        ...
                                        <input type="radio" class="custom-control-input"
                                            ...
                                            {{ isset($business_mode) && $business_mode == 'single' ? 'checked' : '' }}>
                                ...
                                <div class="form-control">
                                    <div class="custom-control custom-radio custom-radio-reverse"
                                        ...
                                        <input type="radio" class="custom-control-input"
                                            ...
                                            {{ isset($business_mode) && $business_mode == 'multi' ? 'checked' : '' }}>
                                        <label class="custom-control-label media align-items-center"
                                            for="projectViewNewProjectTypeRadio2">

                                            <span class="media-body">{{ \App\CPU\translate('multi_vendor') }}</span>
                                        </label>
                                    </div>
                                </div>
                                <!-- End Custom Radio -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.business-settings.seller-settings.product-approval') }}"
                            ...
                            @csrf
                            <label
                                class="title-color d-flex mb-3">{{ \App\CPU\translate('approval_for_products') }}</label>
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <input name="new_product_approval" type="checkbox" id="new_product_approval"
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <label
                                    ...
                                    <span class="text-info">(
                                        {{ \App\CPU\translate('if the shipping responsibility is inhouse and product wise shipping is activated then this function will work') }}
                                        )</span>
                                </label>
                            </div>
                            <div class="mt-3 d-flex flex-wrap justify-content-end gap-10">
