                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input class="switcher_input" type="checkbox" name="status"
                                        {{ isset($config) && $config['status'] == 1 ? 'checked' : '' }} value="1">
                        ...
                        <div class="card-body">
                            <div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label
                                                class="title-color font-weight-bold d-flex">{{ \App\CPU\translate('Site Key') }}</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label
                                                class="title-color font-weight-bold d-flex">{{ \App\CPU\translate('Secret Key') }}</label>
                                ...
                                <ol class="pl-3 instructions-list">
                                    ...
                                    <li>{{ \App\CPU\translate('select_sub_type') }}:
                                        {{ \App\CPU\translate('im_not_a_robot_checkbox ') }}</li>
                                    ...
                                    <li>{{ \App\CPU\translate('Copy_Site_Key_and_Secret_Key,_Paste_in_the_input_filed_below_and_Save.') }}
                                    </li>
                                </ol>
