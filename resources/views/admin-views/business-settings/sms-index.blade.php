        ...
        <div class="row gy-3">
            <div class="col-md-6" style="display:none;">
                <div class="card h-100">
                    ...
                    <div class="card-body text-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }}">
                        <span
                            class="badge text-wrap badge-soft-info mb-3">{{ \App\CPU\translate('NB_:_#OTP#_will_be_replace_with_otp') }}</span>
                        @php($config = \App\CPU\Helpers::get_business_settings('releans_sms'))
                        <form
                            action="{{ env('APP_MODE') != 'demo' ? route('admin.business-settings.sms-module-update', ['releans_sms']) : 'javascript:' }}"
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body text-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }}">
                        ...
                        <form
                            ...
                            <div class="form-group">
                                <label
                                    class="text-capitalize title-color">{{ \App\CPU\translate('messaging_service_sid') }}</label>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body text-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }}">
                        <div class="mb-3 d-flex flex-wrap gap-10">
                            <span
                                class="badge text-wrap badge-soft-info">{{ \App\CPU\translate("EX of SMS provider's template : your OTP is XXXX here, please check") }}.</span>
                            <span
                                class="badge text-wrap badge-soft-info">{{ \App\CPU\translate('NB : XXXX will be replace with otp') }}</span>
                        </div>
            ...
            <div class="col-md-6" style="display:none;">
                <div class="card h-100">
                    ...
                    <div class="card-body text-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }}">
                        <span
                            class="badge text-wrap badge-soft-info mb-3">{{ \App\CPU\translate('NB : Keep an OTP variable in your SMS providers OTP Template') }}.</span>
