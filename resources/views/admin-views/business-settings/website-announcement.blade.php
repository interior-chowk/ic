                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-4">
                            <div class="form-group text-center">
                                ...
                                <div class="title-color mb-4 mt-3" id="background-color-set">{{ $announcement['color'] }}
                                </div>
                            </div>
                            <div class="form-group text-center">
                                <label class="title-color">{{ \App\CPU\translate('text_color') }}</label>
                                <input type="color" name="text_color" id="text-color"
                                    value="{{ $announcement['text_color'] }}" class="form-control form-control_color">
                                <div class="title-color mb-4 mt-3" id="text-color-set">{{ $announcement['text_color'] }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="justify-content-end d-flex">
                            <button type="submit"
                                class="btn btn--primary px-4">{{ \App\CPU\translate('publish') }}</button>
                        </div>
                    </div>
                </div>
            @endif
