                                        ...
                                        <div class="col-sm-12 col-md-3 mb-4 removeThisFeaturesCard_div">
                                            <div class="card">
                                                <div class="card-header justify-content-end">
                                                    <div class="cursor-pointer removeThisFeaturesCard_class"><i
                                                            class="tio-add-to-trash"></i> {{ translate('remove') }}</div>
                                                </div>
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        <label for="title">{{ translate('title') }}</label>
                                ...
                                @if (isset($features_section_bottom) && !empty($features_section_bottom))
                                    @forelse (json_decode($features_section_bottom->value) as $key => $item)
                                        ...
                                        <div class="col-sm-12 col-md-3 mb-4">
                                            <div class="card">
                                                <div class="card-header justify-content-end">
                                                    <span class="cursor-pointer text-danger remove_icon_box_with_titles"
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" disabled
                                                            value="{{ $item->title }}" name="icontitle"
                                                            placeholder="{{ translate('type_your_title_text') }}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="title">Sub Title</label>
                                                        <textarea class="form-control" disabled placeholder="{{ translate('type_your_subtitle_text') }}">{{ $item->subtitle }}</textarea>
                                                    </div>

                                                    <div class="mb-3 d-flex">
                                                        <div class="custom_img_upload">
                                                            <img id="pre_img_header_logo{{ $card_index }}"
                                                                src="{{ asset('storage/app/public/banner') }}/{{ $item->icon }}"
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="features_section_bottom[title][]" value=""
                                                            required
                                                            placeholder="{{ translate('type_your_title_text') }}">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3 d-flex">
                                                        <div class="custom_img_upload">
                                                            <span class="icon"
                                                                onclick="clearSiteIMGInput('img_header_logo')">
                                                        ...
                                                        <div class="custom_img_upload_grp">
                                                            <label for="img_header_logo" class="form-label text-center">
                                                                <span>{{ translate('upload_Icon') }}</span><br>-
                                                                {{ translate('click') }} -
                                                            </label>
