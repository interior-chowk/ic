    ...
    <div class="content container-fluid __inline-3">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{ \App\CPU\translate('language_setting') }}
                    {{ \App\CPU\translate('for_app') }}</li>
            </ol>
        </nav>
        ...
        <div class="row" style="margin-top: 20px">
            <div class="col-md-12">
                <div class="alert alert-warning sticky-top" id="alert_box" style="display:none;">
                    ...
                    <strong>{{ \App\CPU\translate('Warning') }}!</strong>
                    {{ \App\CPU\translate('Follow the documentation to setup from app end') }}, <a
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>{{ \App\CPU\translate('Select Country code') }}
                            {{ \App\CPU\translate('for') }} {{ \App\CPU\translate('product') }}
                            {{ \App\CPU\translate('and') }} {{ \App\CPU\translate('category') }}
                            {{ \App\CPU\translate('language') }}</h4>
