        ...
        <div class="dashboard-summary">
            <div class="card first-div">
                ...
                <div class="card-value">
                    ₹{{ number_format($totalIncome ?? 0, 2) }}</div>
                <div class="card-desc green">Order
                    Delivered = ₹{{ number_format($deliveredIncome ?? 0, 2) }}</div>
                <div class="card-desc green">
                    Order in Progress = ₹{{ max(0, $totalIncome - $deliveredIncome) }}</div>
            </div>
            <div class="card first-div">
                <div class="card-title">Total Earnings
                </div>
                <div class="card-value">
                    ₹{{ $totalEarning ?? 0 }}
                </div>
                <div class="card-desc green">
                    Order Delivered = ₹{{ number_format($deliveredtotalEarning, 2) ?? 0 }}
                </div>
                <div class="card-desc green" title=>
                    Order in Progress =
                    ₹{{ ($totalEarning ?? 0) - ($deliveredtotalEarning ?? 0) }}
            ...
            <div class="card first-div">
                ...
                <div class="card-value">
                    ₹{{ number_format($totalCollectionCOD + $totalCollectionWallet + $totalCollectionPrepaid, 2) ?? 0 }}
                </div>
                <div class="card-desc green">
                    COD =
                    ₹{{ number_format($totalCollectionCOD, 2) ?? 0 }}
                </div>
                <div class="card-desc green">
                    Prepaid =
                    ₹{{ number_format($totalCollectionPrepaid, 2) ?? 0 }}
                </div>
                <div class="card-desc green">Wallet =
                    ₹{{ number_format($totalCollectionWallet) }}
                </div>
            </div>
            ...
            <div class="card chart-card" style="max-width:300px !important;">
                ...
                <div id="target-section">
                    ...
                    <div id="target-form" style="display:none; margin-top:10px;">
                        <input type="number" id="target-input" class="form-control mb-2" placeholder="Enter target (₹)">
                        <button id="save-target-btn" class="btn btn-sm btn-primary w-100">
                            Save Target
                        </button>
                    </div>
                </div>
                ...
                <div class="gauge-footer" id="gauge-footer" style="display:none;">
                    <div>
                        <span>Target</span><br>
                        <span class="red" id="footer-target">₹0</span>
                    </div>
                    <div>
                        <span>Sales</span><br>
                        <span class="green" id="footer-revenue">₹0</span>
                    </div>
                </div>
            </div>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (sellerTarget) {
                        ...
                        saveBtn.innerText = 'Update Target';
