                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">
                            ...
                            <span class="ml-2" data-toggle="tooltip" data-placement="top"
                                title="{{ \App\CPU\translate('free_delivery_coupon') }}, {{ \App\CPU\translate('coupon_discount_will_be_shown_here') }}">
                ...
                <div class="left-content-card">
                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">
                            ...
                            <span class="ml-2" data-toggle="tooltip" data-placement="top"
                                title="{{ \App\CPU\translate('discount_on_purchase_and_first_delivery_coupon_amount_will_be_shown_here') }}">
                                <img class="info-img" src="{{ asset('/public/assets/back-end/img/info-circle.svg') }}"
                                    alt="img">
                            </span>
                        </h6>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('admin.transaction.expense-transaction-export-excel', ['search' => request('search'), 'date_type' => request('date_type'), 'from' => request('from'), 'to' => request('to')]) }}">{{ \App\CPU\translate('Excel') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <tbody>
                        @foreach ($expense_transactions_table as $key => $transaction)
                            <tr>
                                ...
                                <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($transaction->discount_amount)) }}
                                </td>
                                <td>{{ isset($transaction->coupon->coupon_type) ? ucwords(str_replace('_', ' ', $transaction->coupon->coupon_type)) : '' }}
                                </td>
                                <td>
