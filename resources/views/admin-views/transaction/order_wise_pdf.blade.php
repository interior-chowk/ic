...
<body>
                ...
                <table class="bs-0">
                    <tr>
                        ...
                        <th class="p-0 text-right">
                            <img class="logo" src="{{ asset("storage/app/public/company/$company_web_logo") }}"
                                alt="">
                        </th>
                    </tr>
                </table>
                ...
                <table class="bs-0">
                    <tr>
                        <td class="p-0 text-left">
                            <b class="bold black">{{ \App\CPU\translate('date') }}</b> : {{ date('F d, Y') }} <span
                    ...
                    <tr>
                        <td class="p-0 text-left">
                            <table>
                                ...
                                <tr>
                                    <th class="bold black p-0 text-left" style="padding: 3px 0">
                                        {{ \App\CPU\translate('Seller_Info') }}</th>
                                    <td class="p-0" style="padding: 3px 0">:
                                ...
                                <tr>
                                    <th class="bold black p-0 text-left" style="padding: 3px 0">
                                        {{ \App\CPU\translate('Customer_Info') }}</th>
                                    <td class="p-0" style="padding: 3px 0">:
                        ...
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    ...
                                    <td class="p-0" style="padding: 3px 0;">:
                                        @if ($transaction->order->delivery_type == 'self_delivery' && !empty($transaction->order->delivery_man_id))
                                            {{ \App\CPU\translate('delivery_man') }}
                                            {{ $transaction->order->delivery_man->seller_id == 0 ? 'admin' : 'seller' }}
                                        @else
                                ...
                                <tr>
                                    <th class="bold black p-0 text-left">{{ \App\CPU\translate('Payment_Method') }}
                                    </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                ...
                                <tr>
                                    <th class="bold black p-0 text-left">{{ \App\CPU\translate('Payment_Status') }}
                                    </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                    ...
                    <tbody>
                        <tr>
                            <td class="pl-0 pr-0 text-center"
                                ...
                                {{ \App\CPU\translate('SL') }}</td>
                            <td style="background-color: #0177CD important; color: white; font-weight: bold">
                                {{ \App\CPU\translate('details') }}</td>
                            <td class="text-right"
                                style="background-color: #0177CD important; color: white; font-weight: bold">
                                {{ \App\CPU\translate('amount') }}</td>
                        </tr>
                        <tr>
    ...
    <table class="content-position">
        <tr>
            <th class="text-left black bold"><b>{{ \App\CPU\translate('additional') }}
                    {{ \App\CPU\translate('information') }}</b></th>
