                    ...
                    <div class="border-bottom px-4 py-3">
                        <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                            ...
                            <span class="ml-2" data-toggle="tooltip" data-placement="top" title=""
                                data-original-title="{{ \App\CPU\translate('this_module_will_run_for_updates_after_version_13.1') }}">
                                <img class="info-img w-200" src="{{ asset('/public/assets/back-end/img/info-circle.svg') }}"
                                    alt="img">
                            </span>
                        </h5>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.system-settings.software-update') }}" method="post"
                            ...
                            @else
                                <div class="row">
                                    <div class="col-12">
                                        <div class="alert alert-soft-{{ $condition_one ? 'success' : 'danger' }}"
                                            role="alert">
                                        ...
                                        <div class="alert alert-soft-{{ $condition_two ? 'success' : 'danger' }}"
                                            role="alert">
                    ...
                    xhr.upload.addEventListener("progress",
                        (evt) => {
                            if (evt.lengthComputable) {
                                ...
                                $('.progress-bar').css('width', `${percentageFormatted}%`).text(
                                    `${percentageFormatted}%`);
                            }
                        }, false);
                    return xhr;
