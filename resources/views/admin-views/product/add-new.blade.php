                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="title-color"
                                                ...
                                                <a class="style-one-pro cursor-pointer" onclick="document.getElementById('generate_number').value = getRndIntegerAlpha()">{{ \App\CPU\translate('generate') }}
                                ...
                                <div class="card-body">
                                    <div class="row align-items-end">
                                        <div class="col-md-6 form-group">
                                            <label class="title-color">{{ \App\CPU\translate('MRP') }} (Actual Selling Price <span id="selling_price_">0.00</span>)</label>
                                            <input type="number" min="0" step="0.01"
                                       ...
                                       <!-- <div class="col-md-6 form-group">
                                        ...
                                        <div class="col-md-3 form-group physical_product_show" id="shipping_cost_multy">
                                            <div class="border rounded px-3 py-2 min-h-40 d-flex justify-content-between gap-3">
                                                ...
                                                <label class="switcher">
                                                    <input type="checkbox" class="switcher_input" name="multiplyQTY" disabled>
                                                    <span class="switcher_control"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 mb-3 physical_product_show" id="shipping_cost_multy1">
                                     ...
                                     <div class="col-md-4 mb-3 physical_product_show" id="shipping_cost_multy2">
                                        <div class="border rounded px-3 py-2 min-h-40 d-flex justify-content-between gap-3">
                                            <label
                                                class="title-color mb-0">{{ \App\CPU\translate('instant_delivery') }}
                                            </label>
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="1" class="form-control" name="breadth" required>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" value="0" step="0.01" class="form-control" name="weight" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@push('script')
    ...
    <script>
        ...
        $('#choice_attributes').on('change', function() {
            // Preserve existing options and values
            let existingOptions = {};
            $('#customer_choice_options .row').each(function() {
                ...
                existingOptions[choiceNo] = choiceOptions; // Store values based on choice number
            });
        
            $('#customer_choice_options').html(null);
        
            // Add the selected options back, including previously filled values
