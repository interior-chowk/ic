    ...
    <div class="content container-fluid"
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-10 mb-3">
            ...
            <div class="d-flex justify-content-end flex-wrap gap-10">
                 ...
                 <a  class="btn btn--primary" data-toggle="modal" onclick="services_tags({{$product['id']}})" data-target=".bd-example-modal-lg">{{\App\CPU\translate('service_tags')}}</a>
                <a href="{{url()->previous()}}" class="btn btn--primary">
                    <i class="tio-back-ui"></i> {{\App\CPU\translate('Back')}}
                </a>
                <a href="{{route('product',$product['slug'])}}" class="btn btn--primary " target="_blank" style="display:none;"><i
        ...
        <div class="d-flex justify-content-sm-end flex-wrap gap-2 mb-3">
            <div class="card ">
            <div class="card-body">
                @php($seller = App\Model\Seller::where('id',$product['user_id'])->first())
                @php($shop = App\Model\Shop::where('seller_id',$seller->id)->first())
                <a><b>VN{{$seller->id}} : {{$shop->name}} </b></a>
            </div>
            </div>
            <div>
...
<div class="modal fade bd-example-modal-lg" id="serviceTagModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body ">
        ...
        <div class="">
           <select class="form-control services-tags" id="service_tag_id" name="service_type[]" multiple> 
           </select>
        </div>
      </div>
      <div class="modal-footer">
