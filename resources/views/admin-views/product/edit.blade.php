                        ...
                        <div class="card-body">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select class="js-example-basic-multiple js-states js-example-responsive form-control"
                                        name="choice_attributes[]" id="choice_attributes" multiple="multiple" required>
                            ...
                            <div class="row align-items-end">
                                <div class="col-md-6 form-group">
                                    ...
                                    if ($product->discount_type == 'percent') {
                                        $selling_price = $product->unit_price - ($product->unit_price * $product->discount) / 100;
                                    } else {
                                        $selling_price = $product->unit_price - $product->discount;
                                    }
                                    ?>
                                    <label class="title-color">{{ \App\CPU\translate('MRP') }} (Actual Selling Price <span
                                            id="selling_price_">{{ $selling_price }}</span>)</label>
                                    <input type="number" min="0" step="0.01" placeholder="MRP"
                                        name="unit_price" id="unit_price_" class="form-control"
                                ...
                                <div class="col-md-2 form-group">
                                    ...
                                    <select name="tax_model" class="form-control" required disabled>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="number" min="0" id="discount_"
                                ...
                                <div class="col-md-2 form-group">
                                    ...
                                    <select class="form-control" name="discount_type" id="discount_type_">
                                ...
                                <div class="col-md-3 form-group physical_product_show" id="shipping_cost">
                                    ...
                                    <label class="switcher title-color">
                                        <input class="switcher_input" type="checkbox" name="multiplyQTY" disabled
                                            id="" {{ $product->multiply_qty == 1 ? 'checked' : '' }} disabled>
                                        <span class="switcher_control"></span>
                                    </label>
                                </div>

                                <div class="col-md-3 mb-3 physical_product_show" id="shipping_cost_multy1">
                                    <div class="border rounded px-3 py-2 min-h-40 d-flex justify-content-between gap-3">
                                        <label class="title-color">{{ \App\CPU\translate('free_delivery') }} </label>
                                ...
                                <div class="col-md-3 mb-3 physical_product_show" id="shipping_cost_multy1">
                                    <div class="border rounded px-3 py-2 min-h-40 d-flex justify-content-between gap-3">
                                        <label class="title-color">{{ \App\CPU\translate('instant_delivery') }} </label>

                                        <label class="switcher">
                                            <input type="checkbox" class="switcher_input"
                                                name="available_instant_delivery" id=""
                                                {{ $product->available_instant_delivery == 1 ? 'checked' : '' }}>
                                            <span class="switcher_control"></span>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="card mt-2 mb-2 rest-part">
                        ...
                        <div class="card-body pb-0">
                            <div class="row g-2">
                                <div class="col-3">
                                    <div class="form-group">
                                        <label class="title-color">{{ \App\CPU\translate('length') }} <small>(in
                                                cms)</small></label>
                                        <input type="number" value="{{ $product->length }}" min="1"
                                            class="form-control" name="length" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label class="title-color">{{ \App\CPU\translate('breadth') }} <small>(in
                                                cms)</small></label>
                                        <input type="number" min="1" value="{{ $product->breadth }}"
                                            class="form-control" name="breadth" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label class="title-color">{{ \App\CPU\translate('height') }} <small>(in
                                                cms)</small></label>
                                        <input type="number" min="1" value="{{ $product->height }}"
                                            class="form-control" name="height" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label class="title-color">{{ \App\CPU\translate('weight') }} <small>(in
                                                kgs)</small></label>
                                        <input type="number" value="{{ $product->weight }}" min="0"
                                            value="0" step="0.01" class="form-control" name="weight" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row gy-3" id="thumbnail">
                                        <div class="col-sm-6 col-md-12 col-lg-6">
                                            <img class="w-100" height="auto"
                                                onerror="this.src='{{ asset('assets/front-end/img/image-place-holder.png') }}'"
                                                src="{{ strpos($product['thumbnail'], 'https://interiorchowk.com') === 0 ? $product['thumbnail'] : asset('storage/product/thumbnail/' . $product['thumbnail']) }}"
                                                alt="Product image">
