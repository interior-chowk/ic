                        ...
                        <form action="{{route('admin.product.home-products-store')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4 form-group coupon_by first_order">
                                    <label for="name" class="title-color font-weight-medium d-flex">{{\App\CPU\translate('Home_page_section')}}</label>
                                    <select class="js-example-basic-multiple js-states js-example-responsive form-control" name="section_type" id="section_type_">
                                ...
                                <div class="col-md-6 col-lg-4 form-group coupon_type first_order">
                                    <label for="name" class="title-color font-weight-medium d-flex">{{\App\CPU\translate('products')}}</label>
                                    <select class="js-example-basic-multiple js-states js-example-theme-single form-control" id="product_id_" name="product_id" >
                                    ...
                                    <div class="col-md-6 col-lg-4 form-group coupon_type first_order">
                                        <label for="name" class="title-color font-weight-medium d-flex">{{\App\CPU\translate('priority')}}</label>
                                        <input type="text" class="form-control " id="priority_" name="priority" placeholder="{{\App\CPU\translate('priority')}}">
                                    </div>
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                                <h5 class="mb-0 text-capitalize d-flex gap-2">
                                    ...
                                    <span class="badge badge-soft-dark radius-50 fz-12 ml-1">{{ $home_products->total() }}</span>
                                </h5>
                            </div>
                            ...
                            <!--                   value="" aria-label="Search orders" required>-->
                        ...
                        <table id="datatable"
                            ...
                            @foreach($home_products as $k=>$c)
                                ...
                                <tr>
                                    ...
                                    <td class="text-capitalize"><strong>{{\App\CPU\translate($c['section_type'])}}</strong></td>
                                    
                                     <td>
                                        <div>{{ \Illuminate\Support\Str::limit($c['product']['name'] ?? 'N/A', 60, '...') }}</div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-10 justify-content-center">
                                            ...
                                            <form action="{{route('admin.product.home-products-delete',[$c['id']])}}"
