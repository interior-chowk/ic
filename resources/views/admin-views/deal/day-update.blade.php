                        ...
                        <div class="form-group">
                         ...
                         <div class="row">
                            <div class="col-md-6 col-lg-6 form-group">
                                    ...
                                    <input id="start_date" type="datetime-local" name="start_date_time" value="{{ $deal['start_date_time'] }}" class="form-control"
                                ...
                                <div class="col-md-6 col-lg-6 form-group">
                                    ...
                                    <input id="expire_date" type="datetime-local" name="expire_date_time" value="{{ $deal['expire_date_time'] }}" class="form-control"
