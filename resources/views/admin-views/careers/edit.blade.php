        ...
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="{{ route('admin.employee.career.update', $career->id) }}">
                    ...
                    @php
                        $education = is_array(json_decode($career->education, true))
                            ? implode(', ', json_decode($career->education, true))
                            : '';
                        $skills = is_array(json_decode($career->skills, true))
                            ? implode(', ', json_decode($career->skills, true))
                            : '';
                        $job_description = is_array(json_decode($career->job_description, true))
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="employment_type" class="form-control"
                                value="{{ $career->employment_type }}" required>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <label>Salary</label>
                            <input type="text" name="salary" class="form-control" value="{{ $career->salary }}"
                                required>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="openings" class="form-control" value="{{ $career->openings }}"
                                required>
                        </div>
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="text" name="education" class="form-control" value="{{ $education }}"
                                placeholder="UG, PG, Diploma" required>
                        </div>
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="text" name="skills" class="form-control" value="{{ $skills }}"
                                placeholder="Figma, Photoshop, ..." required>
                        </div>
