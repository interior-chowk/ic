                    ...
                    <table id="datatable" class="table table-hover table-borderless table-thead-bordered table-align-middle card-table w-100">
                        ...
                        @foreach($applicants as $k => $applicant)
                            <tr>
                                ...
                                <td>
                                    @if($applicant->resume)
                                        <a href="{{ asset('storage/'.$applicant->resume) }}" target="_blank" class="btn btn-sm btn-outline-info">
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        <a class="btn btn-outline-danger btn-sm delete square-btn" title="{{\App\CPU\translate('Delete')}}" data-id="{{ $applicant->id }}">
