            ...
            <form method="POST" action="{{ route('admin.employee.career.create') }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Graphic Designer" required>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="employment_type" class="form-control" placeholder="Full Time" required>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-12">
                        ...
                        <input type="text" name="education" class="form-control" placeholder="UG, PG, Diploma" required>
                    </div>

                    <!-- Skills -->
                    <div class="form-group col-12">
                        <label>Skills <small>(Comma Separated)</small></label>
                        <input type="text" name="skills" class="form-control" placeholder="Photoshop, Figma, Illustrator" required>
                    </div>

                    <!-- Job Description -->
                    <div class="form-group col-12">
                        <label>Job Description <small>(One per line)</small></label>
                        <textarea name="job_description" class="form-control" rows="5" placeholder="Write each responsibility on a new line" required></textarea>
                    </div>
                </div>
