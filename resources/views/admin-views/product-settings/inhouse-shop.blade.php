    ...
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p>*{{ \App\CPU\translate('By_turning_on_temporary_close_mode,_your_shop_will_be_shown_as_temporary_off_in_the_website_and_app_for_the_customers._they_cannot_purchase_or_place_order_from_your_shop') }}
                </p>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="vacation_end_date"
                                        value="{{ $vacation['vacation_end_date'] }}" id="vacation_end_date"
                                        class="form-control" required>
                                </div>
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            toastr.success(
                                '{{ \App\CPU\translate('temporary_close_updated_successfully') }}!'
                                );
                            location.reload();
                        }
                    });
