...
@section('content')
    @push('style')
    <link rel="stylesheet" href="{{ asset('public/website/assets/css/faq.css') }}">
                        ...
                        <div class="col-12">
                            <div class="faqHeadWrapper">
                                ...
                                <div class="faqspage-contact">
                                    <p>Still need help?</p>
                                    <a href="{{ url('contact-us') }}" class="faqspage-linkButton">Contact us</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3 pr-0">
                                    <nav id="scrollspyNavbar" class="scrollspyNavbar">
                                        <ul class="nav-menu bor-right">
                                            @foreach ($subcategories as $subcategory)
                                                <li>
                                                    <a data-scroll="#subcat-{{ $subcategory->id }}"
                                                        href="#subcat-{{ $subcategory->id }}" class="dot menu-link">
                                                ...
                                                <div class="faqSection-section">
                                                    ...
                                                    <div class="faqSection-link">
                                                        ...
                                                        <div class="faqSection-links">
                                                            @auth
                                                                <a
                                                                    href="{{ $subcategory->link }}">{{ $subcategory->link_name }}</a>
                                                            @else
                                                                <button type="button" class="btn btn-default bulk-button"
                                                            ...
                                                            <div class="accordion" id="accordion-{{ $subcategory->id }}">
                                                                <div class="card">
                                                                    <div class="card-header"
                                                                        id="heading-{{ $subcategory->id }}-{{ $index }}">
                                                                        <h2 class="mb-0">
                                                                            <button
                                                                                class="btn btn-link btn-block text-left collapsed faqSection-question"
                                                                    ...
                                                                    <div id="collapse-{{ $subcategory->id }}-{{ $index }}"
                                                                        class="collapse"
                                            ...
                                            <section id="faq-subcat-{{ $subcategory->id }}" class="faqSection">
                                                <div class="faqSection-section">
                                                    ...
                                                    @foreach ($subcategory->faqs as $index => $faq)
                                                        <div class="faqSection-query">
                                                            <div class="accordion"
                                                                id="mob-accordion-{{ $subcategory->id }}">
                                                                <div class="card">
                                                                    <div class="card-header"
                                                                        id="mob-heading-{{ $subcategory->id }}-{{ $index }}">
                                                                        <h2 class="mb-0">
                                                                            <button
                                                                                class="btn btn-link btn-block text-left collapsed faqSection-question"
                                                                                type="button" data-toggle="collapse"
                                                                    ...
                                                                    <div id="mob-collapse-{{ $subcategory->id }}-{{ $index }}"
                                                                        class="collapse"
                                                    ...
                                                    <div class="faqSection-query">
                                                        <div class="accordion" id="mob-accordion-others">
                                                            <div class="card">
                                                                ...
                                                                <div id="mob-collapse-others-{{ $index }}"
                                                                    class="collapse"
