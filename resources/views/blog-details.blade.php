...
@section('content')
    @push('head')
        ...
        <meta property="og:image" content="{{ secure_url('storage/app/public/' . $blogs->banner) }}">
        ...
        <meta name="twitter:image" content="{{ secure_url('storage/app/public/' . $blogs->banner) }}">
        ...
        <script type="application/ld+json">
    {
        ...
        "image": "{{ secure_url('storage/app/public/' . $blogs->banner) }}",
        "author": {
            "@type": "Person",
        ...
        <main class="main">
            <div class="page-content pb-0 containerBg">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <img src="{{ asset('storage/app/public/' . $blogs->banner) }}"
                                style="
