...
<table class="table table-bordered physical_product_show">
    ...
    <tbody>
        ...
        <tr data-row-id="{{ $key }}">
            ...
            <td>
                <input type="text" min="0" step="0.01" placeholder="Tax" name="taxes[]" value="{{ $data->tax }}"
                    class="form-control tax" id="tax_{{ $key }}">

            </td>
            <td>
                <div class="d-flex align-items-center">
                    <input type="text" id="tax_gst_{{ $key }}" name="tax_gst[]" class="form-control ms-2 text-center"
                        style="width: 40%; height: 10%;" value="{{ $data->gst_percent }}" />
                    <span class="fw-bold"> plus </span>
                    <input type="text" id="var_tax_{{ $key }}" name="var_tax[]" class="form-control me-2 text-center"
                        style="width: 40%; height:10%;" value="{{ $data->discount_percent }}" />
                </div>
            ...
            <td>
                <div class="d-flex align-items-center">
                    ...
                    <span class="fw-bold"> plus </span>
                    <input type="text" id="tax1_gst_{{ $key }}" name="tax1_gst[]" class="form-control me-2 text-center"
                        style="width: 40%; height:10%;" value="{{ $data->listed_gst_percent }}" />
                </div>
            ...
            <td colspan="5">
                <div id="dropArea_{{ $key }}" class="drop-area" style="border: 2px dashed #ccc; padding: 10px;">
                    <p style="margin:0;">
                        ...
                        <input type="file" id="imageInput_{{ $key }}" name="image_{{ $key }}[]" class="image-input"
                            data-key="{{ $key }}" multiple accept="image/*" style="margin-top:10px;">
                    </p>
                </div>

                <input type="hidden" id="thumbnail_input_{{ $key }}" name="thumbnail_image_{{ $key }}"
                ...
                <div id="imagePreview_{{ $key }}" class="image-preview"
                    ...
                    <div class="image-container" draggable="true" style="position:relative; margin:5px;">
                        ...
                        <img src="{{ asset('/storage/app/public/images/' . $img) }}" width="100" alt="">
                        <input type="radio" class="image-radio" name="thumbnail_{{ $key }}" value="{{ $img }}" @if
                            ($data->thumbnail_image == $img) checked @endif
