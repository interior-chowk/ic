        ...
        <div class="navbar-nav-wrap">
            ...
            <div class="navbar-nav-wrap-content-right"
                ...
                <ul class="navbar-nav align-items-center flex-row">
                           ...
                           <!-- <div class="hs-unfold">
                                <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                                   href="{{route('admin.orders.list',['status'=>'pending'])}}">
                                    ...
                                    <span
                                        class="btn-status btn-sm-status btn-status-danger">{{\App\Model\Order::where('instant_delivery_type','0')->count()}}</span>
                                </a>
                            </div>-->
                            <div class="hs-unfold">
                                <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                            ...
                            <div class="hs-unfold">
                                <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                                   href="{{route('admin.orders.list',['all','instant'=>'1'])}}">
                                    <i class="tio-shopping-cart-outlined"></i>
                                    <span
                                        class="btn-status btn-sm-status btn-status-danger">{{\App\Model\Order::where('instant_delivery_type','1')->count()}}</span>
                                </a>
                            </div>
                            <!-- End Notification -->
                        </li>
                    ...
                    <li class="nav-item view-web-site-info" style="display:none;">
                        <div class="hs-unfold">
