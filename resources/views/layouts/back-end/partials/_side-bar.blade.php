            ...
            <div class="navbar-vertical-footer-offset pb-0">
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('order_management'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item  {{ str_contains(url()->current() . '?instant=' . request()->get('instant'), '/admin/orders/list/all?instant=0') == 1 ? 'active' : '' }}">

                                        <a class="nav-link"
                                            href="{{ route('admin.orders.list', ['all', 'instant' => '0']) }}"
                                    ...
                                    <li
                                        class="nav-item  {{ str_contains(url()->current() . '?instant=' . request()->get('instant'), '/admin/orders/list/all?instant=1') == 1 ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.orders.list', ['all', 'instant' => '1']) }}"
                                            title="{{ \App\CPU\translate('All') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/sellers/seller-list/inactive') ? 'active' : '' }}">
                                        <a class="nav-link" title="{{ \App\CPU\translate('Seller_List') }}"
                                            href="{{ route('admin.sellers.seller-list', ['status' => 'inactive']) }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                    ...
                                    <li
                                        class="nav-item {{ str_contains(url()->current() . '?isactive=' . request()->get('isactive'), '/admin/provider/list?isactive=0') == 1 ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('admin.provider.list', ['isactive' => '0']) }}"
                                            title="{{ \App\CPU\translate('Service_Provider') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ \App\CPU\translate('Service_Provider') }}
                                            </span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/refund-section/refund/*') ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('admin.refund-section.refund.list', ['Filter']) }}"
                                            title="{{ \App\CPU\translate('return_&_refund') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ \App\CPU\translate('return_&_refund') }}
                                            </span>
                                        </a>
                                    </li>
                                    <li
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/brand/add-new') || Request::is('admin/category*') || Request::is('admin/product/home-products') || Request::is('admin/sub*') || Request::is('admin/service-category*') || Request::is('admin/service-sub*') || Request::is('admin/attribute*') || Request::is('admin/product/list/in_house') || Request::is('admin/product/bulk-import') || Request::is('admin/product/add-new') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="{{ \App\CPU\translate('create') }}">
                                    <i class="tio-category-outlined nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('create') }}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/brand/add-new') || Request::is('admin/product/home-products') || Request::is('admin/category*') || Request::is('admin/sub*') || Request::is('admin/service-category*') || Request::is('admin/service-sub*') || Request::is('admin/attribute*') || Request::is('admin/product/list/in_house') || Request::is('admin/product/bulk-import') || Request::is('admin/product/add-new') ? 'block' : 'none' }}">
                                    <li class="nav-item {{ Request::is('admin/product/home-products') ? 'active' : '' }}"
                                        title="{{ \App\CPU\translate('home_Products') }}">
                                        <a class="nav-link " href="{{ route('admin.product.home-products') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{ \App\CPU\translate('home_Products') }}</span>
                                        </a>
                                    </li>
                                    ...
                                    <li
                                        ...
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                            ...
                                            <span
                                                class="text-truncate">{{ \App\CPU\translate('Product_Attributes') }}</span>
                                        </a>
                                    </li>
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                            ...
                                            <li
                                                ...
                                                <a class="nav-link "
                                                    ...
                                                    <span class="tio-circle nav-indicator-icon"></span>
                                                    <span
                                                        class="text-truncate">{{ \App\CPU\translate('Products') }}</span>
                                                </a>
                                            </li>
                                            <li
                                    ...
                                    <li
                                        ...
                                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                            href="javascript:" title="{{ \App\CPU\translate('Product_Category') }}">
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                            ...
                                            <li
                                                class="nav-item {{ Request::is('admin/category/view') ? 'active' : '' }}">
                                            ...
                                            <li
                                                class="nav-item {{ Request::is('admin/sub-sub-category/view') ? 'active' : '' }}">
                                                <a class="nav-link "
                                                    href="{{ route('admin.category.category_request') }}"
                                                    title="{{ \App\CPU\translate('Sub_Sub_Categories') }}">
                                                    <span class="tio-circle nav-indicator-icon"></span>
                                                    <span
                                                        class="text-truncate">{{ \App\CPU\translate('Categories_request') }}</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/service-category*') || Request::is('admin/service-sub*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                            href="javascript:" title="{{ \App\CPU\translate('Service_Category') }}">
                                            <i class="tio-filter-list nav-icon"></i>
                                            <span class="text-truncate">
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                            style="display: {{ Request::is('admin/service-category*') || Request::is('admin/service-sub*') ? 'block' : '' }}">
                                            <li
                                                class="nav-item {{ Request::is('admin/service-category/view') ? 'active' : '' }}">
                                                <a class="nav-link "
                                                    href="{{ route('admin.service-category.view') }}"
                                                    title="{{ \App\CPU\translate('Categories') }}">
                                                    <span class="tio-circle nav-indicator-icon"></span>
                                                    <span
                                                        class="text-truncate">{{ \App\CPU\translate('Categories') }}</span>
                                            ...
                                            <li
                                                class="nav-item {{ Request::is('admin/service-sub-category/view') ? 'active' : '' }}">
                                                <a class="nav-link "
                                                    href="{{ route('admin.service-sub-category.view') }}"
                                                    title="{{ \App\CPU\translate('Sub_Categories') }}">
                                                    <span class="tio-circle nav-indicator-icon"></span>
                                                    <span
                                                        class="text-truncate">{{ \App\CPU\translate('Sub_Categories') }}</span>
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        ...
                                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                            href="javascript:" title="{{ \App\CPU\translate('Products_List') }}">
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                            ...
                                            @if (\App\CPU\Helpers::get_business_settings('product_wise_shipping_cost_approval') == 1)
                                                <li class="nav-item {{ Request::is('admin/product/updated-product-list') ? 'active' : '' }}"
                                                    style="display:none;">
                                                    <a class="nav-link"
                                                        title="{{ \App\CPU\translate('updated_products') }}"
                                    ...
                                    <li class="nav-item {{ Request::is('admin/brand/list') ? 'active' : '' }}"
                                        title="{{ \App\CPU\translate('Brand_List') }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/customer/customerslist') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.customer.customerslist') }}"
                                            title="{{ \App\CPU\translate('Contact_Customer_List_') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{ \App\CPU\translate('Contact_Customer_List') }}
                                            </span>
                                        </a>
                                    </li>

                                    <li
                                        class="nav-item {{ Request::is('admin/sellers/seller-list/active') ? 'active' : '' }}">
                                        <a class="nav-link" title="{{ \App\CPU\translate('Seller_List') }}"
                                            href="{{ route('admin.sellers.seller-list', ['status' => 'active']) }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                    ...
                                    <li
                                        class="nav-item {{ str_contains(url()->current() . '?isactive=' . request()->get('isactive'), '/admin/provider/list?isactive=1') == 1 ? 'active' : '' }}">
                                        <a class="nav-link "
                                            href="{{ route('admin.provider.list', ['isactive' => '1']) }}"
                                            title="{{ \App\CPU\translate('Service_Provider_List') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{ \App\CPU\translate('Service_Provider_List') }}
                                            </span>
                                        </a>
                                    </li>

                                    <li class="nav-item {{ Request::is('admin/bulk-purchase-list/list') ? 'active' : '' }}"
                                        title="{{ \App\CPU\translate('Bulk_Purchase_List') }}">
                                        <a class="nav-link " href="{{ route('admin.bulk-purchase-list.list') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{ \App\CPU\translate('Bulk_Purchase_List') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/coupon*') || Request::is('admin/deal*') || Request::is('admin/banner*') || Request::is('admin/provider-banner*') || Request::is('admin/notification*') || Request::is('admin/provider-notification*') || Request::is('admin/Membership_plan*') || Request::is('admin/Scheme_management*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/coupon*') || Request::is('admin/deal*') || Request::is('admin/banner*') || Request::is('admin/provider-banner*') || Request::is('admin/notification*') || Request::is('admin/provider-notification*') || Request::is('admin/Membership_plan*') || Request::is('admin/Scheme_management*') ? 'block' : 'none' }}">
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/coupon*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.coupon.add-new') }}"
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/provider-banner*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.provider-banner.list') }}"
                                        title="{{ \App\CPU\translate('service_provider_banners') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/provider-notification*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.provider-notification.add-new') }}"
                                        title="{{ \App\CPU\translate('Push_Notification_Provider') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/Membership_plan*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.Membership_plan.add-new') }}"
                                        title="{{ \App\CPU\translate('Push_Notification') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/Scheme_management*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.Scheme_management.add-new') }}"
                                        title="{{ \App\CPU\translate('Push_Notification') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/seo*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/reviews/list') || Request::is('admin/reviews/provider-list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ \App\CPU\translate('Reviews') }}">
                                <i class="tio-star nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('Reviews') }}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/reviews/list') || Request::is('admin/reviews/provider-list') ? 'block' : 'none' }}">
                                <li class="nav-item {{ Request::is('admin/reviews/list') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.reviews.list') }}"
                                        title="{{ \App\CPU\translate('Customer') }} {{ \App\CPU\translate('Product') }} {{ \App\CPU\translate('Reviews') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{ \App\CPU\translate('Customer') }} {{ \App\CPU\translate('Product') }}
                                            {{ \App\CPU\translate('Reviews') }}
                                        </span>
                                    </a>
                                </li>
                                <li
                                    class="nav-item {{ Request::is('admin/reviews/provider-list') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.reviews.provider-list') }}"
                                        title="{{ \App\CPU\translate('Customer') }} {{ \App\CPU\translate('Service') }} {{ \App\CPU\translate('Reviews') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{ \App\CPU\translate('Customer') }} {{ \App\CPU\translate('Service') }}
                                            {{ \App\CPU\translate('Reviews') }}
                                        </span>
                                    </a>
                                </li>
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ \App\CPU\translate('Reports') }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{ Request::is('admin/report/shipping_register') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.report.shipping_register') }}"
                                        title="{{ \App\CPU\translate('Sale_Register') }} {{ \App\CPU\translate('Report') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate">{{ \App\CPU\translate('Shipping Reports') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('admin.report.coupon_register') }}"
                                        title="{{ \App\CPU\translate('Sale_Register') }} {{ \App\CPU\translate('Report') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                ...
                                <li class="nav-item {{ Request::is('admin/report/order') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.report.cancellation_report') }}"
                                        title="{{ \App\CPU\translate('Order') }} {{ \App\CPU\translate('Report') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate">{{ \App\CPU\translate('Cancellation_Report') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/report/order') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.report.sale_return') }}"
                                        title="{{ \App\CPU\translate('Order') }} {{ \App\CPU\translate('Report') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate">{{ \App\CPU\translate('Sale Return Report') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/report/order') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('admin.report.order_sale') }}"
                                        title="{{ \App\CPU\translate('Order') }} {{ \App\CPU\translate('Report') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate">{{ \App\CPU\translate('Order Sale Report') }}</span>
                                    </a>
                                </li>
                                <li
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/report/order_sale') || Request::is('admin/report/seller-earning') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.report.order_sale') }}"
                                ...
                                <li class="navbar-vertical-aside-has-menu">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.report.order_sale_statement') }}"
                                        title="{{ \App\CPU\translate('Sales_&_Commission_Report') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <li class="navbar-vertical-aside-has-menu">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.report.payment_record_report') }}"
                                        title="{{ \App\CPU\translate('Sales_&_Commission_Report') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        ...
                                        <li
                                            ...
                                            <a class="nav-link" href="{{ route('admin.employee.list') }}"
                                                ...
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ \App\CPU\translate('Employees') }}</span>
                                            </a>
                                        </li>
                                        <li
                                            class="nav-item {{ Request::is('admin/employee/career/list') || Request::is('admin/employee/career/add-new') || Request::is('admin/employee/career/update*') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('admin.employee.career.list') }}"
                                                title="{{ \App\CPU\translate('Career') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate">{{ \App\CPU\translate('Career') }}</span>
                                            </a>
                                        </li>
                                        <li
                                            class="nav-item {{ Request::is('admin/employee/applicants*') || Request::is('admin/employee/career/add-new') || Request::is('admin/employee/career/update*') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('admin.employee.applicants.list') }}"
                                                title="{{ \App\CPU\translate('Applicants') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ \App\CPU\translate('Applicants') }}</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('system_settings'))
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/web-config') ||Request::is('admin/business-settings/web-config/app-settings') ||Request::is('admin/product-settings/inhouse-shop') ||Request::is('admin/business-settings/seller-settings') ||Request::is('admin/customer/customer-settings') ||Request::is('admin/refund-section/refund-index') ||Request::is('admin/business-settings/shipping-method/setting') ||Request::is('admin/business-settings/order-settings/index') ||Request::is('admin/product-settings') ||Request::is('admin/business-settings/web-config/delivery-restriction') ||Request::is('admin/business-settings/cookie-settings') ||Request::is('admin/business-settings/otp-setup') ||Request::is('admin/business-settings/all-pages-banner*') ||Request::is('admin/business-settings/delivery-restriction') ||Request::is('admin/business-settings/mail') ||Request::is('admin/business-settings/sms-module') ||Request::is('admin/business-settings/captcha') ||Request::is('admin/social-login/view') ||Request::is('admin/social-media-chat/view') ||Request::is('admin/business-settings/map-api') ||Request::is('admin/business-settings/payment-method') ||Request::is('admin/business-settings/fcm-index') ||Request::is('admin/business-settings/terms-condition') ||Request::is('admin/business-settings/page*') ||Request::is('admin/business-settings/privacy-policy') ||Request::is('admin/business-settings/about-us') ||Request::is('admin/helpTopic/list') ||Request::is('admin/business-settings/social-media') ||Request::is('admin/business-settings/sp-social-media') ||Request::is('admin/file-manager*') ||Request::is('admin/business-settings/features-section')? 'active': '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="{{ \App\CPU\translate('system_settings') }}">
                                    <i class="tio-settings-outlined nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('system_settings') }}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/business-settings/web-config') ||Request::is('admin/business-settings/web-config/app-settings') ||Request::is('admin/product-settings/inhouse-shop') ||Request::is('admin/business-settings/seller-settings') ||Request::is('admin/customer/customer-settings') ||Request::is('admin/refund-section/refund-index') ||Request::is('admin/business-settings/shipping-method/setting') ||Request::is('admin/business-settings/order-settings/index') ||Request::is('admin/product-settings') ||Request::is('admin/business-settings/web-config/delivery-restriction') ||Request::is('admin/business-settings/cookie-settings') ||Request::is('admin/business-settings/otp-setup') ||Request::is('admin/business-settings/all-pages-banner*') ||Request::is('admin/business-settings/delivery-restriction') ||Request::is('admin/business-settings/mail') ||Request::is('admin/business-settings/sms-module') ||Request::is('admin/business-settings/captcha') ||Request::is('admin/social-login/view') ||Request::is('admin/social-media-chat/view') ||Request::is('admin/business-settings/map-api') ||Request::is('admin/business-settings/payment-method') ||Request::is('admin/business-settings/fcm-index') ||Request::is('admin/business-settings/terms-condition') ||Request::is('admin/business-settings/page*') ||Request::is('admin/business-settings/privacy-policy') ||Request::is('admin/business-settings/about-us') ||Request::is('admin/helpTopic/list') ||Request::is('admin/business-settings/social-media') ||Request::is('admin/business-settings/sp-social-media') ||Request::is('admin/file-manager*') ||Request::is('admin/business-settings/features-section')? 'block': 'none' }}">
                                    ...
                                    <li
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                            ...
                                            <li
                                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/sp-social-media') ? 'active' : '' }}">
                                                <a class="js-navbar-vertical-aside-menu-link nav-link"
