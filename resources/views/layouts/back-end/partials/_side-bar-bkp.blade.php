                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                   ...
                                   <!-- <li class="nav-item {{Request::is('admin/orders/list/all')?'active':''}}">-->
                                    <li class="nav-item  {{str_contains(url()->current().'?instant='.request()->get('instant'),'/admin/orders/list/all?instant=0')==1?'active':''}}">
                                        ...
                                        <a class="nav-link" href="{{route('admin.orders.list',['all','instant'=>'0'])}}"
                                    ...
                                    <li class="nav-item  {{str_contains(url()->current().'?instant='.request()->get('instant'),'/admin/orders/list/all?instant=1')==1?'active':''}}">
                                        <a class="nav-link" href="{{route('admin.orders.list',['all','instant'=>'1'])}}"
                                           title="{{\App\CPU\translate('All')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                           ...
                           <!-- <li class="navbar-vertical-aside-has-menu {{Request::is('admin/refund-section/refund/*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="{{\App\CPU\translate('Refund_Requests')}}">
                                    <i class="tio-receipt-outlined nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{\App\CPU\translate('Return_Requests')}}
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/report/admin-earning') || Request::is('admin/report/seller-earning') || Request::is('admin/report/inhoue-product-sale') || Request::is('admin/report/seller-report') || Request::is('admin/report/earning') || Request::is('admin/transaction/order-transaction-list') || Request::is('admin/transaction/expense-transaction-list') || Request::is('admin/transaction/refund-transaction-list')) ?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('admin/report/inhoue-product-sale')?'active':''}}" style="display:none;">
                                ...
                                <li class="nav-item {{Request::is('admin/report/seller-report')?'active':''}}" style="display:none;">
                                ...
                                <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/transaction/order-transaction-list') || Request::is('admin/transaction/expense-transaction-list') || Request::is('admin/transaction/refund-transaction-list'))?'active':''}}" style="display:none;">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/customer/wallet*') || Request::is('admin/customer/list') || Request::is('admin/customer/view*') || Request::is('admin/reviews*') || Request::is('admin/customer/loyalty/report'))?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('admin/customer/loyalty/report')?'active':''}}" style="display:none;">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/service-category*') ||Request::is('admin/service-sub*')) ?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/service-category/view')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.service-category.view')}}"
                                           title="{{\App\CPU\translate('Categories')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Categories')}}</span>
                                        </a>
                                    ...
                                    <li class="nav-item {{Request::is('admin/service-sub-category/view')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.service-sub-category.view')}}"
                                           title="{{\App\CPU\translate('Sub_Categories')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{\App\CPU\translate('Sub_Categories')}}</span>
                                        </a>
                            ...
                            <!-- start folder of the service provider  -->
                               <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/provider/wallet*') || Request::is('admin/provider/list') || Request::is('admin/provider/view*') || Request::is('admin/reviews*') || Request::is('admin/customer/loyalty/report'))?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                               href="javascript:" title="{{\App\CPU\translate('Service providers')}}">
                                <i class="tio-wallet nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('Service_providers')}}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{(Request::is('admin/provider/wallet*') || Request::is('admin/provider/list') || Request::is('admin/provider/view*') || Request::is('admin/reviews*') || Request::is('admin/provider/loyalty/report'))?'block':'none'}}">
                                <li class="nav-item {{Request::is('admin/provider/list') || Request::is('admin/provider/view*')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.provider.list')}}"
                                       title="{{\App\CPU\translate('Customer_List')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/seller*')?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('admin/sellers/seller-add')?'active':''}}" style="display:none;">
                                ...
                                <li class="nav-item {{(Request::is('admin/sellers/withdraw-method/list') || Request::is('admin/sellers/withdraw-method/*'))?'active':''}}" style="display:none;">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/business-settings/web-config/environment-setup') || Request::is('admin/business-settings/web-config/mysitemap') || Request::is('admin/business-settings/analytics-index') || Request::is('admin/currency/view') || Request::is('admin/business-settings/web-config/db-index') || Request::is('admin/business-settings/language*') || Request::is('admin/business-settings/web-config/theme/setup')  || Request::is('admin/system-settings/software-update'))?'active':''}}" style="display:none;">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
