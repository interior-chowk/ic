                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('user_section'))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/provider/wallet*') || Request::is('admin/provider/list') || Request::is('admin/provider/view*') || Request::is('admin/reviews*') || Request::is('admin/customer/loyalty/report') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/provider/list') || Request::is('admin/provider/view*') ? 'active' : '' }}">
