        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 col-sm-3 col-md-3">
                    ...
                    {{-- <button onclick="toggleForm()" class="ftrQryBtn">Ask Your Query <i class="fa fa-chevron-down"
                        ...
                        <ul style="list-style-type: none; padding-left: 0;">
                            <li>
                                <input type="text" name="name" placeholder="Name" class="form-control mb-2"
                                    required style="height: 30px; width: 50%; font-size: 1.2rem;">
                            </li>
                            <li>
            ...
            <div class="row mt-2">
                <div class="col-6 col-sm-6 col-md-3">
                    ...
                    <img style="height: 65px;display: inline-block;"
                        src="{{ asset('public/website/new/assets/images/white_ic_logo.webp') }}" class="footerImg"
                        alt="white logo" />
                </div>
                <div class="col-6 col-sm-6 col-md-3">
                ...
                {{-- <div class="col-6 col-sm-6 col-md-6">
                    ...
                    <ul style="display: flex; margin-top: 10px;">
                        ...
                        <li style="margin-right: 25px;"><a
                                href="https://play.google.com/store/apps/details?id=com.interiorchowk.app&hl=en_IN&pli=1"><img
                                    src="{{ asset('storage/app/icon/GOOGLE.webp') }}" alt="PlayStore"
                                    width="130px" /></a></li>
                        <li><a href="https://apps.apple.com/in/app/interiorchowk/id6554003290"><img
                                    src="{{ asset('storage/app/icon/APPLE.webp') }}" alt="AppStore"
                                    width="130px" /></a></li>
                    </ul>
                </div> --}}
            </div>
...
<script src="{{ asset('public/website/new/assets/js/jquery.plugin.min.js') }}"></script>
<script src="{{ asset('public/website/new/assets/js/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('public/website/new/assets/js/jquery.countdown.min.js') }}"></script>
<script src="{{ asset('public/website/new/assets/js/demos/demo-9.js') }}"></script>
...
<div class="modal fade" id="bulkEnquiryModal" tabindex="-1" aria-labelledby="bulkEnquiryLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('bulk.enquiry.submit') }}" method="POST">
                @csrf
