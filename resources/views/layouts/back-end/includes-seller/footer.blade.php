            ...
            <div class="col-md-4">
                <div class="c-footer-nav">
                    ...
                    <ul >
                        ...
                        <li class="active"><a href="{{ route('policy',['type' => $Business_setting->type]) }}">E-wallet policy</a></li>
                        ...
                        <li class="active"><a href="{{ route('policy',['type' => $Business_setting->type]) }}">Terms & Conditions</a></li>
                         @elseif($Business_setting->type == 'privacy_policy')
                        <li class="active"><a href="{{ route('policy',['type' => $Business_setting->type]) }}">Privacy Policy</a></li>
                          @elseif($Business_setting->type == 'shipping_policy')
                        <li class="active"><a href="{{ route('policy',['type' => $Business_setting->type]) }}">Shipping Policy</a></li>
                         @elseif($Business_setting->type == 'refund-policy')
                        <li class="active"><a href="{{ route('policy',['type' => $Business_setting->type]) }}">Return & refund policy</a></li>
                        @elseif($Business_setting->type == 'instant_delivery_policy')
                        <li class="active"><a href="{{ route('policy',['type' => $Business_setting->type]) }}">Instant Delivery Policy</a></li>
                         @elseif($Business_setting->type == 'secure_payment_policy')
                        <li class="active"><a href="{{ route('policy',['type' => $Business_setting->type]) }}">Secure Payment Policy </a></li>
                          ...
                          <ul class="d-flex">
                              ...
                              <li>
                                  <a href="{{ $social_media_link->link }}" target="_blank">
                                      <img src="{{ asset('asset/img/social-icon-1.png') }}" alt="">
                                  </a>
                              </li>
                              @endif
                              ...
                              <li>
                                  <a href="{{ $social_media_link->link }}" target="_blank">
                                      <img src="{{ asset('asset/img/social-icon-2.png') }}" alt="">
                                  </a>
                              </li>
                               @endif
                              ...
                              <li>
                                  <a href="{{ $social_media_link->link }}" target="_blank">
                                      <img src="{{ asset('asset/img/social-icon-3.png') }}" alt="">
                                  </a>
                              </li>
                               @endif
                              ...
                              <li>
                                  <a href="{{ $social_media_link->link }}" target="_blank">
                                      <img src="{{ asset('asset/img/social-icon-4.png') }}" alt="">
                                  </a>
                              </li>
                               @endif
                              @endforeach
...
<script src="{{ asset('asset/js/seller-custom.js') }}"></script>
