...
<body class="footer-offset">
    ...
    @include('layouts.back-end.partials-service._header')
    @include('layouts.back-end.partials-service._side-bar')

    <main id="content" role="main" class="main pointer-event">

        @yield('content')

        @include('layouts.back-end.partials-service._footer')

        @include('layouts.back-end.partials-service._modals')
