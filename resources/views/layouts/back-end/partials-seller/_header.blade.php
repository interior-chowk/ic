    ...
    <header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-flush navbar-container navbar-bordered">
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <!-- End Logo  || empty($shop->reg_cert) || empty($shop->reg_cert_image) -->
            </div>

            <div class="navbar-nav-wrap-content-left">
              
                @if(empty($shop->name) || empty($shop->contact) || empty($shop->address) || empty($shop->billing_address) || empty($shop->country) || empty($shop->state) || empty($shop->city) || empty($shop->pincode)  || empty($shop->gst_no) || empty($shop->gst_cert_image) || empty($shop->pan) || empty($shop->pan_image)))
                 <div class="alert alert-danger mt-3" role="alert">
                  Your profile is incomplete. Please complete from here: <a style="color:white" href="{{route('seller.shop.edit',[$shop->id])}}" > <u><b>{{\App\CPU\translate('click')}}</b></u></a> !
                </div>
               @endif
        ...
        <div id="website_info"
            ...
            <div class="p-3">
                ...
                <div class="bg-white p-1 rounded mt-2" style="display:none;">
