                    ...
                    @if (isset($shop))
                        <span>
                            <h5 class="profile-name mb-0">
                                @if (isset($shop->name))
                                    {{ $shop->comp_name ?? $shop->name }}
                                @endif
                            </h5>
                            <h5 class="profile-name mb-0">
                                @if (isset($shop->seller_id))
                                    {{ 'VN' }}{{ $shop->seller_id }}
                                @endif
                            </h5>
                        </span>
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/orders*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{ str_contains(url()->current() . '?instant=' . request()->get('instant'), '/seller/orders/list/all?instant=0') == 1 ? 'active' : '' }}">

                                    <a class="nav-link "
                                        href="{{ route('seller.orders.list', ['all', 'instant' => '0']) }}"
                                        title="">
                                ...
                                <li
                                    class="nav-item {{ str_contains(url()->current() . '?instant=' . request()->get('instant'), '/seller/orders/list/all?instant=1') == 1 ? 'active' : '' }}">
                                    <a class="nav-link "
                                        href="{{ route('seller.orders.list', ['all', 'instant' => '1']) }}"
                                        title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                ...
                                <li class="nav-item {{ Request::is('seller/orders/list/out_for_delivery') ? 'active' : '' }}"
                                    style="display:none;">
                                    <a class="nav-link "
                                        href="{{ route('seller.orders.list', ['out_for_delivery']) }}"
                                        title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                        ...
                        <li
                            ...
                            <a class="nav-link" href="{{ route('seller.refund.list', ['Filter']) }}">
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                        ...
                                        <li
                                            ...
                                            <a class="nav-link " href="{{ route('seller.product.add-search-new') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ \App\CPU\translate('Single Listing') }}</span>
                                            </a>
                                        </li>
                                        ...
                                        <li
                                            class="nav-item {{ Request::is('seller/product/list') || Request::is('seller/product/stock-limit-list/in_house') ? 'active' : '' }}">
                                            <a class="nav-link "
                                                href="{{ route('seller.product.search_bulk-import') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ \App\CPU\translate('Bulk Listing') }}</span>
                                            </a>
                                        </li>
                                        <li
                                            class="nav-item {{ Request::is('seller/product/list') || Request::is('seller/product/stock-limit-list/in_house') ? 'active' : '' }}">
                                            <a class="nav-link " href="{{ route('seller.product.bulk_image') }}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ \App\CPU\translate('Bulk Images') }}</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/messages*') ? 'active' : '' }}"
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{ Request::is('seller/messages/chat/customer') ? 'active' : '' }}">
                                    <a class="nav-link "
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('seller/transaction/order-list') || Request::is('seller/transaction/expense-list') || Request::is('seller/transaction/sale_register') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('seller/transaction/order-list') || Request::is('seller/transaction/expense-list') || Request::is('seller/transaction/sale_register') ? 'block' : 'none' }}">
                                <!-- style="display: {{ Request::is('seller/transaction/order-list') || Request::is('seller/transaction/expense-list') ? 'block' : 'none' }}"> -->
                                {{-- <li
                                    class="nav-item {{ Request::is('seller/transaction/order-list') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('seller.transaction.order-list') }}"
                                ...
                                {{-- <li
                                    class="nav-item {{ Request::is('seller/transaction/sale_register') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('seller.transaction.sale_register') }}"
                                ...
                                <li
                                    class="nav-item {{ Request::is('seller/transaction/Order_Sale_Report') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('seller.transaction.Order_Sale_Report') }}"
                                        title="{{ \App\CPU\translate('Sale_Register') }} {{ \App\CPU\translate('Report') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate">{{ \App\CPU\translate('Sales & Order Reports') }}</span>
                                    </a>
                                </li>
                                <li
                                    class="nav-item {{ Request::is('seller/transaction/sale_return_report') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('seller.transaction.sale_return') }}"
                                ...
                                <li class="nav-item {{ Request::is('seller/transaction/receipt') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('seller.transaction.receipt') }}"
                                        title="{{ \App\CPU\translate('Sale_Register') }} {{ \App\CPU\translate('Report') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('seller/shop*') || Request::is('seller/profile/view') || Request::is('seller/profile/bank-edit/*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('seller/profile/policy') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('seller.profile.policy') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate">{{ \App\CPU\translate('Seller Guide & Terms') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
