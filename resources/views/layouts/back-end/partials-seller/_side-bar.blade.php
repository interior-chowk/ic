        ...
        <div class="navbar-vertical-container">
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-brand-wrapper justify-content-between side-logo">
                    ...
                    <a class="avatar-sm avatar-circle" href="{{route('seller.dashboard.index')}}" aria-label="Front">
                        @if (isset($shop))
                            <img onerror="this.src='{{asset('assets/back-end/img/900x400/img1.jpg')}}'"
                                class="navbar-brand-logo-mini for-seller-logo avatar-img"
                                src="{{asset('storage/shop/')}}/{{$shop->image}}" alt="Logo">
                        @else
                            <img class="navbar-brand-logo-mini for-seller-logo avatar-img"
                                src="{{asset('assets/back-end/img/900x400/img1.jpg')}}" alt="Logo">
                        @endif
                    </a>
                    @if(isset($shop))
                    <span>
                    <h5 class="profile-name mb-0">@if(isset($shop->name)) {{$shop->name}} @endif</h5>
                    <h5 class="profile-name mb-0">@if(isset($shop->seller_id)) {{'VN'}}{{$shop->seller_id}} @endif</h5>
                    </span>
                    @endif
                    <!-- End Logo -->
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if ($seller_pos==1)
                            @if ($seller->pos_status == 1)
                                ...
                                <li class="navbar-vertical-aside-has-menu {{Request::is('seller/pos')?'active':''}}" style="display:none;">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('seller/orders*')?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                               ...
                               <!-- <li class="nav-item {{Request::is('seller/orders/list/all')?'active':''}}">-->
                                <li class="nav-item {{str_contains(url()->current().'?instant='.request()->get('instant'),'/seller/orders/list/all?instant=0')==1?'active':''}}">
                                    
                                    <a class="nav-link " href="{{route('seller.orders.list',['all','instant'=>'0'])}}" title="">
                                        ...
                                        <span class="text-truncate">
                                            ...
                                            <span class="badge badge-soft-info badge-pill {{Session::get('direction') === "rtl" ? 'mr-1' : 'ml-1'}}">
                                                {{ \App\Model\Order::where(['seller_is'=>'seller'])->where(['seller_id'=>$sellerId])->where('instant_delivery_type',0)->count()}}
                                            </span>
                                        </span>
                                    </a>
                                </li>
                                
                                <li class="nav-item {{str_contains(url()->current().'?instant='.request()->get('instant'),'/seller/orders/list/all?instant=1')==1?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.orders.list',['all','instant'=>'1'])}}" title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                            {{\App\CPU\translate('instant_delivery')}}
                                            <span class="badge badge-soft-info badge-pill {{Session::get('direction') === "rtl" ? 'mr-1' : 'ml-1'}}">
                                                {{ \App\Model\Order::where(['seller_is'=>'seller'])->where(['seller_id'=>$sellerId])->where('instant_delivery_type',1)->count()}}
                                            </span>
                                        </span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('seller/orders/list/pending')?'active':''}}" style="display:none;">
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/confirmed')?'active':''}}" style="display:none;">
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/processing')?'active':''}}" style="display:none;">
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/out_for_delivery')?'active':''}}" style="display:none;">
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/delivered')?'active':''}}" style="display:none;">
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/returned')?'active':''}}" style="display:none;">
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/failed')?'active':''}}" style="display:none;">
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/canceled')?'active':''}}" style="display:none;">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/refund/*') ? 'active' : '' }}">
                                    ...
                                    <a class="nav-link"
                                       href="{{route('seller.refund.list',['Filter'])}}">
                                        <i class="tio-receipt-outlined nav-icon"></i>
                                       <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{\App\CPU\translate('Returns')}}
                                      </span>
                        ...
                        <!--<li class="navbar-vertical-aside-has-menu {{Request::is('seller/refund*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                               href="javascript:">
                                <i class="tio-receipt-outlined nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{\App\CPU\translate('Returned_Product_List')}}
                                </span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('seller/product*'))?'active':''}}">
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                ...
                                <li class="nav-item {{Request::is('seller/product/list') || Request::is('seller/product/stock-limit-list/in_house')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.product.add-search-new')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('Single Listing')}}</span>
                                    </a>
                                </li>
                                 
                                <li class="nav-item {{Request::is('seller/product/list') || Request::is('seller/product/stock-limit-list/in_house')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.product.search_bulk-import')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('Bulk Listing')}}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('seller/product/list') || Request::is('seller/product/stock-limit-list/in_house')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.product.bulk_image')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('Bulk Images')}}</span>
                                    </a>
                                </li>
                           </ul>
                                </li>
                                ...
                                <!-- <li class="nav-item {{Request::is('seller/product/bulk-import')?'active':''}}" style="display:block;">
                        ...
                        <!-- <li class="navbar-vertical-aside-has-menu {{(Request::is('seller/product*'))?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{(Request::is('seller/product*'))?'block':''}}">
                                <li class="nav-item {{Request::is('seller/product/list') || Request::is('seller/product/stock-limit-list/in_house')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.product.add_Categories')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('add category')}}</span>
                                    </a>
                                </li>
</ul></li> -->
                       ...
                       <!-- <li class="navbar-vertical-aside-has-menu {{Request::is('seller/coupon*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                               href="javascript:" title="{{\App\CPU\translate('Offers_&_Deals')}}">
                                ...
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('create_coupon')}}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('seller/messages*')?'active':''}}" style="display:none;">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                               href="javascript:">
                        ...
                        <li class="nav-item {{(Request::is('seller/transaction/order-list')) ? 'scroll-here':''}}" style="display:none;">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('seller/transaction/order-list') || Request::is('seller/transaction/expense-list') || Request::is('seller/transaction/sale_register')) ?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{(Request::is('seller/transaction/order-list') || Request::is('seller/transaction/expense-list') || Request::is('seller/transaction/sale_register')) ?'block':'none'}}">
                                <!-- style="display: {{(Request::is('seller/transaction/order-list') || Request::is('seller/transaction/expense-list')) ?'block':'none'}}"> -->
                                <li class="nav-item {{Request::is('seller/transaction/order-list') ?'active':''}}">
                                    <a class="nav-link"
                            ...
                            <li class="nav-item {{Request::is('seller/transaction/sale_register')?'active':''}}">
                                <a class="nav-link " href="{{route('seller.transaction.sale_register')}}" title="{{\App\CPU\translate('Sale_Register')}} {{\App\CPU\translate('Report')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CPU\translate('Sale_Register')}}</span>
                                </a>
                            </li>
                            <li class="nav-item {{Request::is('seller/transaction/Order_Sale_Report')?'active':''}}">
                                <a class="nav-link " href="{{route('seller.transaction.Order_Sale_Report')}}" title="{{\App\CPU\translate('Sale_Register')}} {{\App\CPU\translate('Report')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CPU\translate('Order_Sale_Report')}}</span>
                                </a>
                            </li>
                            <li class="nav-item {{Request::is('seller/transaction/receipt')?'active':''}}">
                                <a class="nav-link " href="{{route('seller.transaction.receipt')}}" title="{{\App\CPU\translate('Sale_Register')}} {{\App\CPU\translate('Report')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{\App\CPU\translate('Receipt_Report')}}</span>
                                </a>
                            </li>
                            </ul>
                        </li>

                        <li class="navbar-vertical-aside-has-menu {{ (Request::is('seller/report/all-product') ||Request::is('seller/report/stock-product-report')) ?'active':''}}" style="display:none;">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('seller/report/order-report')?'active':''}}" style="display:none;">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <!-- End Pages -->
                        <li class="nav-item {{( Request::is('seller/business-settings*'))?'scroll-here':''}}" style="display:none;">
                            <small class="nav-subtitle" title="">{{\App\CPU\translate('business_section')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        @php($shippingMethod = \App\CPU\Helpers::get_business_settings('shipping_method'))
                        @if($shippingMethod=='sellerwise_shipping')
                            <li class="navbar-vertical-aside-has-menu {{Request::is('seller/business-settings/shipping-method*')?'active':''}}" style="display:none;">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                       ...
                       <!-- <li class="navbar-vertical-aside-has-menu {{Request::is('seller/profile/view') || Request::is('seller/profile/bank-edit/*') ?'active':''}}">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('seller/shop*') || Request::is('seller/profile/view') || Request::is('seller/profile/bank-edit/*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                 <i class="tio-home nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{\App\CPU\translate('My_Shop')}}
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{(Request::is('seller/shop*') || Request::is('seller/profile/view') || Request::is('seller/profile/bank-edit/*') || Request::is('seller/profile/signature'))?'block':''}}">
                                <li class="nav-item {{Request::is('seller/shop*')?'active':''}}">
                                    <a class="nav-link "  href="{{route('seller.shop.view')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('My_Shop')}}</span>
                                    </a>
                                </li>

                                <li class="nav-item {{Request::is('seller/profile/view') || Request::is('seller/profile/bank-edit/*')?'active':''}}">
                                    <a class="nav-link "  href="{{route('seller.profile.view')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('My_Bank_Info')}}</span>
                                    </a>
                                </li>
                                 <li class="nav-item {{Request::is('seller/profile/signature')?'active':''}}">
                                    <a class="nav-link "  href="{{route('seller.profile.signature')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('upload_signature')}}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('seller/profile/signature')?'active':''}}">
                                    <a class="nav-link "  href="{{route('seller.profile.warehouse')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{\App\CPU\translate('Add Warehouse')}}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        @if($shipping_method=='sellerwise_shipping')
                            <li class="nav-item {{Request::is('seller/delivery-man*')?'scroll-here':''}}" style="display:none;">
                                <small class="nav-subtitle">{{\App\CPU\translate('delivery_man_management')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <li class="navbar-vertical-aside-has-menu {{Request::is('seller/delivery-man*')?'active':''}}" style="display:none;">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:">
                                    <i class="tio-user nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
