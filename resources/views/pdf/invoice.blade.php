    ...
    <table class="bs-0 mb-30 px-10">
        <tr>
            <th class="content-position-y text-left">
                ...
                <p style=" margin-top: 6px; margin-bottom:0px;">{{ $order->seller->shop->address }}, {{ $order->seller->shop->city }}, {{ $order->seller->shop->state }}, {{ $order->seller->shop->country }}, {{ $order->seller->shop->pincode }}</p>
