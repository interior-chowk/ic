  ...
  <div class="c-banner-in">
     <div class="container">
        <div class="row align-items-center">  
            <div class="col-lg-5 col-md-6">
                  <div class="c-banner-con">
                        ...
                        <h1 data-aos="flip-up" data-aos-duration="1000" data-aos-delay="500">INTERIOR <span> CHOWK</span></h1>
                        <p data-aos="flip-up" data-aos-duration="1000" data-aos-delay="700"> <strong>India's first dedicated marketplace</strong>  for home interior buyer‘s where a multitude of sellers, interior designers, architects, contractors, workers and many more..
                        </p>
                        ...
                        <a href="https://play.google.com/store/apps/details?id=com.interiorchowk.app" target="_blank" class="c-downlod-btn">
                            <img src="{{ asset('asset/img/android.png') }}" width="150" />
                        ...
                        <a href="https://apps.apple.com/app/interiorchowk/id6554003290" target="_blank" class="c-downlod-btn">
                              <img src="{{ asset('asset/img/ios.png') }}" width="150" />
        ...
        <div class="c-banner-img" data-aos="fade-up" data-aos-duration="1000">
             <img src="{{ asset('asset/img/hand-mobile.png') }}" alt="">
        </div>
    ...
    <div class="c-about-in">
        <div class="c-about-con">
            ...
            <p data-aos="fade-up" data-aos-duration="1000">Welcome to <span class="c-inte-text">
              ...
              reliable suppliers. As a subsidiary of <strong>"<a href="https://sohaminfratech.com/" target="_blank" style="color:lightblue">Soham
...
<section class="c-why-chose-w">
        ...
        <div class="c-why-chose-left-in">
            <div class="c-why-chose-left-slide" data-aos="zoom-in" data-aos-duration="500">
                ...
                <ul class="slick-dots" style="" role="tablist">
                  ...
                  <li aria-hidden="true" role="presentation" aria-selected="false" aria-controls="navigation01" id="slick-slide01"  class="slick-active"><button type="button" data-role="none" role="button" tabindex="0">2</button></li>
                  <li aria-hidden="false" role="presentation" aria-selected="false" aria-controls="navigation02" id="slick-slide02" ><button type="button" data-role="none" role="button" tabindex="0">3</button></li></ul>
            </div>
            ...
            <div class="c-why-chose-left-other">
                ...
                <a href="https://play.google.com/store/apps/details?id=com.interiorchowk.app" target="_blank" class="c-downlod-btn" data-aos="fade" data-aos-duration="500" data-aos-delay="650">
    ...
    <div class="c-why-chose-right">
       <div class="c-why-chose-right-in">
            ...
            <ul>
                <li data-aos="fade-left" data-aos-duration="800" data-aos-delay="500">Explore a diverse marketplace: Discover an extensive range of products and services
                  curated to meet every aspect of your home interior project, all in one convenient
                  location.</li>
                 <li data-aos="fade-left" data-aos-duration="800" data-aos-delay="600">Connect with trusted professionals: Access a network of skilled service providers and
                  workers vetted for their expertise and reliability, ensuring peace of mind throughout
                  your project.</li> 
                  <li data-aos="fade-left" data-aos-duration="800" data-aos-delay="700">Source premium materials: Partner with reputable suppliers offering top-notch
                  materials and furnishings to elevate the aesthetic and functionality of your living space.</li>
                  <li data-aos="fade-left" data-aos-duration="800" data-aos-delay="800">Experience seamless transactions: Enjoy a user-friendly interface and streamlined
...
<section class="c-consider-w-video">
    <div class="c-consider-in">
        <h2 class="mb-5 text-white" data-aos="fade" data-aos-duration="800"> Welcome to Interior<span>Chowk</span> </h2>
                ...
                <div class="row ">
                    <div class="col-md-6">
                        <div class="c-consider-box" data-aos="fade" data-aos-duration="800" data-aos-delay="200">
                            ...
                            <p class="text-white">Welcome to InteriorChowk Free branding & promotion* InteriorChowk is committed to supporting your growth</p>
                            <p class="text-white">Join us on this journey, and let's turn your interior design dreams into reality together!</p>
                            <p class="text-white">India's first dedicated marketplace for home interior buyer‘s where a multitude of sellers, interior designers, architects, contractors, workers and many more..</p>
