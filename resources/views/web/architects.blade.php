...
<div class="container featured mt-4 pb-2">
    <center>
        <h2 class="title" style="text-align:center;">Top Architects</h2>
    </center>
        ...
        @foreach($architects as $arch)
            <div style="flex: 0 0 20%; max-width: 20%; padding: 10px; box-sizing: border-box;">
                <div class="card text-center border-0"
                    ...
                    <img src="{{ asset($arch->banner_image) }}" class="card-img-top topCon" alt="Architect Banner">
                    <div class="overlap_img">
                        <img src="{{ asset('storage/service-provider/profile/' . $arch->image) }}"
                             class="card-img-top"
