                            ...
                            <div class="tabs-container">
                                <div class="tabs-block">
                                    <div id="tabs-section" class="tabs">
                                                ...
                                                <a>
                                                    <div class="media">
                                                        ...
                                                        <img style="height:62px;width: 62px;object-fit: contain;"
                                                            src="{{ asset('website/assets/images/male.webp') }}"
                                        ...
                                        <section id="tab-1" class="tab-body entry-content active active-content ordSectionRespo">
                                            ...
                                            <div class="orderId-list">
                                                <h6 style="color: #2E6CB2; margin-bottom: 0rem;"><a
                                                        ...
                                                        ID: {{ $order->id }}</a></h6>
                                                <div class="p-4 rounded-lg" style="background-color: #E3EEFF; margin-bottom: 10px;">
                                                    <div class="media">
                                            ...
                                            @empty
                                            <img src="{{ asset('website/assets/images/no order yet.webp') }}"
                                                alt="Empty Wishlist" class="img-fluid" style="max-width: 50%;height: auto;margin: auto;">
                                            @endforelse
                                        </section>
                                        ...
                                        <section id="tab-2" class="tab-body entry-content walletRespo">
                                            ...
                                            <div class="p-4 text-center">
                                                <img src="{{ asset('website/assets/images/Empty Wallet.webp') }}"
                                            ...
                                            <div class="mt-2 walletDtlWrapper">
                                                <div class="p-3 walletDtlInner">
                                                    ...
                                                    <div class="text-center withdWalBalnc">
                                                        ...
                                                        <h3 class="text-center mb-0" style="color: #2E6CB2;">
                                                            ...
                                                            $walletss = $wallets
                                                            ->filter(function ($w) {
                                                            return in_array($w->transaction_type, [
                                                            'Ref. Earn bonus',
                                                            'Ref. bonus',
                                                            ]);
                                                            })
                                                            ...
                                                            @endphp
                                                            <span>&#8377;</span>
                                                            {{ number_format($walletsss ?? 0, 2) }}
                                                        </h3>
                                                        <!-- <button type="button" class="mt-1" data-balance="{{ number_format($wallets->first()->balance ?? 0, 2) }}"></button> -->
                                                        <button type="button" class="btn btnOrdCan btn-RetExcOrd btn-info  btnWalWith"
                                                ...
                                                @forelse ($wallets as $transaction)
                                                @if (is_object($transaction))
                                                <div class="media p-4"
                                                    style="border-top:1px solid #2E6CB2;">
                                                    <img src="{{ asset('website/new/assets/images/online-shopping_18662840.png') }}"
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p class="mb-0" style="color: #2E6CB2;">
                                                            Transaction
                                                            ID: {{ $transaction->transaction_id }}</p>
                                                    </div>
                                        ...
                                        <section id="tab-3" class="tab-body entry-content">
                                            ...
                                            <div class="myDefAddWrapper">
                                                ...
                                                <div class="col-md-12">
                                                    <img src="{{ asset('website/assets/images/No saved address.webp') }}"
                                                        alt="Empty Wishlist" class="img-fluid" style="max-width: 50%;height: auto;margin: auto;">
                                                </div>
                                                @else
                                                ...
                                                <div id="editAddressForm_{{ $address->id }}" class="editAddWrapper">
                                        ...
                                        <section id="tab-4" class="tab-body entry-content persInfoRespo">
                                            ...
                                            <div class="p-4 mb-2 persInfoFrm"
                                                ...
                                                {{-- FAQ --}}
                                                <div class="mt-5">
                                                    <h6 class="faqHead" style="margin-bottom:10px;"><strong>FAQ’s</strong></h6>
                                                    <ul class="faq_list">
                                        ...
                                        <section id="tab-5" class="tab-body entry-content wishListRespo">
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <img src="https://interiorchowk.com/public/website/assets/images/Wishlistnew.png" alt="Empty Wishlist" class="img-fluid emptyIcn">
                                                    </div>
                                                    @else
                                                    ...
                                                    <div class="col-6 col-sm-6 col-md-3">
                                                        <div class="product product-3">
                                                            <figure class="product-media">
                                                                ...
                                                                <span class="product-label label-new">₹{{ number_format($wishlist->discount, 0) }} off</span>
                                                                @endif
                                                            ...
                                                            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                                                                ...
                                                                <div class="product product-7">
                                                                    <figure class="product-media">
                                                                        ...
                                                                        <span class="product-label label-new">{{ round($item->discount, 0) }}% off</span>
                                                                        @elseif($item->discount_type == 'flat' && $item->discount > 0)
                                                                        <span class="product-label label-new">₹{{ number_format($item->discount, 0) }} off</span>
                                                                        @endif

                                                                        <a
                                                                            href="{{ url('product/' . $item->slug) }}">
                                                                            <img src="{{ asset('storage/images/' . $item->thumbnail_image) }}"
                                                                                alt="{{ $item->name }}"
                                                                                class="product-image" style="max-width: 100%;">
                                                                        </a>
                                                                    </figure>
                                                                    <div class="product-body">
                                                                        <div class="product-cat">
                                        ...
                                        <section id="tab-6" class="tab-body entry-content cartRespo">
                                            <div class="container">
                                                ...
                                                $qty = $cartItem->cart_qty; // You can make this dynamic if you have quantity logic

                                                $totalAmount += $price * $qty;
                                                $totalamounts += $mrp*$qty;
                                                        ...
                                                        <div class="media mt-4 cart-item"
                                                            ...
                                                            <div class="position-relative">
                                                                <img style="height: 100px;"
                                                                    src="{{ asset('storage/images/' . $cartItem->thumbnail_image) }}"
                                                                    class="mr-3" alt="{{ $cartItem->name }}">
                                                            </div>
                                                            <div class="media-body">
                                                                <a href="{{ url('product/' . $cartItem->slug) }}">
                                                                    <h5 style="font-weight: 300;"
                                                                        class="mb-1 mt-0">{{ $cartItem->name }}
                                                                    </h5>
                                                                </a>
                                                                {{-- <h6 class="product-type mb-0">
                                                        ...
                                                        $(document).ready(function() {
                                                            ...
                                                            $('.qty-input').on('change', function() {
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    success: function(response) {
                                                                        alert(response.message || 'Quantity updated successfully.');
                                                        ...
                                                        <div class="p-4 mb-2 text-login"
                                                            ...
                                                            <div class="card border-0 mt-1">
                                                                <img style="height: 200px; object-fit: cover; object-position: center; border-radius: 15px; max-width: 100%;"
                                                                    src="{{ asset('website/new/assets/images/products/product-1.webp') }}"
                                                                ...
                                                                <div class="card-body p-0 mt-2">
                                                                    ...
                                                                    <a href="#"
                                                                        class="btn btn-info w-100 p-3">Proceed to
                                                                        Purchase</a>

                                                                    <a href="javascript:void(0);"
                                                                        class="btn mt-2 btn-primary rounded-pill w-100">
                                                                        You’re Saving ₹ {{ number_format($totalSaving, 2) }}
                                                                        today!
                                                                    </a>
                                                                </div>
                                                            </div>
                                                ...
                                                @else
                                                <div class="col-md-12">
                                                    <img src="https://interiorchowk.com/public/website/assets/images/Empty Cart.webp" alt="Empty Wishlist" class="img-fluid" style="max-width: 50%;height: auto;margin: auto;">
                                                </div>
                                                @endif
                                    ...
                                    "1200": {"items":4, "nav": true, "dots": false}
                                                                ...
                                                                <div class="product product-7">
                                                                    <figure class="product-media">
                                                                        ...
                                                                        <span class="product-label label-new">{{ round($recentItem->discount, 0) }}% off</span>
                                                                        @elseif($recentItem->discount_type == 'flat' && $recentItem->discount > 0)
                                                                        <span class="product-label label-new">₹{{ number_format($recentItem->discount, 0) }} off</span>
                                                                        @endif
                                                                        ...
                                                                        <a
                                                                            ...
                                                                            <img src="{{ asset('storage/images/' . $recentItem->thumbnail_image) }}"
                                                                                alt="{{ $recentItem->name }}"
                                                                                class="product-image" style="max-width: 100%;">
                                                                        </a>
                                                                    </figure>
                                            ...
                                            <div class="p-4 mb-2 imgRefWrapper"
                                                ...
                                                <div class="text-center imgErnWrap">
                                                    <img class="d-inline-block"
                                                        src="{{ asset('website/assets/images/referandearn.webp') }}" style="width:50%" />
                                                    <div class="referBG">
                                                        ...
                                                        <span>
                                                            <img class="mr-4"
                                                                src="{{ asset('website/new/assets/images/share icon.webp') }}"
                                                                onclick="toggleSharePopup(event)"
                                                                style="cursor: pointer;height:40px;width:40px;" />
                                                            <img class="mr-4"
                                                                src="{{ asset('website/new/assets/images/copy icon.webp') }}"
                                                                style="cursor: pointer;height:40px;width:40px;" onclick="copyReferralText()"
                                                                alt="Copy" />
                                                        </span>
                                                    </div>
                                                </div>
