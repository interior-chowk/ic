...
<div class="container featured wishListRespo mt-4 pb-2">
    <div class="row">
        ...
        <div class="col-md-12">
            <img src="{{ asset('website/assets/images/Wishlistnew.png') }}" class="img-fluid empWishListimg" alt="Empty Wishlist">
        </div>
        @else
                ...
                <figure class="product-media">
                    ...
                    <a href="{{ url('product/' . $wishlist->slug) }}">
                        <img src="{{ asset('storage/images/'.$images[0]) }}"
                            alt="{{ $wishlist->name }}"
                            class="product-image rounded-lg" style="max-width: 100%">
                    </a>
                </figure>
                <div class="product-body">
                    ...
                    <div class="d-flex ml-auto">
                        ...
                        <div class="action-buttons">
                            <button type="button" class="btnAddToCart" data-slug="{{ $wishlist->slug }}">
                                <i class="fa fa-shopping-cart"></i>
                            </button>
                            <button type="button" class="btnDelete" data-slug="{{ $wishlist->slug }}">
                        ...
                        <figure class="product-media">
                            ...
                            <a href="{{ url('product/' . $item->slug) }}">
                                <img src="{{ asset('storage/images/'.$item->thumbnail_image) }}"
                                    alt="{{ $item->name }}"
                                    class="product-image" style="max-width: 100%!important;">
                            </a>
                        </figure>
                        <div class="product-body">
                            <div class="product-cat">
