                ...
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="mobileAddrWrapper">
                        ...
                        <div class="addrMainWrap">
                            ...
                            <div class="offerCoupWrapper">
                                <div class="offCoupLeftWrap">
                                    <div class="d-flex align-items-start justify-content-between">
                                        ...
                                        <div>
                                            <h5>OFF10<span>Best offer for
                                                    you</span></h5>
                                            <p style="font-size: 14px">
                                                Get 10% off on all products</p>
                                        </div>
                                    </div>
                                    <div>
                                        <button type="submit" class="btn btnApply" data-code="">Applied</button>
                            ...
                            <button class="btn viewOffBtn" type="button">
