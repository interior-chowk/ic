...
@section('content')
            ...
            <div class="page-content pb-0">
                    ...
                    <div class="row mt-3 mb-3">
                        <div class="col-md-8">
                            <a href="javascript:void(0);" class="instant-del">
                                <img src="{{ asset('public/website/new/assets/images/instant-del.png') }}" alt="" />
                                4-Hour Instant Delivery
                            </a>

                            <a href="javascript:void(0);" class="regular-del">
                                <img src="{{ asset('public/website/new/assets/images/regular-del.png') }}" alt="" />
                                Regular Delivery
                            </a>
                        </div>
                ...
                {{-- <div class="banner-head">
                    <img style="height: 250px;object-fit: cover;width: 100%;"
                        src="{{ asset('public/website/new/assets/images/banners/banner-3.jpg') }}" alt="" />
                </div> --}}
                                                    ...
                                                    <figure class="product-media"
                                                        ...
                                                        <a href="{{ url('product/' . $product->slug) }}">
                                                            ...
                                                            <img src="{{ asset('storage/app/public/images/' . $firstImage) }}"
                                                                ...
                                                                onerror="this.onerror=null;this.src='{{ asset('public/website/new/assets/images/error-image.png') }}';">
                                                        </a>
                                                    </figure>
    ...
    @else
        <div class="text-center mt-4">
            <img src="{{ asset('public/website/new/assets/images/coming soon to your city_1.webp') }}"
