        ...
        @foreach($order->sku_product as $product)
            <li>
                <div class="d-flex align-items-end justify-content-between">
                    <div class="pro-desc">
                        <img src="{{ asset('storage/app/public/images/'.$product->thumbnail_image) }}" class="img-fluid" alt="pro-img">
                        <div class="ml-3">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    returnButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            // Set image
            document.querySelector('#retExcModal img').src = `storage/app/public/images/${product.thumbnail_image}`;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    cancelButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            // Set image
            document.querySelector('#cancellationModal img').src = `storage/app/public/images/${product.thumbnail_image}`;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    reviewButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            // Set image
            document.querySelector('#revProdModal img').src = `storage/app/public/images/${product.thumbnail_image}`;
