        ...
        <div class="page-content">
                ...
                <div class="product-details-top">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="pincode-section mb-2">
                                <form id="edtForm" action="{{ route('get_edt') }}">
                                    @csrf

                                    <input type="text" placeholder="Check Delivery" name="edt_zip" maxlength="6"
            ...
            {{-- <div class="container">
                <div class="video-banner video-banner-bg bg-image text-right"
                    style="background-image: url('{{ asset('/public/website/new/assets/images/banners/multiple category banner.webp') }}')">

                </div>
            </div> --}}
            <div class="banner-head mb-5">
                <img style="height: 250px; object-fit: cover; width: 100%;margin-top:60px;"
