...
if (config('app.artisan') == 1) {
    ...
    Route::get('reminder-mail-one', function () {
        Artisan::call('gathering:onedayreminder');
        return 'reminder mail one day done.';
    });
    
    Route::get('reminder-mail-three', function () {
        Artisan::call('gathering:threedaysreminder');
        return 'reminder mail three day done.';
    });
    
    Route::get('reminder-mail-five', function () {
        Artisan::call('gathering:fivedaysreminder');
        return 'reminder mail five day done.';
    });
}
