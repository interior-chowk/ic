...
Route::get('download-invoice', 'SystemController@send_invoce_to_customer');
//Route::get('order-invoice/{id}', 'SystemController@generate_invoice');
Route::get('order-invoice/{id}', 'App\Http\Controllers\Admin\OrderController@generate_invoice');
