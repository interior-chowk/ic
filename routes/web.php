...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::post('/logins', 'HomeController@weblogin');
    Route::post('/sendOtpweb', 'HomeController@sendOtpweb')->name('sendOtpweb');
    Route::any('/web_suggestion', 'HomeController@web_suggestion')->name('web_suggestion');    Route::any('/logout', 'HomeController@logout')->name('logout_1');
    Route::any('/web_search', 'HomeController@web_search')->name('web_search');    Route::any('/logout', 'HomeController@logout')->name('logout_1');
...
Route::post('/payment-razorpay', [RazorPayController::class, 'payments'])->name('payment.razorpay');
