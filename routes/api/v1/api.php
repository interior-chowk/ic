...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    //cron for shiprocket status update
    Route::get('update-shiprocket-status', 'OrderController@updateShiprocketStatus');
    ...
    Route::post('get-shipping-cost', 'ShippingMethodController@get_shipping_cost')->middleware('auth:api');
    Route::post('get-instant-shipping-cost', 'ShippingMethodController@get_shipping_cost')->middleware('auth:api');
    
    
    Route::get('all-country', 'LocationController@all_country');
    Route::get('all-state', 'LocationController@all_state');
    Route::any('pincode', 'LocationController@pincode');
    Route::get('all-city', 'LocationController@all_city');
    Route::get('all-pincode', 'LocationController@all_pincode');
    Route::post('get-all-city', 'LocationController@get_all_city');
    Route::post('get-all-pincode', 'LocationController@get_all_pincode');

   // order invoice
    Route::post('get-invoice', 'CustomerController@get_invoice');
    Route::post('add-gst-details', 'CustomerController@add_gst_details');
    
    // gst detail and order_id
    Route::get('gst-orderid-details', 'OrderController@gst_orderid_details');
    
    // wallet - apply
    Route::post('wallet-apply', 'CustomerController@wallet_apply');
    ...
    Route::group(['prefix' => 'cart','middleware'=>'auth:api'], function () {
        ...
        Route::post('add_new', 'CartController@add_to_cart_new');
        Route::get('new', 'CartController@cart_new');
        Route::put('update', 'CartController@update_cart');
        Route::post('updates', 'CartController@update_quantity');
        Route::post('remove', 'CartController@remove_from_cart');
        Route::delete('remove-all','CartController@remove_all_from_cart');
        Route::get('wishlist_carts','CartController@wishlist_carts');
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::post('filter', 'ProductController@get_filtered_products');
        Route::post('filterTest', 'ProductController@get_filtered_products_Test');
        ...
        Route::get('home_productsc', 'ProductController@get_home_products');
        Route::get('home_products', 'ProductController@get_home_products_custom');
    ...
    Route::group(['prefix' => 'notifications'], function () {
        ...
        Route::post('mark-notification', 'NotificationController@mark_notifications');
        Route::post('mark-read-notification', 'NotificationController@read_notifications');
    });
    ...
    Route::group(['prefix' => 'categories'], function () {
        ...
        Route::get('sub-sub-categories', 'CategoryController@get_sub_sub_categories');
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::get('account-blocked','CustomerController@status_update');
        ...
        Route::get('payment-mobile', 'OrderController@place_order_by_online_payment');
        
         Route::group(['prefix' => 'membership'], function () {
              Route::get('plan-list', 'CustomerController@plan_list');
         });
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            Route::get('place-online', 'OrderController@place_order_online');
    ...
    Route::group(['prefix' => 'order'], function () {
        ...
        Route::get('track-shipping-status', 'OrderController@track_order_status');
        Route::get('track-mannual-order/{order_id}', 'OrderController@track_mannual_order');
        Route::get('track-shiprocket-status/{order_id}', 'OrderController@track_shiprocket_status');
        Route::get('cancel-order','OrderController@order_cancel');
        Route::any('return-order','OrderController@order_return');
    ...
    Route::group(['prefix' => 'banners'], function () {
        ...
        Route::get('/get_all_banners', 'BannerController@get_all_banners');

    });

   Route::group(['prefix' => 'contact_us'], function () {
        Route::post('store', 'CustomerController@contact_store');
    });
    ...
    Route::group(['prefix' => 'coupon','middleware'=>'auth:api'], function () {
       ...
       // Route::get('get-all-coupon', 'CouponController@all_coupon');
         Route::post('get-all-coupon', 'CouponController@all_coupon_seeller');
    });
    ...
    Route::group(['prefix' => 'policies'], function () {
        Route::get('e-wallet-Policy', 'GeneralController@e_wallet_Policy');
        Route::get('shipping-policy', 'GeneralController@shipping_policy');
        Route::get('secure-payment-policy', 'GeneralController@secure_payment_policy');
        Route::get('instant-delivery-policy', 'GeneralController@instant_delivery_policy');
    });
