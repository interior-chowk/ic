...
Route::group(['namespace' => 'api\v4', 'prefix' => 'v4', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'cart','middleware'=>'auth:api'], function () {
        ...
        Route::post('select','CartController@is_select');
    });
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::any('recently_view', 'ProductController@recently_views');
        Route::any('instant_delivery_product', 'ProductController@instant_delivery_product');
        Route::any('search_city_products', 'ProductController@search_city_products');
        Route::any('bulk_product', 'ProductController@bulk_product');
        Route::any('search_warehouse_city', 'ProductController@search_warehouse_city');
        Route::any('product_recently_view', 'ProductController@product_recently_views');
        Route::any('cart_recently_view', 'ProductController@cart_recently_views');
        Route::any('wishlist_recently_view', 'ProductController@wishlist_recently_views');
        Route::any('more_item', 'ProductController@more_item');
        Route::any('suggestion', 'ProductController@suggestion');
        Route::any('popular_choice', 'ProductController@popular_choice');
    ...
    Route::group(['prefix' => 'categories'], function () {
        ...
        Route::any('category_views', 'ProductController@category_views');
    });
    ...
    Route::group(['prefix' => 'order'], function () {
        ...
        Route::get('check-zip', 'OrderController@check_zip');
    });
