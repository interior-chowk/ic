...
class SystemController extends Controller
{
    ...
    public function send_invoce_to_customer(){
        
        
        $order_id = 100089;
         $download_url = url('/') . '/seller/order-invoice/' . $order_id;
         //return $download_url;
         Mail::to('puneet2017prajapati@gmail.com')->send(new \App\Mail\InvoiceToCustomer($download_url));
    ...
    public function generate_invoice($id)
    {
        ...
        $data["order"] = $order;
        $mpdf_view = View::make('pdf.invoice',
