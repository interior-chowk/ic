...
class CustomerController extends Controller
{
    ...
    public function contact_customer_list(Request $request)
    {
        ...
        return view('admin-views.customer.customerlist', compact('contacts', 'search'));
    }

    // View single contact
    public function contact_customer_view($id)
    {
        ...
        return view('admin-views.customer.customerview', compact('contact'));
    }

    // Delete contact
    public function contact_customer_delete($id)
    {
        $contact = Contact::find($id);

        if (!$contact) {
            return redirect()->back()->withErrors(['msg' => 'Contact not found']);
        }
    ...
    {
        $data = BusinessSetting::where('type','like','wallet_%')->orWhere('type','like','loyalty_point_%')->orWhere('type','like','Signup_refer_point_%')->get();
    ...
    public function customer_update_settings(Request $request)
    {
        ...
        BusinessSetting::updateOrInsert(['type' => 'Signup_refer_point_sender'], [
            'value' => $request['Signup_refer_point_sender']??0
        ]);
        BusinessSetting::updateOrInsert(['type' => 'Signup_refer_point_receiver'], [
            'value' => $request['Signup_refer_point_receiver']??0
        ]);
