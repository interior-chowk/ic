...
class ForgotPasswordController extends Controller
{
    ...
    {
        return view('seller-views.auth-seller.forget-password');
    }
    ...
    public function reset_password(Request $request)
    {
        ...
        if (isset($data)) {
            $token = $request['token'];
            return view('seller-views.auth-seller.reset-password', compact('token'));
        }
        Toastr::error('Invalid URL.');
        return redirect('/seller/auth/seller-login');
    }
