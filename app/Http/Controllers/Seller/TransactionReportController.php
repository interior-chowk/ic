...
class TransactionReportController extends Controller
{
 ...
 //dd($sellers);
        ...
        return view('seller-views.transaction.order_sale', compact('orders', 'order_count', 'payment_data', 'chart_data', 'due_amount', 'settled_amount', 'sellers', 'seller_id', 'search', 'date_type', 'from', 'to','products','product_id','net_base_amount','net_gst','net_total_amount'));
    }
