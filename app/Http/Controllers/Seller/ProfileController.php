...
class ProfileController extends Controller
{
    ...
    public function warehouse()
    {
        ...
        return view('seller-views.profile.warehouse', compact('data','warehouse'));
    }

    public function policy()
    {
        $data = Seller::where('id', auth('seller')->id())->first();
        return view('seller-views.profile.policy', compact('data'));
    }
    ...
    public function get_warehouse()
    {
       ...
       $data = DB::table('warehouse')->where('seller_id',auth('seller')->id())->get();
    ...
    {
        $deleted = DB::table('warehouse')->where('id', $request->warehouse_id)->delete();
