...
class LoginController extends Controller
{
    ...
    {
        return view('seller-views.auth-seller.seller-login');
    }
    ...
    public function submit(Request $request)
    {
        ...
        if (isset($se) && (in_array($se['status'], ['approved', 'pending'])) && auth('seller')->attempt(['email' => $request->email, 'password' => $request->password], $request->remember)) {
            if($request->ajax()) {
                return response()->json([
