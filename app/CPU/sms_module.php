...
class SMS_module
{
    ...
    public static function send_msg_to($receiver, $msg)
    {
        ...
        $response = 'error';
           ...
           $curl = curl_init();
            curl_setopt_array($curl, array(
              ...
              CURLOPT_POSTFIELDS => 'module=TRANS_SMS&apikey=28ec74ef-f955-11ed-addf-0200cd936042&to=91'.$receiver.'&from=INTCHK&msg=Dear%20customer%2C%20your%20order%20is%20'.$msg.'.%20Thanks%C2%A0Interior%C2%A0Chowk.',
